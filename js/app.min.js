...
$("#wrapper").addClass("transition"),$(document).on("dialogopen",".ui-dialog",function(i,s){2==$(".ui-dialog:visible").length&&$(this).hasClass("dialog-modal")?$("body").append($("<div id='overlay' class='overlay' />").css("z-index",$(this).css("z-index")-1)):$("#overlay")&&$("#overlay").css("z-index",$(this).css("z-index")-1),$(this).hasClass("dialog-noeffect")||$("#wrapper").addClass("blur")}),$(document).on("dialogclose",".ui-dialog",function(i,s){$(".ui-dialog").is(":visible")||$("#wrapper").removeClass("blur"),1==$(".ui-dialog:visible").length?$("#overlay").remove():$("#overlay")&&$("#overlay").css("z-index",$(this).css("z-index")-2)}),$("#dialog-sigAdd #sigType, #dialog-sigEdit #sigType").on("selectmenuchange",function(){"Wormhole"==$(this).val()?($(this).closest(".ui-dialog").find(".sig-site").find("td > div, th > div").slideUp(200,function(){$(this).closest(".sig-site").hide(0)}),$(this).closest(".ui-dialog").find("#sigLife").attr("disabled","disabled").selectmenu("disable"),$(this).closest(".ui-dialog").find("#sigName").attr("disabled","disabled"),$(this).closest(".ui-dialog").find(".sig-wormhole").find("td > div, th > div").slideDown(200,function(){$(this).closest(".sig-wormhole").show(200)}),$(this).closest(".ui-dialog").find("#whType").removeAttr("disabled"),$(this).closest(".ui-dialog").find("#connection").removeAttr("disabled"),$(this).closest(".ui-dialog").find("#whLife").removeAttr("disabled").selectmenu("enable"),$(this).closest(".ui-dialog").find("#whMass").removeAttr("disabled").selectmenu("enable")):($(this).closest(".ui-dialog").find(".sig-site").find("td > div, th > div").slideDown(200,function(){$(this).closest(".sig-site").show(200)}),$(this).closest(".ui-dialog").find("#sigLife").removeAttr("disabled").selectmenu("enable"),$(this).closest(".ui-dialog").find("#sigName").removeAttr("disabled"),$(this).closest(".ui-dialog").find(".sig-wormhole").find("td > div, th > div").slideUp(200,function(){$(this).closest(".sig-wormhole").hide(0)}),$(this).closest(".ui-dialog").find("#whType").attr("disabled","disabled"),$(this).closest(".ui-dialog").find("#connection").attr("disabled","disabled"),$(this).closest(".ui-dialog").find("#whLife").attr("disabled","disabled").selectmenu("disable"),$(this).closest(".ui-dialog").find("#whMass").attr("disabled","disabled").selectmenu("disable"))}),$(document).on("click","#overwrite",function(){var i={request:{signatures:{delete:[$(this).data("id")]}},systemID:viewingSystemID};$("#overwrite").attr("disable",!0);tripwire.refresh("refresh",i,function(i){$("th.critical").removeClass("critical"),ValidationTooltips.close(),$("#dialog-sigEdit").parent().find(".ui-button-text:contains(Save)").click()},function(i){$("#overwrite").removeAttr("disable")})});
