...
var chain=new function(){var i=this;this.map,this.view,this.drawing,this.data={},thirdPartySuppliers=[];const s={orgChart:new ChainMapRendererOrgchart(this),radial:new ChainMapRendererRadial(this)};this.renderer=s[options.chain.renderer],this.renderer.switchTo(),this.useRenderer=function(i){if(!s[i])throw"Unknown renderer "+i;this.renderer!=s[i]&&(this.renderer.switchFrom(),this.renderer=s[i],this.renderer.switchTo(),this.redraw())},this.activity=function(i){for(var s=0,e=(t=document.querySelectorAll("#chainMap .nodeActivity span")).length;s<e;++s)t[s].className=t[s].className+" invisible";var t;for(s=0,e=(t=document.querySelectorAll("#chainMap [data-nodeid]")).length;s<e;++s){var a=t[s].getAttribute("data-nodeid");if(i[a]){var n=i[a].shipJumps,r=i[a].podKills,l=i[a].shipKills,c=i[a].npcKills,o=t[s].getElementsByClassName("nodeActivity")[0];if(n>0){var d=o.getElementsByClassName("jumps")[0];d.className=d.className.replace(/invisible/g,""),d.setAttribute("data-tooltip",n+" Jumps")}if(r>0){var p=o.getElementsByClassName("pods")[0];p.className=p.className.replace(/invisible/g,""),p.setAttribute("data-tooltip",r+" Pod Kills")}if(l>0){var h=o.getElementsByClassName("ships")[0];h.className=h.className.replace(/invisible/g,""),h.setAttribute("data-tooltip",l+" Ship Kills")}if(c>0){var m=o.getElementsByClassName("npcs")[0];m.className=m.className.replace(/invisible/g,""),m.setAttribute("data-tooltip",c+" NPC Kills")}}}return SystemActivityToolTips.attachedElements&&SystemActivityToolTips.attachedElements.length>0&&SystemActivityToolTips.detach($("#chainMap .whEffect")),SystemActivityToolTips.attach($("#chainMap .nodeActivity > span[data-tooltip]:not(.invisible)")),i},this.occupied=function(i){for(var s in $("#chainMap [data-icon='user'], #chainMap [data-icon='user'] + .badge").addClass("invisible"),i)$("#chainMap [data-nodeid='"+i[s].systemID+"'] [data-icon='user']").removeClass("invisible"),$("#chainMap [data-nodeid='"+i[s].systemID+"'] [data-icon='user'] + .badge").removeClass("invisible").html(i[s].count);return OccupiedToolTips.attach($("#chainMap [data-icon='user']:not(.invisible)")),i},this.flares=function(i){if($("#chainMap div.node").removeClass("redNode yellowNode greenNode"),$("#chainGrid tr").removeClass("red yellow green"),i)for(var s in i.flares){var e=i.flares[s].systemID,t=i.flares[s].flare,a=($("#chainMap [data-nodeid="+e+"]").addClass(t+"Node").parent().index()-1)/3*2;a>0&&$("#chainGrid tr:eq("+a+")").addClass(t).next().addClass(t)}return i},this.grid=function(){if(0==options.chain.gridlines)return $("#chainGrid tr").addClass("hidden"),!1;$("#chainGrid tr").removeClass("hidden");var i=Math.max(0,2*$(".google-visualization-orgchart-table tr:has(.node)").length-1);$("#chainGrid tr:gt("+i+")").addClass("hidden")},this.nodes=function(i){var s={cols:[{label:"System",type:"string"},{label:"Parent",type:"string"}],rows:[]},e=["Q003","E004","L005","Z006","M001","C008","G008","A009","SML"],t=[];function a(i,s){if(!i||!tripwire.systems[i])return!1;const e=options.chain.tabs[options.chain.active];return n(i,s,null,null,e&&0!=e.systemID&&0>e.systemID.indexOf(",")?options.chain.tabs[options.chain.active].name:void 0,"&nbsp;",["top-level"])}function n(i,s,e,t,a,n,r){var l=function(i){var s=systemAnalysis.analyse(i);if(!s){var e="string"==typeof i&&i.indexOf("|")>=0?tripwire.aSigSystems[i.substring(0,i.indexOf("|"))]:null;const t=e&&"Class-"==e.substring(0,6)?1*e.substring(6):void 0,a="High-Sec"==e?.8:"Low-Sec"==e?.4:"Null-Sec"==e?-.1:void 0,n="Triglavian"==e?500026:void 0;s=systemAnalysis.analyse(i,{security:a,class:t,factionID:n})}return"<span class='"+s.systemTypeClass+"'>"+s.systemTypeName+s.systemTypeModifiers.join("")+"</span>"}(i);const c=tripwire.systems[i];var o=null,d=null;if(c&&c.effect){switch(c.effect){case"Black Hole":o="blackhole";break;case"Cataclysmic Variable":o="cataclysmic-variable";break;case"Magnetar":o="magnetar";break;case"Pulsar":o="pulsar";break;case"Red Giant":o="red-giant";break;case"Wolf-Rayet Star":o="wolf-rayet"}d=c.effect}const p="name"==options.chain.sigNameLocation?a||(c?c.name:"&nbsp;"):"name_prefix"==options.chain.sigNameLocation&&a?a+(c?" - "+c.name:""):c?c.name:"&nbsp;";var h={v:s,systemID:i},m="<div id='node"+s+"' data-nodeid='"+i+"'"+(e?" data-sigid='"+e+"'":"")+(t?" data-inSigid='"+t+"'":"")+" class='node "+(r||[]).join(" ")+"'><div class='nodeIcons'><div style='float: left;'><i class='whEffect' "+(o?"data-icon='"+o+"' data-tooltip='"+d+"'":null)+"></i></div><div style='float: right;'><i data-icon='user' class='invisible'></i><span class='badge invisible'></span></div></div><h4 class='nodeClass'>"+l+"</h4><h4 class='nodeSystem'>"+(c?"<a href='.?system="+c.name+"'>"+p+"</a>":p)+"</h4><h4 class='nodeType'>"+n+"</h4><div class='statics'>"+function(i){if(!i)return"";const s={"High-Sec":"H","Low-Sec":"L","Null-Sec":"N",Triglavian:"▼","Class 1":"1","Class 2":"2","Class 3":"3","Class 4":"4","Class 5":5,"Class 6":6},e={H:"hisec",L:"lowsec",N:"nullsec","▼":"triglavian"};return i.map(function(i){const t=s[tripwire.wormholes[i].leadsTo];return'<span class="'+(e[t]||"class-"+t)+'" data-tooltip="'+tripwire.wormholes[i].leadsTo+" via "+i+'">'+t+"</span>"}).join("")}(c?c.statics:[])+"</div><div class='nodeActivity'><span class='jumps invisible'>&#9679;</span>&nbsp;<span class='pods invisible'>&#9679;</span>&nbsp;&nbsp;<span class='ships invisible'>&#9679;</span>&nbsp;<span class='npcs invisible'>&#9679;</span></div></div>";return h.f=m,h}function r(i,s,e){var t=guidance.findShortestPath(tripwire.map.shortest,[e-3e7,s.child.systemID-3e7]);if(!t)return null;var a={calculated:!0,life:"Gate",parent:{}};return a.parent.id=s.child.id,a.parent.systemID=s.child.systemID,a.parent.name=s.child.name,a.parent.type=s.child.type,a.parent.nth=s.child.nth,a.child={},a.child.id=++i,a.child.systemID=e,a.child.name=tripwire.systems[e].name,a.child.path=t,a.child.jumps=t.length-1,a.child.nth=null,{childID:i,calcNode:a}}function l(i){if(i[0]<=0)return!1;var s=parseInt(i[1]),e=o.length;const t=[],a=function(i){$("#show-viewing").hasClass("active")&&tripwire.systems[i.child.systemID]&&!tripwire.systems[viewingSystemID].class&&!tripwire.systems[i.child.systemID].class&&viewingSystemID!=i.child.systemID&&((t=r(e,i,viewingSystemID))&&(e=t.childID,p.push(t.calcNode),o.push([0,e])));if($("#show-favorite").hasClass("active")&&tripwire.systems[i.child.systemID]&&!tripwire.systems[i.child.systemID].class)for(var s in options.favorites){var t;if(!(tripwire.systems[options.favorites[s]].regionID>=11e6||tripwire.systems[i.child.systemID].regionID>=11e6||options.favorites[s]==i.child.systemID))(t=r(e,i,options.favorites[s]))&&(e=t.childID,p.push(t.calcNode),o.push([0,e]))}};for(var n in d){var l=d[n];if(-1==$.inArray(l.id,h)){var c,m,y,u,v,f,g;if("secondary"==l.parent?(c=tripwire.client.signatures[l.secondaryID],m=tripwire.client.signatures[l.initialID]):(c=tripwire.client.signatures[l.initialID],m=tripwire.client.signatures[l.secondaryID]),y=l.type,"K162",c&&c.systemID==i[0])u=c,v=m,f="K162",g=y;else{if(!m||m.systemID!=i[0])continue;u=m,v=c,g="K162",f=y}var w={};w.id=l.id,w.life=l.life,w.mass=l.mass,w.time=u.modifiedTime,w.parent={},w.parent.id=s,w.parent.systemID=tripwire.systems[u.systemID]?u.systemID:u.systemID+"|"+Math.floor(Math.random()*Math.floor(1e4)),w.parent.name=u.name,w.parent.type=f,w.parent.typeBM=null,w.parent.classBM=null,w.parent.nth=null,w.parent.signatureID=v.signatureID,w.parent.sigIndex=v.id,w.child={},w.child.id=++e,w.child.systemID=tripwire.systems[v.systemID]?v.systemID:v.systemID+"|"+Math.floor(Math.random()*Math.floor(1e4)),w.child.name=v.name,w.child.type=g,w.child.typeBM=null,w.child.classBM=null,w.child.nth=null,w.child.signatureID=u.signatureID,w.child.sigIndex=u.id,p.push(w),o.push([w.child.systemID,w.child.id,i[2]]),h.push(w.id),tripwire.systems[v.systemID]&&t.push(1*v.systemID),a(w)}}thirdPartySuppliers.forEach(function(n){const r={parentID:s,nextChildID:++e},l=n.findLinks(1*i[0],r);if(l){e=r.nextChildID-1;for(var c=0;c<l.length;c++){var d=l[c];0>h.indexOf(d.id)&&(0>t.indexOf(d.child.systemID)&&(d.thirdParty=n.nodeNameSuffix,p.push(d),o.push([d.child.systemID,d.child.id,i[2]]),t.push(d.child.systemID),a(d)),h.push(d.id))}}})}if($("#chainTabs .current").length>0){var c=$("#chainTabs .current .name").data("tab").toString().split(","),o=[],d=i,p=[],h=[];if(0==c){let e=0;Object.keys(i).slice().forEach(t=>{const n=tripwire.client.signatures[i[t].initialID],r=tripwire.client.signatures[i[t].secondaryID];n&&tripwire.systems[n.systemID]&&void 0===tripwire.systems[n.systemID].class?(e++,s.rows.push({c:[a(n.systemID,e),{v:null}]}),o.push([n.systemID,e,n.systemID])):r&&tripwire.systems[r.systemID]&&void 0===tripwire.systems[r.systemID].class&&(e++,s.rows.push({c:[a(r.systemID,e),{v:null}]}),o.push([r.systemID,e,r.systemID]))})}else for(var m in c)s.rows.push({c:[a(c[m],parseInt(m)+1),{v:null}]}),o.push([c[m],parseInt(m)+1,c[m]]);for(var y=0;y<o.length;y++)l(o[y])}else{$("#chainError").hide();var u={c:[]},v=viewingSystemID;u.c.push(a(v,1),{v:null}),s.rows.push(u);for(o=[[v,1]],d=i,p=[],h=[],y=0;y<o.length;++y)l(o[y])}const f={};for(var m in p){var g=p[m];u={c:[]};const i="id"==options.chain["node-reference"]?g.child.signatureID?g.child.signatureID.substring(0,3):"???":(g.child.type||"(?)")+sigFormat(g.child.typeBM,"type"),a=g.child.path?this.renderPath(g.child.path):"<a href='#' onclick='openSignatureDialog({data: { signature: "+g.child.sigIndex+', mode: "update" }}); return false;\'>'+(g.parent.name&&"ref"==options.chain.sigNameLocation?g.parent.name:g.parent.name&&"ref_prefix"==options.chain.sigNameLocation?g.parent.name+" - "+i:i)+"</a>",r=g.calculated?["calc"]:f[g.child.systemID]?["loop"]:[];g.thirdParty&&r.push("third-party","third-party-"+g.thirdParty);const l=n(g.child.systemID,g.child.id,g.id,g.child.sigIndex,g.parent.name,a,r);var w={v:g.parent.id};u.c.push(l,w),s.rows.push(u);var I=[];"critical"==g.life&&I.push("eol"),"critical"==g.mass?I.push("critical"):"destab"==g.mass&&I.push("destab"),-1==$.inArray(g.parent.type,e)&&-1==$.inArray(g.child.type,e)||I.push("frig"),I.length&&t.push(Array(l.v,w.v,I,g.id)),g.calculated||(f[g.child.systemID]=u)}return t.reverse(),{map:s,lines:t}},this.renderPath=function(i){if(i.length<=1||i.length>options.chain.routingLimit)return""+i.length-1;for(var s=i.slice(0,i.length-1).reverse().map(function(i){const s=3e7+1*i,e=systemAnalysis.analyse(s);return'<span class="'+e.systemTypeClass+'" data-tooltip="'+e.name+" ("+e.security+')" onclick="tripwire.systemChange('+s+')">'+e.pathSymbol+"</span>"}),e='<span class="path">',t=0;t<s.length;t++)t>0&&0==t%5&&(e+="|"),e+=s[t];return e+"</span>"},this.setActiveTab=function(s){$("#chainTabs .tab").removeClass("current"),options.chain.active=s,null!=s&&$("#chainTabs .tab").eq(s).addClass("current"),options.save(),i.redraw(),tripwire.parse(tripwire.client,"refresh")},this.redraw=function(){this.useRenderer(options.chain.renderer);var i=$.extend(!0,{},this.data);i.map=$.extend(!0,{},i.rawMap),this.draw(i)};var e=null;this.draw=function(s){s=void 0!==s?s:{};if(clearTimeout(e),!this.renderer.ready()||Object.size(s.map)&&!tripwire.client.signatures)e=setTimeout(function(){i.draw(s)},100);else{if(s.map){this.drawing=!0,this.data.rawMap=$.extend(!0,{},s.map),Object.sort(s.map,"id"),$.extend(s,this.nodes(s.map)),$.extend(this.data,s);const i=options.chain.tabs[options.chain.active]&&options.chain.tabs[options.chain.active].collapsed||[];this.renderer.draw(s.map,s.lines,i),this.grid(),$("#chainMap [data-nodeid='"+viewingSystemID+"']").parent().addClass("currentNode"),WormholeTypeToolTips.attachedElements&&WormholeTypeToolTips.attachedElements.length>0&&WormholeTypeToolTips.detach($("#chainMap .whEffect")),WormholeTypeToolTips.attach($("#chainMap .whEffect[data-icon]")),WormholeRouteToolTips.attach($("#chainMap .path span[data-tooltip]")),SystemActivityToolTips.attach($("#chainMap .nodeClass span[data-tooltip]")),this.drawing=!1}!this.data.activity||new Date>this.data.activity.expires?(s.activity={},tripwire.esi.universeJumps().done(function(i,e,t){s.activity.expires=new Date(t.getResponseHeader("expires")),$.each(i,function(e){s.activity[i[e].system_id]={systemID:i[e].system_id,shipJumps:i[e].ship_jumps}})}).then(function(){return tripwire.esi.universeKills().done(function(i){$.each(i,function(e){s.activity[i[e].system_id]?(s.activity[i[e].system_id].podKills=i[e].pod_kills,s.activity[i[e].system_id].shipKills=i[e].ship_kills,s.activity[i[e].system_id].npcKills=i[e].npc_kills):s.activity[i[e].system_id]={systemID:i[e].system_id,podKills:i[e].pod_kills,shipKills:i[e].ship_kills,npcKills:i[e].npc_kills}})})}).then(function(){i.data.activity=i.activity(s.activity)})):s.map&&i.activity(this.data.activity),s.occupied&&(this.data.occupied=this.occupied(s.occupied)),s.flares&&(this.data.flares=this.flares(s.flares))}},this.updateCollapsed=function(s){options.chain.tabs[options.chain.active]&&(options.chain.tabs[options.chain.active].collapsed=s),$("#chainMap [data-nodeid='"+viewingSystemID+"']").parent().addClass("currentNode"),WormholeTypeToolTips.attachedElements&&WormholeTypeToolTips.attachedElements.length>0&&WormholeTypeToolTips.detach($("#chainMap .whEffect")),WormholeTypeToolTips.attach($("#chainMap .whEffect[data-icon]")),i.activity(i.data.activity),i.occupied(i.data.occupied),i.flares(i.data.flares),i.grid(),options.save()}};
