...
var chain=new function(){this.map,this.view,this.options,this.drawing,this.data={},this.newView=function(i){return this.view=new google.visualization.DataView(new google.visualization.DataTable(i)),this.view},this.activity=function(i){for(var s=0,e=(t=document.querySelectorAll("#chainMap .nodeActivity span")).length;s<e;++s)t[s].className=t[s].className+" invisible";var t;for(s=0,e=(t=document.querySelectorAll("#chainMap [data-nodeid]")).length;s<e;++s){var a=t[s].getAttribute("data-nodeid");if(i[a]){var n=i[a].shipJumps,l=i[a].podKills,r=i[a].shipKills,c=i[a].npcKills,p=t[s].getElementsByClassName("nodeActivity")[0];if(n>0){var o=p.getElementsByClassName("jumps")[0];o.className=o.className.replace(/invisible/g,""),o.setAttribute("data-tooltip",n+" Jumps")}if(l>0){var d=p.getElementsByClassName("pods")[0];d.className=d.className.replace(/invisible/g,""),d.setAttribute("data-tooltip",l+" Pod Kills")}if(r>0){var h=p.getElementsByClassName("ships")[0];h.className=h.className.replace(/invisible/g,""),h.setAttribute("data-tooltip",r+" Ship Kills")}if(c>0){var m=p.getElementsByClassName("npcs")[0];m.className=m.className.replace(/invisible/g,""),m.setAttribute("data-tooltip",c+" NPC Kills")}}}return SystemActivityToolTips.attachedElements&&SystemActivityToolTips.attachedElements.length>0&&SystemActivityToolTips.detach($("#chainMap .whEffect")),SystemActivityToolTips.attach($("#chainMap .nodeActivity > span[data-tooltip]:not(.invisible)")),i},this.occupied=function(i){for(var s in $("#chainMap [data-icon='user'], #chainMap [data-icon='user'] + .badge").addClass("invisible"),i)$("#chainMap [data-nodeid='"+i[s].systemID+"'] [data-icon='user']").removeClass("invisible"),$("#chainMap [data-nodeid='"+i[s].systemID+"'] [data-icon='user'] + .badge").removeClass("invisible").html(i[s].count);return OccupiedToolTips.attach($("#chainMap [data-icon='user']:not(.invisible)")),i},this.flares=function(i){if($("#chainMap td.node").removeClass("redNode yellowNode greenNode"),$("#chainGrid tr").removeClass("red yellow green"),i)for(var s in i.flares){var e=i.flares[s].systemID,t=i.flares[s].flare,a=($("#chainMap [data-nodeid="+e+"]").parent().addClass(t+"Node").parent().index()-1)/3*2;a>0&&$("#chainGrid tr:eq("+a+")").addClass(t).next().addClass(t)}return i},this.grid=function(){if(0==options.chain.gridlines)return $("#chainGrid tr").addClass("hidden"),!1;$("#chainGrid tr").removeClass("hidden");var i=Math.max(0,2*$(".google-visualization-orgchart-table tr:has(.node)").length-1);$("#chainGrid tr:gt("+i+")").addClass("hidden")},this.lines=function(i){function s(s,e,t,a){var n=$("#chainMap #node"+s).parent();if(0==n.length)return!1;var l=Math.ceil((n[0].cellIndex+1)/2-1),r=$(n.parent().prev().children("td.google-visualization-orgchart-lineleft, td.google-visualization-orgchart-lineright")[l]).addClass("left-"+t+" right-"+t),c=$("#chainMap #node"+e).parent();if(0==c.length||0==r.length)return!1;var p=0,o=r[0].cellIndex;n.parent().prev().find("td").each(function(i){if(p+=this.colSpan,i==o)return!1});for(var d=Math.ceil((c[0].cellIndex+1)/2-1),h=d,m=0;m<=d;m++){var y=0;n.parent().prev().prev().prev().find("td > [data-nodeid]").each(function(i){if(i==m)return y=$(this).attr("id").replace("node",""),!1}),$.map(i.map.rows,function(i){return i.c[1].v==y?i:null}).length<=0&&h--}d=h;var v=$(n.parent().prev().prev().children("td.google-visualization-orgchart-lineleft, td.google-visualization-orgchart-lineright")[d]).addClass("left-"+t+" right-"+t),u=0,f=(e=!1,!1);n.parent().prev().prev().find("td").each(function(i,s){if(u+=this.colSpan,f&&e)return!1;if(void 0!==v[0]&&v[0].cellIndex==i){if(e=!0,$(this).addClass("left-"+t),f||u==p||$(this).addClass("bottom-"+t),p==u)return!1}else if(u==p)f=!0,$(this).addClass("bottom-"+t);else if(f||e){var a=0,l=!1,r=!1;if(n.parent().prev().find("td").each(function(i){if((a+=this.colSpan)==u&&($(this).hasClass("google-visualization-orgchart-lineleft")||$(this).hasClass("google-visualization-orgchart-lineright"))){if(0==e)return l=!0,v.removeClass("left-"+t+" right-"+t),!1;1==e&&(v.removeClass("left-"+t+" right-"+t),n.parent().prev().prev().find("td").each(function(i){i>=v[0].cellIndex&&$(this).removeClass("bottom-"+t)}),r=!0)}}),l)return!1;r||$(this).addClass("bottom-"+t)}})}for(var e in i.lines)s(i.lines[e][0],i.lines[e][1],i.lines[e][2],i.lines[e][3])},this.nodes=function(i){var s={cols:[{label:"System",type:"string"},{label:"Parent",type:"string"}],rows:[]},e=["Q003","E004","L005","Z006","M001","C008","G008","A009","SML","MED","LRG","XLG"],t=[];function a(i,s){if(!i||!tripwire.systems[i])return!1;var e;tripwire.systems[i].class?e="<span class='wh'>C"+tripwire.systems[i].class+"</span>":tripwire.systems[i].security>=.45?e="<span class='hisec'>HS</span>":tripwire.systems[i].security>0?e="<span class='lowsec'>LS</span>":tripwire.systems[i].security<=0&&(e="<span class='nullsec'>NS</span>");var t=null,a=null;if(tripwire.systems[i].class){switch(tripwire.systems[i].effect){case"Black Hole":t="blackhole";break;case"Cataclysmic Variable":t="cataclysmic-variable";break;case"Magnetar":t="magnetar";break;case"Pulsar":t="pulsar";break;case"Red Giant":t="red-giant";break;case"Wolf-Rayet Star":t="wolf-rayet"}a=tripwire.systems[i].effect}var n={v:s},l="<div id='node"+s+"' data-nodeid='"+i+"'><div class='nodeIcons'><div style='float: left;'><i class='whEffect' "+(t?"data-icon='"+t+"' data-tooltip='"+a+"'":null)+"></i></div><div style='float: right;'><i data-icon='user' class='invisible'></i><span class='badge invisible'></span></div></div><h4 class='nodeClass'>"+e+"</h4><h4 class='nodeSystem'><a href='.?system="+tripwire.systems[i].name+"'>"+(options.chain.tabs[options.chain.active]&&0!=options.chain.tabs[options.chain.active].systemID?options.chain.tabs[options.chain.active].name:tripwire.systems[i].name)+"</a></h4><h4 class='nodeType'>&nbsp;</h4><div class='nodeActivity'><span class='jumps invisible'>&#9679;</span>&nbsp;<span class='pods invisible'>&#9679;</span>&nbsp;&nbsp;<span class='ships invisible'>&#9679;</span>&nbsp;<span class='npcs invisible'>&#9679;</span></div></div>";return n.f=l,n}function n(i){if(i[0]<=0)return!1;var s=parseInt(i[1]),e=r.length;for(var t in c){var a=c[t];if("secondary"==a.parent)var n=tripwire.client.signatures[a.secondaryID],l=tripwire.client.signatures[a.initialID];else n=tripwire.client.signatures[a.initialID],l=tripwire.client.signatures[a.secondaryID];if(-1==$.inArray(a.id,o))if(n&&n.systemID==i[0]){if((h={}).id=a.id,h.life=a.life,h.mass=a.mass,h.time=n.modifiedTime,h.parent={},h.parent.id=s,h.parent.systemID=tripwire.systems[n.systemID]?n.systemID:n.systemID+"|"+Math.floor(Math.random()*Math.floor(1e4)),h.parent.name=n.name,h.parent.type="K162",h.parent.typeBM=null,h.parent.classBM=null,h.parent.nth=null,h.parent.signatureID=l.signatureID,h.child={},h.child.id=++e,h.child.systemID=tripwire.systems[l.systemID]?l.systemID:l.systemID+"|"+Math.floor(Math.random()*Math.floor(1e4)),h.child.name=l.name,h.child.type=a.type,h.child.typeBM=null,h.child.classBM=null,h.child.nth=null,h.child.signatureID=n.signatureID,p.push(h),r.push([h.child.systemID,h.child.id,i[2]]),o.push(h.id),$("#show-viewing").hasClass("active")&&tripwire.systems[h.child.systemID]&&!tripwire.systems[viewingSystemID].class&&!tripwire.systems[h.child.systemID].class){var d=guidance.findShortestPath(tripwire.map.shortest,[viewingSystemID-3e7,h.child.systemID-3e7]).length-1;(m={life:"Gate",parent:{}}).parent.id=h.child.id,m.parent.systemID=h.child.systemID,m.parent.name=h.child.name,m.parent.type=h.child.type,m.parent.nth=h.child.nth,m.child={},m.child.id=++e,m.child.systemID=viewingSystemID,m.child.name=tripwire.systems[viewingSystemID].name,m.child.jumps=d,m.child.nth=null,p.push(m),r.push([0,e])}if($("#show-favorite").hasClass("active")&&tripwire.systems[h.child.systemID])for(t in options.favorites)if(!(tripwire.systems[options.favorites[t]].regionID>=11e6||tripwire.systems[h.child.systemID].regionID>=11e6)){d=guidance.findShortestPath(tripwire.map.shortest,[options.favorites[t]-3e7,h.child.systemID-3e7]).length-1;(m={life:"Gate",parent:{}}).parent.id=h.child.id,m.parent.systemID=h.child.systemID,m.parent.name=h.child.name,m.parent.type=h.child.type,m.parent.nth=h.child.nth,m.child={},m.child.id=++e,m.child.systemID=options.favorites[t],m.child.name=tripwire.systems[options.favorites[t]].name,m.child.jumps=d,m.child.nth=null,p.push(m),r.push([0,e])}}else if(l&&l.systemID==i[0]){var h;if((h={}).id=a.id,h.life=a.life,h.mass=a.mass,h.time=a.modifiedTime,h.parent={},h.parent.id=s,h.parent.systemID=tripwire.systems[l.systemID]?l.systemID:l.systemID+"|"+Math.floor(Math.random()*Math.floor(1e4)),h.parent.name=l.name,h.parent.type=a.type,h.parent.typeBM=null,h.parent.classBM=null,h.parent.nth=null,h.parent.signatureID=n.signatureID,h.child={},h.child.id=++e,h.child.systemID=tripwire.systems[n.systemID]?n.systemID:n.systemID+"|"+Math.floor(Math.random()*Math.floor(1e4)),h.child.name=n.name,h.child.type="K162",h.child.typeBM=null,h.child.classBM=null,h.child.nth=null,h.child.signatureID=l.signatureID,p.push(h),r.push([h.child.systemID,h.child.id,i[2]]),o.push(h.id),$("#show-viewing").hasClass("active")&&tripwire.systems[h.child.systemID]&&!tripwire.systems[viewingSystemID].class&&!tripwire.systems[h.child.systemID].class){d=guidance.findShortestPath(tripwire.map.shortest,[viewingSystemID-3e7,h.child.systemID-3e7]).length-1;(m={life:"Gate",parent:{}}).parent.id=h.child.id,m.parent.systemID=h.child.systemID,m.parent.name=h.child.name,m.parent.type=h.child.type,m.parent.nth=h.child.nth,m.child={},m.child.id=++e,m.child.systemID=viewingSystemID,m.child.name=tripwire.systems[viewingSystemID].name,m.child.nth=null,m.child.jumps=d,p.push(m),r.push([0,e])}if($("#show-favorite").hasClass("active")&&tripwire.systems[h.child.systemID])for(t in options.favorites)if(!(tripwire.systems[options.favorites[t]].regionID>=11e6||tripwire.systems[h.child.systemID].regionID>=11e6)){var m;d=guidance.findShortestPath(tripwire.map.shortest,[options.favorites[t]-3e7,h.child.systemID-3e7]).length-1;(m={life:"Gate",parent:{}}).parent.id=h.child.id,m.parent.systemID=h.child.systemID,m.parent.name=h.child.name,m.parent.type=h.child.type,m.parent.nth=h.child.nth,m.child={},m.child.id=++e,m.child.systemID=options.favorites[t],m.child.name=tripwire.systems[options.favorites[t]].name,m.child.nth=null,m.child.jumps=d,p.push(m),r.push([0,e])}}}}if($("#chainTabs .current").length>0){var l=$("#chainTabs .current .name").data("tab").toString().split(","),r=[],c=i,p=[],o=[];if(0==l){var d=0;for(var h in i){var m=tripwire.client.signatures[i[h].initialID],y=tripwire.client.signatures[i[h].secondaryID];void 0===tripwire.systems[m.systemID].class?(d++,s.rows.push({c:[a(m.systemID,d),{v:null}]}),r.push([m.systemID,d,m.systemID])):tripwire.systems[y.systemID]&&void 0===tripwire.systems[y.systemID].class&&(d++,s.rows.push({c:[a(y.systemID,d),{v:null}]}),r.push([y.systemID,d,y.systemID]))}}else for(var h in l)s.rows.push({c:[a(l[h],parseInt(h)+1),{v:null}]}),r.push([l[h],parseInt(h)+1,l[h]]);for(d=0;d<r.length;d++)n(r[d])}else{$("#chainError").hide();var v={c:[]},u=viewingSystemID;v.c.push(a(u,1),{v:null}),s.rows.push(v);for(r=[[u,1]],c=i,p=[],o=[],d=0;d<r.length;++d)n(r[d])}for(var h in p){var f,w=p[h],g=(v={c:[]},tripwire.systems[w.child.systemID]?tripwire.systems[w.child.systemID].class:null),I=tripwire.systems[w.child.systemID]?tripwire.systems[w.child.systemID].security:null,D="string"==typeof w.child.systemID&&w.child.systemID.indexOf("|")>=0?tripwire.aSigSystems[w.child.systemID.substring(0,w.child.systemID.indexOf("|"))]:null;f=6==g||"Class-6"==D||void 0!==tripwire.wormholes[w.child.type]&&"Class 6"==tripwire.wormholes[w.child.type].leadsTo?"<span class='wh'>C6</span>":5==g||"Class-5"==D||void 0!==tripwire.wormholes[w.child.type]&&"Class 5"==tripwire.wormholes[w.child.type].leadsTo?"<span class='wh'>C5</span>":4==g||"Class-4"==D||void 0!==tripwire.wormholes[w.child.type]&&"Class 4"==tripwire.wormholes[w.child.type].leadsTo?"<span class='wh'>C4</span>":3==g||"Class-3"==D||void 0!==tripwire.wormholes[w.child.type]&&"Class 3"==tripwire.wormholes[w.child.type].leadsTo?"<span class='wh'>C3</span>":2==g||"Class-2"==D||void 0!==tripwire.wormholes[w.child.type]&&"Class 2"==tripwire.wormholes[w.child.type].leadsTo?"<span class='wh'>C2</span>":1==g||"Class-1"==D||void 0!==tripwire.wormholes[w.child.type]&&"Class 1"==tripwire.wormholes[w.child.type].leadsTo?"<span class='wh'>C1</span>":g>6?"<span class='wh'>C"+g+"</span>":void 0!==tripwire.wormholes[w.child.type]&&tripwire.wormholes[w.child.type].leadsTo.split(" ").length>1?"<span class='wh'>C"+tripwire.wormholes[w.child.type].leadsTo.split(" ")[1]+"</span>":I>=.45||"High-Sec"==D||void 0!==tripwire.wormholes[w.child.type]&&"High-Sec"==tripwire.wormholes[w.child.type].leadsTo&&!I?"<span class='hisec'>HS</span>":I>0||"Low-Sec"==D||void 0!==tripwire.wormholes[w.child.type]&&"Low-Sec"==tripwire.wormholes[w.child.type].leadsTo&&!I?"<span class='lowsec'>LS</span>":I<=0&&null!=I||"Null-Sec"==D||void 0!==tripwire.wormholes[w.child.type]&&"Null-Sec"==tripwire.wormholes[w.child.type].leadsTo?"<span class='nullsec'>NS</span>":"<span>&nbsp;</span>";var b=null,C=null;if(void 0!==tripwire.systems[w.child.systemID]){switch(tripwire.systems[w.child.systemID].effect){case"Black Hole":b="blackhole";break;case"Cataclysmic Variable":b="cataclysmic-variable";break;case"Magnetar":b="magnetar";break;case"Pulsar":b="pulsar";break;case"Red Giant":b="red-giant";break;case"Wolf-Rayet Star":b="wolf-rayet";break;default:b=null}C=tripwire.systems[w.child.systemID].effect}y={v:w.child.id};var T="<div id='node"+w.child.id+"' data-nodeid='"+w.child.systemID+"' data-sigid='"+w.id+"'><div class='nodeIcons'><div style='float: left;'><i class='whEffect' "+(b?"data-icon='"+b+"' data-tooltip='"+C+"'":null)+"></i></div><div style='float: right;'><i data-icon='user' class='invisible'></i><span class='badge invisible'></span></div></div><h4 class='nodeClass'>"+(f+sigFormat(w.child.classBM,"class"))+"</h4><h4 class='nodeSystem'>"+(tripwire.systems[w.child.systemID]?"<a href='.?system="+tripwire.systems[w.child.systemID].name+"'>"+(w.parent.name?w.parent.name:tripwire.systems[w.child.systemID].name)+"</a>":w.parent.name?w.parent.name:"<a class='invisible'>system</a>")+"</h4>"+(w.child.jumps?"<h4 class='nodeType'>"+w.child.jumps+"</h4>":"<h4 class='nodeType'>"+("id"==options.chain["node-reference"]?w.child.signatureID?w.child.signatureID.substring(0,3):"&nbsp;":(w.child.type||"&nbsp;")+sigFormat(w.child.typeBM,"type")||"&nbsp;")+"</h4>")+"<div class='nodeActivity'><span class='jumps invisible'>&#9679;</span>&nbsp;<span class='pods invisible'>&#9679;</span>&nbsp;&nbsp;<span class='ships invisible'>&#9679;</span>&nbsp;<span class='npcs invisible'>&#9679;</span></div></div>";y.f=T;m={v:w.parent.id};v.c.push(y,m),s.rows.push(v),"critical"!=w.life||-1==$.inArray(w.parent.type,e)&&-1==$.inArray(w.child.type,e)?"critical"==w.life&&"critical"==w.mass?t.push(Array(y.v,m.v,"eol-critical",w.id)):"critical"==w.life&&"destab"==w.mass?t.push(Array(y.v,m.v,"eol-destab",w.id)):-1!=$.inArray(w.parent.type,e)||-1!=$.inArray(w.child.type,e)?t.push(Array(y.v,m.v,"frig",w.id)):"critical"==w.life?t.push(Array(y.v,m.v,"eol",w.id)):"critical"==w.mass?t.push(Array(y.v,m.v,"critical",w.id)):"destab"==w.mass?t.push(Array(y.v,m.v,"destab",w.id)):"Gate"!=w.life&&"GATE"!=w.parent.type&&"GATE"!=w.child.type||t.push(Array(y.v,m.v,"gate",w.id)):t.push(Array(y.v,m.v,"eol-frig",w.id))}return t.reverse(),{map:s,lines:t}},this.redraw=function(){var i=$.extend(!0,{},this.data);i.map=$.extend(!0,{},i.rawMap),this.draw(i)},this.draw=function(i){i=void 0!==i?i:{};if(!this.map||Object.size(i.map)&&!tripwire.client.signatures)setTimeout(()=>chain.draw(i),100);else{if(i.map){if(this.drawing=!0,this.data.rawMap=$.extend(!0,{},i.map),Object.sort(i.map,"id"),$.extend(i,this.nodes(i.map)),$.extend(this.data,i),this.map.draw(this.newView(i.map),this.options),options.chain.tabs[options.chain.active])for(var s in options.chain.tabs[options.chain.active].collapsed){var e=$("#chainMap [data-nodeid='"+options.chain.tabs[options.chain.active].collapsed[s]+"']").attr("id");e&&(e=e.split("node")[1],this.map.collapse(e-1,!0))}this.lines(i),this.grid(),$("#chainMap [data-nodeid='"+viewingSystemID+"']").parent().addClass("currentNode"),WormholeTypeToolTips.attachedElements&&WormholeTypeToolTips.attachedElements.length>0&&WormholeTypeToolTips.detach($("#chainMap .whEffect")),WormholeTypeToolTips.attach($("#chainMap .whEffect[data-icon]")),this.drawing=!1}!this.data.activity||new Date>this.data.activity.expires?(i.activity={},tripwire.esi.universeJumps().done(function(s,e,t){i.activity.expires=new Date(t.getResponseHeader("expires")),$.each(s,function(e){i.activity[s[e].system_id]={systemID:s[e].system_id,shipJumps:s[e].ship_jumps}})}).then(function(){return tripwire.esi.universeKills().done(function(s){$.each(s,function(e){i.activity[s[e].system_id]?(i.activity[s[e].system_id].podKills=s[e].pod_kills,i.activity[s[e].system_id].shipKills=s[e].ship_kills,i.activity[s[e].system_id].npcKills=s[e].npc_kills):i.activity[s[e].system_id]={systemID:s[e].system_id,podKills:s[e].pod_kills,shipKills:s[e].ship_kills,npcKills:s[e].npc_kills}})})}).then(function(){chain.data.activity=chain.activity(i.activity)})):i.map&&chain.activity(this.data.activity),i.occupied&&(this.data.occupied=this.occupied(i.occupied)),i.flares&&(this.data.flares=this.flares(i.flares))}},this.collapse=function(i){if(chain.drawing)return!1;if(options.chain.tabs[options.chain.active]){var s=chain.map.getCollapsedNodes();for(x in options.chain.tabs[options.chain.active].collapsed=[],s){var e=$("#chainMap #node"+(s[x]+1)).data("nodeid");options.chain.tabs[options.chain.active].collapsed.push(e)}}chain.lines(chain.data),$("#chainMap [data-nodeid='"+viewingSystemID+"']").parent().addClass("currentNode"),WormholeTypeToolTips.attachedElements&&WormholeTypeToolTips.attachedElements.length>0&&WormholeTypeToolTips.detach($("#chainMap .whEffect")),WormholeTypeToolTips.attach($("#chainMap .whEffect[data-icon]")),chain.activity(chain.data.activity),chain.occupied(chain.data.occupied),chain.flares(chain.data.flares),chain.grid(),options.save()},this.init=function(){chain.map=new google.visualization.OrgChart(document.getElementById("chainMap")),chain.options={allowHtml:!0,allowCollapse:!0,size:"medium",nodeClass:"node"},google.visualization.events.addListener(chain.map,"collapse",chain.collapse),chain.map.draw(new google.visualization.DataView(new google.visualization.DataTable({cols:[{label:"System",type:"string"},{label:"Parent",type:"string"}]})),this.options)},google.charts.setOnLoadCallback(this.init)};
