...
tripwire.addSig=function(t,e,i){var s=void 0===(e=e||{}).animate||e.animate,a=(i=i||!1,{});const n=t.signatureID?'<a class="return-link" href="#" onclick="tripwire.setReturnSig(event, '+t.id+')">&gt;&gt; Set '+t.signatureID.substring(0,3).toUpperCase()+"-"+t.signatureID.substring(3)+" as return</a>":"";if("wormhole"==t.type){if(!(a=Object.values(tripwire.client.wormholes).find(function(e){return e.initialID==t.id||e.secondaryID==t.id})))return!1;var r=t.id==a.initialID?tripwire.client.signatures[a.secondaryID]:tripwire.client.signatures[a.initialID];if(!r)return!1;t.name?leadsTo=tripwire.systems[r.systemID]?"<a href='.?system="+tripwire.systems[r.systemID].name+"'>"+t.name+"</a>":t.name:tripwire.aSigSystems[r.systemID]?leadsTo=tripwire.aSigSystems[r.systemID]:tripwire.systems[r.systemID]?leadsTo="<a href='.?system="+tripwire.systems[r.systemID].name+"'>"+tripwire.systems[r.systemID].name+"</a>":leadsTo="";const e=leadsTo||(t.signatureID&&t.signatureID.length&&"?"!=t.signatureID[0]?n:"");var o="<tr data-id='"+t.id+"' data-tooltip='' "+(i?'disabled="disabled"':"")+"><td class='"+options.signatures.alignment.sigID+"'>"+(t.signatureID?t.signatureID.substring(0,3)+"-"+(t.signatureID.substring(3,6)||"###"):"???-###")+"</td><td class='type-tooltip "+options.signatures.alignment.sigType+"' data-tooltip=\""+this.whTooltip(a)+'">'+(a[a.parent+"ID"]==t.id?a.type||"":a.parent?"K162":"")+"</td><td class='age-tooltip "+options.signatures.alignment.sigAge+(0===parseInt(t.lifeLength)?" disabled":"")+"' data-tooltip='"+this.ageTooltip(t)+"'><span data-age='"+t.lifeTime+"'></span></td><td class='"+options.signatures.alignment.leadsTo+"'>"+e+"</td><td class='"+a.life+" "+options.signatures.alignment.sigLife+"'>"+a.life+"</td><td class='"+a.mass+" "+options.signatures.alignment.sigMass+"'>"+a.mass+"</td></tr>",d=$(o)}else{const e="unknown"===t.type?n:t.name?linkSig(t.name):"";o="<tr data-id='"+t.id+"' data-tooltip='' "+(i?'disabled="disabled"':"")+"><td class='"+options.signatures.alignment.sigID+"'>"+(t.signatureID?t.signatureID.substring(0,3)+"-"+(t.signatureID.substring(3,6)||"###"):"???-###")+"</td><td class='"+options.signatures.alignment.sigType+"'>"+t.type+"</td><td class='age-tooltip "+options.signatures.alignment.sigAge+(0===parseInt(t.lifeLength)?" disabled":"")+"' data-tooltip='"+this.ageTooltip(t)+"'><span data-age='"+t.lifeTime+"'></span></td><td class='"+options.signatures.alignment.leadsTo+"' colspan='3'>"+e+"</td></tr>",d=$(o)}Tooltips.attach($(d).find("[data-tooltip]")),$("#sigTable").append(d),"critical"==a.life?$(d).find("span[data-age]").countdown({until:moment.utc(t.lifeLeft).toDate(),onExpiry:this.pastEOL,alwaysExpire:!0,compact:!0,format:this.ageFormat,serverSync:this.serverTime.getTime}).addClass("critical"):$(d).find("span[data-age]").countdown({since:moment.utc(t.lifeTime).toDate(),compact:!0,format:this.ageFormat,serverSync:this.serverTime.getTime}),s&&($(d).find("td").wrapInner('<div class="hidden" />').parent().find("td > div").slideDown(700,function(){$set=$(this),$set.replaceWith($set.contents())}),$(d).find("td").animate({backgroundColor:"#004D16"},1e3).delay(1e3).animate({backgroundColor:"#111"},1e3,null,function(){$(this).css({backgroundColor:""})}))},tripwire.setReturnSig=function(t,e){t.preventDefault();const i=tripwire.signatures.returnSig,s=tripwire.client.signatures[e];i&&s&&sigDialog.overwriteSignature(e,function(t){i.signatureID=s.signatureID;const e={signatures:{update:[{wormhole:"dummy",signatures:[i]}]}};tripwire.refresh("refresh",e)})};
