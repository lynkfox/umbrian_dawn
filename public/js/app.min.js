...
tripwire.autoMapper=function(e,i){var t=[];if(!$("#toggle-automapper").hasClass("active")||$("#toggle-automapper").hasClass("disabled"))return!1;if(!tripwire.systems[e]||!tripwire.systems[i])return!1;if(e==i)return!1;if(tripwire.client.EVE&&tripwire.client.EVE.stationID)return!1;if(tripwire.client.EVE&&tripwire.client.EVE.shipTypeID&&$.inArray(parseInt(tripwire.client.EVE.shipTypeID),[33328,670])>=0)return!1;if(void 0!==tripwire.map.shortest[e-3e7]&&void 0!==tripwire.map.shortest[e-3e7][i-3e7])return!1;if($.map(tripwire.client.wormholes,function(t){return tripwire.client.signatures[t.initialID]&&tripwire.client.signatures[t.secondaryID]&&tripwire.client.signatures[t.initialID].systemID==e&&tripwire.client.signatures[t.secondaryID].systemID==i}))return!1;if($.map(tripwire.client.wormholes,function(t){return tripwire.client.signatures[t.initialID]&&tripwire.client.signatures[t.secondaryID]&&tripwire.client.signatures[t.initialID].systemID==i&&tripwire.client.signatures[t.secondaryID].systemID==e}))return!1;var r,s={signatures:{add:[],update:[]}};r=tripwire.systems[i].class?"Class-"+tripwire.systems[i].class:tripwire.systems[i].security>=.45?"High-Sec":tripwire.systems[i].security>0?"Low-Sec":"Null-Sec";var n=$.map(tripwire.client.wormholes,function(i){if(tripwire.client.signatures[i.initialID].systemID==e&&!tripwire.systems[tripwire.client.signatures[i.secondaryID].systemID]){if(tripwire.aSigSystems[tripwire.client.signatures[i.secondaryID].systemID]==r)return i;if(i.type&&tripwire.wormholes[i.type]&&tripwire.wormholes[i.type].leadsTo.replace(" ","-")==r)return i;if(!tripwire.systems[tripwire.client.signatures[i.secondaryID].systemID])return i}});if(n.length)if(n.length>1)$("#dialog-select-signature").dialog({autoOpen:!0,title:"Which Signature?",width:390,buttons:{Cancel:function(){$(this).dialog("close")},Ok:function(){var e=$("#dialog-select-signature [name=sig]:checked").val(),r=n[e],a=tripwire.client.signatures[r.initialID],u=tripwire.client.signatures[r.secondaryID];s.signatures.update.push({wormhole:{id:r.id},signatures:[{id:a.id},{id:u.id,systemID:i}]});tripwire.refresh("refresh",s,function(e){e.resultSet&&1==e.resultSet[0].result&&(t.push({wormhole:r,signatures:[a,u]}),$("#dialog-select-signature").dialog("close"))})}},open:function(){$("#dialog-select-signature .optionsTable tbody").empty(),$.each(n,function(e){var i=tripwire.client.signatures[n[e].initialID],t="<tr><td><input type='radio' name='sig' value='"+e+"' id='sig"+e+"' /></td>"+$("#sigTable tr[data-id='"+i.id+"']").html()+"</tr>";$("#dialog-select-signature .optionsTable tbody").append(t),$("#dialog-select-signature .optionsTable tbody td").wrapInner("<label for='sig"+e+"' />")})}});else{var a=n[0],u=tripwire.client.signatures[a.initialID],l=tripwire.client.signatures[a.secondaryID];s.signatures.update.push({wormhole:{id:a.id},signatures:[{id:u.id},{id:l.id,systemID:i}]}),t.push({wormhole:a,signatures:[u,l]})}else s.signatures.add.push({wormhole:{type:null,parent:"initial",life:"stable",mass:"stable"},signatures:[{systemID:e,type:"wormhole"},{systemID:i,type:"wormhole"}]});if(s.signatures.add.length||s.signatures.update.length){tripwire.refresh("refresh",s,function(e){e.resultSet&&1==e.resultSet[0].result&&($("#undo").removeClass("disabled"),e.results&&(viewingSystemID in tripwire.signatures.undo?tripwire.signatures.undo[viewingSystemID].push({action:"add",signatures:e.results}):tripwire.signatures.undo[viewingSystemID]=[{action:"add",signatures:e.results}]),t.length&&(viewingSystemID in tripwire.signatures.undo?tripwire.signatures.undo[viewingSystemID].push({action:"update",signatures:t}):tripwire.signatures.undo[viewingSystemID]=[{action:"update",signatures:t}]),sessionStorage.setItem("tripwire_undo",JSON.stringify(tripwire.signatures.undo)))})}};
