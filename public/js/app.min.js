...
var chain=new function(){this.map,this.view,this.options,this.drawing,this.data={},this.newView=function(i){return this.view=new google.visualization.DataView(new google.visualization.DataTable(i)),this.view},this.activity=function(i){for(var e=0,t=(s=document.querySelectorAll("#chainMap .nodeActivity span")).length;e<t;++e)s[e].className=s[e].className+" invisible";var s;for(e=0,t=(s=document.querySelectorAll("#chainMap [data-nodeid]")).length;e<t;++e){var a=s[e].getAttribute("data-nodeid");if(i[a]){var n=i[a].shipJumps,l=i[a].podKills,r=i[a].shipKills,c=i[a].npcKills,o=s[e].getElementsByClassName("nodeActivity")[0];if(n>0){var d=o.getElementsByClassName("jumps")[0];d.className=d.className.replace(/invisible/g,""),d.setAttribute("data-tooltip",n+" Jumps")}if(l>0){var p=o.getElementsByClassName("pods")[0];p.className=p.className.replace(/invisible/g,""),p.setAttribute("data-tooltip",l+" Pod Kills")}if(r>0){var h=o.getElementsByClassName("ships")[0];h.className=h.className.replace(/invisible/g,""),h.setAttribute("data-tooltip",r+" Ship Kills")}if(c>0){var v=o.getElementsByClassName("npcs")[0];v.className=v.className.replace(/invisible/g,""),v.setAttribute("data-tooltip",c+" NPC Kills")}}}return SystemActivityToolTips.attachedElements&&SystemActivityToolTips.attachedElements.length>0&&SystemActivityToolTips.detach($("#chainMap .whEffect")),SystemActivityToolTips.attach($("#chainMap .nodeActivity > span[data-tooltip]:not(.invisible)")),i},this.occupied=function(i){for(var e in $("#chainMap [data-icon='user'], #chainMap [data-icon='user'] + .badge").addClass("invisible"),i)$("#chainMap [data-nodeid='"+i[e].systemID+"'] [data-icon='user']").removeClass("invisible"),$("#chainMap [data-nodeid='"+i[e].systemID+"'] [data-icon='user'] + .badge").removeClass("invisible").html(i[e].count);return OccupiedToolTips.attach($("#chainMap [data-icon='user']:not(.invisible)")),i},this.flares=function(i){if($("#chainMap td.node").removeClass("redNode yellowNode greenNode"),$("#chainGrid tr").removeClass("red yellow green"),i)for(var e in i.flares){var t=i.flares[e].systemID,s=i.flares[e].flare,a=($("#chainMap [data-nodeid="+t+"]").parent().addClass(s+"Node").parent().index()-1)/3*2;a>0&&$("#chainGrid tr:eq("+a+")").addClass(s).next().addClass(s)}return i},this.grid=function(){if(0==options.chain.gridlines)return $("#chainGrid tr").addClass("hidden"),!1;$("#chainGrid tr").removeClass("hidden");var i=Math.max(0,2*$(".google-visualization-orgchart-table tr:has(.node)").length-1);$("#chainGrid tr:gt("+i+")").addClass("hidden")},this.lines=function(i){function e(e,t,s,a){var n=$("#chainMap #node"+e).parent();if(0==n.length)return!1;var l=Math.ceil((n[0].cellIndex+1)/2-1),r=$(n.parent().prev().children("td.google-visualization-orgchart-lineleft, td.google-visualization-orgchart-lineright")[l]).addClass("left-"+s+" right-"+s),c=$("#chainMap #node"+t).parent();if(0==c.length||0==r.length)return!1;var o=0,d=r[0].cellIndex;n.parent().prev().find("td").each(function(i){if(o+=this.colSpan,i==d)return!1});for(var p=Math.ceil((c[0].cellIndex+1)/2-1),h=p,v=0;v<=p;v++){var u=0;n.parent().prev().prev().prev().find("td > [data-nodeid]").each(function(i){if(i==v)return u=$(this).attr("id").replace("node",""),!1}),$.map(i.map.rows,function(i){return i.c[1].v==u?i:null}).length<=0&&h--}p=h;var m=$(n.parent().prev().prev().children("td.google-visualization-orgchart-lineleft, td.google-visualization-orgchart-lineright")[p]).addClass("left-"+s+" right-"+s),y=0,f=(t=!1,!1);n.parent().prev().prev().find("td").each(function(i,e){if(y+=this.colSpan,f&&t)return!1;if(void 0!==m[0]&&m[0].cellIndex==i){if(t=!0,$(this).addClass("left-"+s),f||y==o||$(this).addClass("bottom-"+s),o==y)return!1}else if(y==o)f=!0,$(this).addClass("bottom-"+s);else if(f||t){var a=0,l=!1,r=!1;if(n.parent().prev().find("td").each(function(i){if((a+=this.colSpan)==y&&($(this).hasClass("google-visualization-orgchart-lineleft")||$(this).hasClass("google-visualization-orgchart-lineright"))){if(0==t)return l=!0,m.removeClass("left-"+s+" right-"+s),!1;1==t&&(m.removeClass("left-"+s+" right-"+s),n.parent().prev().prev().find("td").each(function(i){i>=m[0].cellIndex&&$(this).removeClass("bottom-"+s)}),r=!0)}}),l)return!1;r||$(this).addClass("bottom-"+s)}})}for(var t in i.lines)e(i.lines[t][0],i.lines[t][1],i.lines[t][2],i.lines[t][3])},this.nodes=function(i){var e={cols:[{label:"System",type:"string"},{label:"Parent",type:"string"}],rows:[]},t=["Q003","E004","L005","Z006","M001","C008","G008","A009","SML","MED","LRG","XLG"],s=[];function a(i,e){if(!i||!tripwire.systems[i])return!1;return n(i,e,null,options.chain.tabs[options.chain.active]&&0!=options.chain.tabs[options.chain.active].systemID?options.chain.tabs[options.chain.active].name:void 0,"&nbsp;")}function n(i,e,t,s,a){var n=function(i){const e=tripwire.systems[i];var t="string"==typeof i&&i.indexOf("|")>=0?tripwire.aSigSystems[i.substring(0,i.indexOf("|"))]:null;const s=e?e.class:t&&"Class-"==t.substring(0,6)?1*t.substring(6):void 0,a=e?e.security:"High-Sec"==t?.8:"Low-Sec"==t?.4:"Null-Sec"==t?-.1:void 0;return s?"<span class='wh class-"+s+"'>C"+s+"</span>":a>=.45?"<span class='hisec'>HS</span>":a>0?"<span class='lowsec'>LS</span>":a<=0?"<span class='nullsec'>NS</span>":"&nbsp;"}(i);const l=tripwire.systems[i];var r=null,c=null;if(l&&l.effect){switch(l.effect){case"Black Hole":r="blackhole";break;case"Cataclysmic Variable":r="cataclysmic-variable";break;case"Magnetar":r="magnetar";break;case"Pulsar":r="pulsar";break;case"Red Giant":r="red-giant";break;case"Wolf-Rayet Star":r="wolf-rayet"}c=l.effect}var o={v:e},d="<div id='node"+e+"' data-nodeid='"+i+"'"+(t?" data-sigid='"+t+"'":null)+"><div class='nodeIcons'><div style='float: left;'><i class='whEffect' "+(r?"data-icon='"+r+"' data-tooltip='"+c+"'":null)+"></i></div><div style='float: right;'><i data-icon='user' class='invisible'></i><span class='badge invisible'></span></div></div><h4 class='nodeClass'>"+n+"</h4><h4 class='nodeSystem'>"+(l?"<a href='.?system="+l.name+"'>"+(s||l.name)+"</a>":s||"&nbsp;")+"</h4><h4 class='nodeType'>"+a+"</h4><div class='statics'>"+function(i){if(!i)return"";const e={"High-Sec":"H","Low-Sec":"L","Null-Sec":"N","Class 1":"1","Class 2":"2","Class 3":"3","Class 4":"4","Class 5":5,"Class 6":6},t={H:"hisec",L:"lowsec",N:"nullsec"};return i.map(function(i){const s=e[tripwire.wormholes[i].leadsTo];return'<span class="'+(t[s]||"class-"+s)+'" data-tooltip="'+tripwire.wormholes[i].leadsTo+" via "+i+'">'+s+"</span>"}).join("")}(l?l.statics:[])+"</div><div class='nodeActivity'><span class='jumps invisible'>&#9679;</span>&nbsp;<span class='pods invisible'>&#9679;</span>&nbsp;&nbsp;<span class='ships invisible'>&#9679;</span>&nbsp;<span class='npcs invisible'>&#9679;</span></div></div>";return o.f=d,o}function l(i,e,t){var s=guidance.findShortestPath(tripwire.map.shortest,[t-3e7,e.child.systemID-3e7]),a={life:"Gate",parent:{}};return a.parent.id=e.child.id,a.parent.systemID=e.child.systemID,a.parent.name=e.child.name,a.parent.type=e.child.type,a.parent.nth=e.child.nth,a.child={},a.child.id=++i,a.child.systemID=t,a.child.name=tripwire.systems[t].name,a.child.path=s,a.child.jumps=s.length-1,a.child.nth=null,{childID:i,calcNode:a}}function r(i){if(i[0]<=0)return!1;var e=parseInt(i[1]),t=o.length;for(var s in d){var a=d[s];if(-1==$.inArray(a.id,h)){var n,r,c,v,u,m,y;if("secondary"==a.parent?(n=tripwire.client.signatures[a.secondaryID],r=tripwire.client.signatures[a.initialID]):(n=tripwire.client.signatures[a.initialID],r=tripwire.client.signatures[a.secondaryID]),c=a.type,"K162",n&&n.systemID==i[0])v=n,u=r,m="K162",y=c;else{if(!r||r.systemID!=i[0])continue;v=r,u=n,y="K162",m=c}var f={};if(f.id=a.id,f.life=a.life,f.mass=a.mass,f.time=v.modifiedTime,f.parent={},f.parent.id=e,f.parent.systemID=tripwire.systems[v.systemID]?v.systemID:v.systemID+"|"+Math.floor(Math.random()*Math.floor(1e4)),f.parent.name=v.name,f.parent.type=m,f.parent.typeBM=null,f.parent.classBM=null,f.parent.nth=null,f.parent.signatureID=u.signatureID,f.child={},f.child.id=++t,f.child.systemID=tripwire.systems[u.systemID]?u.systemID:u.systemID+"|"+Math.floor(Math.random()*Math.floor(1e4)),f.child.name=u.name,f.child.type=y,f.child.typeBM=null,f.child.classBM=null,f.child.nth=null,f.child.signatureID=v.signatureID,p.push(f),o.push([f.child.systemID,f.child.id,i[2]]),h.push(f.id),$("#show-viewing").hasClass("active")&&tripwire.systems[f.child.systemID]&&!tripwire.systems[viewingSystemID].class&&!tripwire.systems[f.child.systemID].class)t=(g=l(t,f,viewingSystemID)).childID,p.push(g.calcNode),o.push([0,t]);if($("#show-favorite").hasClass("active")&&tripwire.systems[f.child.systemID])for(var s in options.favorites){var g;if(!(tripwire.systems[options.favorites[s]].regionID>=11e6||tripwire.systems[f.child.systemID].regionID>=11e6))t=(g=l(t,f,options.favorites[s])).childID,p.push(g.calcNode),o.push([0,t])}}}}if($("#chainTabs .current").length>0){var c=$("#chainTabs .current .name").data("tab").toString().split(","),o=[],d=i,p=[],h=[];if(0==c){let t=0;Object.keys(i).slice().forEach(s=>{const n=tripwire.client.signatures[i[s].initialID],l=tripwire.client.signatures[i[s].secondaryID];n&&tripwire.systems[n.systemID]&&void 0===tripwire.systems[n.systemID].class?(t++,e.rows.push({c:[a(n.systemID,t),{v:null}]}),o.push([n.systemID,t,n.systemID])):l&&tripwire.systems[l.systemID]&&void 0===tripwire.systems[l.systemID].class&&(t++,e.rows.push({c:[a(l.systemID,t),{v:null}]}),o.push([l.systemID,t,l.systemID]))})}else for(var v in c)e.rows.push({c:[a(c[v],parseInt(v)+1),{v:null}]}),o.push([c[v],parseInt(v)+1,c[v]]);for(var u=0;u<o.length;u++)r(o[u])}else{$("#chainError").hide();var m={c:[]},y=viewingSystemID;m.c.push(a(y,1),{v:null}),e.rows.push(m);for(o=[[y,1]],d=i,p=[],h=[],u=0;u<o.length;++u)r(o[u])}for(var v in p){var f=p[v];m={c:[]};const i=f.child.path?this.renderPath(f.child.path):"id"==options.chain["node-reference"]?f.child.signatureID?f.child.signatureID.substring(0,3):"&nbsp;":(f.child.type||"&nbsp;")+sigFormat(f.child.typeBM,"type")||"&nbsp;",a=n(f.child.systemID,f.child.id,f.id,f.parent.name,i);var g={v:f.parent.id};m.c.push(a,g),e.rows.push(m),"critical"!=f.life||-1==$.inArray(f.parent.type,t)&&-1==$.inArray(f.child.type,t)?"critical"==f.life&&"critical"==f.mass?s.push(Array(a.v,g.v,"eol-critical",f.id)):"critical"==f.life&&"destab"==f.mass?s.push(Array(a.v,g.v,"eol-destab",f.id)):-1!=$.inArray(f.parent.type,t)||-1!=$.inArray(f.child.type,t)?s.push(Array(a.v,g.v,"frig",f.id)):"critical"==f.life?s.push(Array(a.v,g.v,"eol",f.id)):"critical"==f.mass?s.push(Array(a.v,g.v,"critical",f.id)):"destab"==f.mass?s.push(Array(a.v,g.v,"destab",f.id)):"Gate"!=f.life&&"GATE"!=f.parent.type&&"GATE"!=f.child.type||s.push(Array(a.v,g.v,"gate",f.id)):s.push(Array(a.v,g.v,"eol-frig",f.id))}return s.reverse(),{map:e,lines:s}},this.renderPath=function(i){if(i.length<=1||i.length>options.chain.routingLimit)return""+i.length-1;for(var e=i.slice(0,i.length-1).reverse().map(function(i){var e=appData.systems[3e7+1*i];return'<span class="'+(e.security>=.45?"hisec":e.security>=0?"lowsec":"nullsec")+'" data-tooltip="'+e.name+" ("+e.security+')">&#x25a0</span>'}),t='<span class="path">',s=0;s<e.length;s++)s>0&&0==s%5&&(t+="|"),t+=e[s];return t+"</span>"},this.redraw=function(){var i=$.extend(!0,{},this.data);i.map=$.extend(!0,{},i.rawMap),this.draw(i)};var i=null;this.draw=function(e){e=void 0!==e?e:{};if(clearTimeout(i),!this.map||Object.size(e.map)&&!tripwire.client.signatures)i=setTimeout(function(){chain.draw(e)},100);else{if(e.map){if(this.drawing=!0,this.data.rawMap=$.extend(!0,{},e.map),Object.sort(e.map,"id"),$.extend(e,this.nodes(e.map)),$.extend(this.data,e),this.map.draw(this.newView(e.map),this.options),options.chain.tabs[options.chain.active])for(var t in options.chain.tabs[options.chain.active].collapsed){var s=$("#chainMap [data-nodeid='"+options.chain.tabs[options.chain.active].collapsed[t]+"']").attr("id");s&&(s=s.split("node")[1],this.map.collapse(s-1,!0))}this.lines(e),this.grid(),$("#chainMap [data-nodeid='"+viewingSystemID+"']").parent().addClass("currentNode"),WormholeTypeToolTips.attachedElements&&WormholeTypeToolTips.attachedElements.length>0&&WormholeTypeToolTips.detach($("#chainMap .whEffect")),WormholeTypeToolTips.attach($("#chainMap .whEffect[data-icon]")),WormholeRouteToolTips.attach($("#chainMap .path span[data-tooltip]")),this.drawing=!1}!this.data.activity||new Date>this.data.activity.expires?(e.activity={},tripwire.esi.universeJumps().done(function(i,t,s){e.activity.expires=new Date(s.getResponseHeader("expires")),$.each(i,function(t){e.activity[i[t].system_id]={systemID:i[t].system_id,shipJumps:i[t].ship_jumps}})}).then(function(){return tripwire.esi.universeKills().done(function(i){$.each(i,function(t){e.activity[i[t].system_id]?(e.activity[i[t].system_id].podKills=i[t].pod_kills,e.activity[i[t].system_id].shipKills=i[t].ship_kills,e.activity[i[t].system_id].npcKills=i[t].npc_kills):e.activity[i[t].system_id]={systemID:i[t].system_id,podKills:i[t].pod_kills,shipKills:i[t].ship_kills,npcKills:i[t].npc_kills}})})}).then(function(){chain.data.activity=chain.activity(e.activity)})):e.map&&chain.activity(this.data.activity),e.occupied&&(this.data.occupied=this.occupied(e.occupied)),e.flares&&(this.data.flares=this.flares(e.flares))}},this.collapse=function(i){if(chain.drawing)return!1;if(options.chain.tabs[options.chain.active]){var e=chain.map.getCollapsedNodes();for(x in options.chain.tabs[options.chain.active].collapsed=[],e){var t=$("#chainMap #node"+(e[x]+1)).data("nodeid");options.chain.tabs[options.chain.active].collapsed.push(t)}}chain.lines(chain.data),$("#chainMap [data-nodeid='"+viewingSystemID+"']").parent().addClass("currentNode"),WormholeTypeToolTips.attachedElements&&WormholeTypeToolTips.attachedElements.length>0&&WormholeTypeToolTips.detach($("#chainMap .whEffect")),WormholeTypeToolTips.attach($("#chainMap .whEffect[data-icon]")),chain.activity(chain.data.activity),chain.occupied(chain.data.occupied),chain.flares(chain.data.flares),chain.grid(),options.save()},this.init=function(){chain.map=new google.visualization.OrgChart(document.getElementById("chainMap")),chain.options={allowHtml:!0,allowCollapse:!0,size:"medium",nodeClass:"node"},google.visualization.events.addListener(chain.map,"collapse",chain.collapse),chain.map.draw(new google.visualization.DataView(new google.visualization.DataTable({cols:[{label:"System",type:"string"},{label:"Parent",type:"string"}]})),this.options)},google.charts.setOnLoadCallback(this.init)};
