...
var guidance=function(e){var r=function(e){var r=[];for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&r.push(n);return r},n=function(e,r){return parseFloat(e)-parseFloat(r)};function t(e,r){if(!(r=systemAnalysis.analyse(3e7+1*r)))return e;switch(options.chain.routeIgnore.enabled&&options.chain.routeIgnore.systems.indexOf(r.name)>=0&&(e+=100),options.chain.routeSecurity){case"highsec":return e+(r.security<.45?100:0);case"avoid-high":return e+(r.security>=.45?100:0);case"avoid-null":return e+(r.security<=0?100:0);default:return e}}var a=function(e,a,o,i){if(!e[a]||!e[o])return null;i=i||1/0;var c,u={},s={0:[a]},h={},l=function(e,r){var n=""+e;s[n]||(s[n]=[]),s[n].push(r)};for(u[a]=0;s&&!u[o]&&(c=r(s)).length;){c.sort(n);var f=c[0],p=s[f],v=p.shift(),y=parseFloat(f),d=e[v]||{};for(var g in p.length||delete s[f],d)if(Object.prototype.hasOwnProperty.call(d,g)){var S=t(d[g],g)+y,C=u[g];(void 0===C||C>S)&&(u[g]=S,l(S,g),h[g]=v)}}return void 0===u[o]?null:h},o=function(e,r){for(var n=[],t=r;t;)n.push(t),predecessor=e[t],t=e[t];return n.reverse(),n},i={kSpaceCache:{},clearCache:function(){i.kSpaceCache={}}};return i.findShortestPath=function(e,r,n){const t=[r,n],c=t.join(","),u=i.kSpaceCache[c];return void 0===u?i.kSpaceCache[c]=function(e,r){for(var n,t,i,c=r.shift(),u=[];r.length;){if(n=r.shift(),!(t=a(e,c,n)))return null;if(i=o(t,n),!r.length)return u.concat(i);u.push.apply(u,i.slice(0,-1)),c=n}}(e,t):u},i}();
const systemRendering=new function(){this.renderPath=function(t){if(t.length<=1||t.length>options.chain.routingLimit)return""+t.length-1;for(var e=t.slice(0,t.length-1).reverse().map(function(t){const e=3e7+1*t,n=systemAnalysis.analyse(e);return'<span class="'+n.systemTypeClass+'" data-tooltip="'+n.name+" ("+n.security+')" onclick="tripwire.systemChange('+e+')">'+n.pathSymbol+"</span>"}),n='<span class="path">',s=0;s<e.length;s++)s>0&&0==s%5&&(n+="|"),n+=e[s];return n+"</span>"},this.renderEffect=function(t,e){return t.effectClass?"<"+e+" class='whEffect' data-icon='"+t.effectClass+"' data-tooltip='"+t.effect+"'></"+e+">":""}};
...
var chain=new function(){var e=this;this.map,this.view,this.drawing,this.data={},thirdPartySuppliers=[];const i={orgChart:new ChainMapRendererOrgchart(this),radial:new ChainMapRendererRadial(this)};this.renderer=i[options.chain.renderer],this.renderer.switchTo(),this.useRenderer=function(e){if(!i[e])throw"Unknown renderer "+e;this.renderer!=i[e]&&(this.renderer.switchFrom(),this.renderer=i[e],this.renderer.switchTo(),this.redraw())},this.activity=function(e){for(var i=0,s=(t=document.querySelectorAll("#chainMap .nodeActivity span")).length;i<s;++i)t[i].className=t[i].className+" invisible";var t;for(i=0,s=(t=document.querySelectorAll("#chainMap [data-nodeid]")).length;i<s;++i){var a=t[i].getAttribute("data-nodeid");if(e[a]){var n=e[a].shipJumps,r=e[a].podKills,l=e[a].shipKills,c=e[a].npcKills,o=t[i].getElementsByClassName("nodeActivity")[0];if(n>0){var d=o.getElementsByClassName("jumps")[0];d.className=d.className.replace(/invisible/g,""),d.setAttribute("data-tooltip",n+" Jumps")}if(r>0){var h=o.getElementsByClassName("pods")[0];h.className=h.className.replace(/invisible/g,""),h.setAttribute("data-tooltip",r+" Pod Kills")}if(l>0){var p=o.getElementsByClassName("ships")[0];p.className=p.className.replace(/invisible/g,""),p.setAttribute("data-tooltip",l+" Ship Kills")}if(c>0){var m=o.getElementsByClassName("npcs")[0];m.className=m.className.replace(/invisible/g,""),m.setAttribute("data-tooltip",c+" NPC Kills")}}}return SystemActivityToolTips.attachedElements&&SystemActivityToolTips.attachedElements.length>0&&SystemActivityToolTips.detach($("#chainMap .whEffect")),SystemActivityToolTips.attach($("#chainMap .nodeActivity > span[data-tooltip]:not(.invisible)")),e},this.occupied=function(e){for(var i in $("#chainMap [data-icon='user'], #chainMap [data-icon='user'] + .badge").addClass("invisible"),e)$("#chainMap [data-nodeid='"+e[i].systemID+"'] [data-icon='user']").removeClass("invisible"),$("#chainMap [data-nodeid='"+e[i].systemID+"'] [data-icon='user'] + .badge").removeClass("invisible").html(e[i].count);return OccupiedToolTips.attach($("#chainMap [data-icon='user']:not(.invisible)")),e},this.flares=function(e){if($("#chainMap div.node").removeClass("redNode yellowNode greenNode"),$("#chainGrid tr").removeClass("red yellow green"),e)for(var i in e.flares){var s=e.flares[i].systemID,t=e.flares[i].flare,a=($("#chainMap [data-nodeid="+s+"]").addClass(t+"Node").parent().index()-1)/3*2;a>0&&$("#chainGrid tr:eq("+a+")").addClass(t).next().addClass(t)}return e},this.grid=function(){if(0==options.chain.gridlines)return $("#chainGrid tr").addClass("hidden"),!1;$("#chainGrid tr").removeClass("hidden");var e=Math.max(0,2*$(".google-visualization-orgchart-table tr:has(.node)").length-1);$("#chainGrid tr:gt("+e+")").addClass("hidden")},this.nodes=function(e){var i={cols:[{label:"System",type:"string"},{label:"Parent",type:"string"}],rows:[]},s=["Q003","E004","L005","Z006","M001","C008","G008","A009","SML"],t=[];function a(e,i){if(!e||!tripwire.systems[e])return!1;const s=options.chain.tabs[options.chain.active];return n(e,i,null,null,s&&0!=s.systemID&&0>s.systemID.indexOf(",")?options.chain.tabs[options.chain.active].name:void 0,"&nbsp;",["top-level"])}function n(e,i,s,t,a,n,r){const l=systemAnalysis.analyse(e);var c="<span class='"+l.systemTypeClass+"'>"+l.systemTypeName+l.systemTypeModifiers.join("")+"</span>";a=_.escape(a);const o="name"==options.chain.sigNameLocation?a||(l.name?l.name:"&nbsp;"):"name_prefix"==options.chain.sigNameLocation&&a?a+(l.name?" - "+l.name:""):l.name?l.name:"&nbsp;";var d={v:i,systemID:e},h="<div id='node"+i+"' data-nodeid='"+e+"'"+(s?" data-sigid='"+s+"'":"")+(t?" data-inSigid='"+t+"'":"")+" class='node "+(r||[]).join(" ")+"'><div class='nodeIcons'><div style='float: left;'>"+systemRendering.renderEffect(l,"i")+"</div><div style='float: right;'><i data-icon='user' class='invisible'></i><span class='badge invisible'></span></div></div><h4 class='nodeClass'>"+c+"</h4><h4 class='nodeSystem'>"+(l.name?"<a href='.?system="+l.name+"'>"+o+"</a>":o)+"</h4><h4 class='nodeType'>"+n+"</h4><div class='statics'>"+function(e){if(!e)return"";const i={"High-Sec":"H","Low-Sec":"L","Null-Sec":"N",Triglavian:"▼","Class 1":"1","Class 2":"2","Class 3":"3","Class 4":"4","Class 5":5,"Class 6":6},s={H:"hisec",L:"lowsec",N:"nullsec","▼":"triglavian"};return e.map(function(e){const t=i[tripwire.wormholes[e].leadsTo];return'<span class="'+(s[t]||"class-"+t)+'" data-tooltip="'+tripwire.wormholes[e].leadsTo+" via "+e+'">'+t+"</span>"}).join("")}(l.name?l.statics:[])+"</div><div class='nodeActivity'><span class='jumps invisible'>&#9679;</span>&nbsp;<span class='pods invisible'>&#9679;</span>&nbsp;&nbsp;<span class='ships invisible'>&#9679;</span>&nbsp;<span class='npcs invisible'>&#9679;</span></div></div>";return d.f=h,d}function r(e,i,s){var t=guidance.findShortestPath(tripwire.map.shortest,s-3e7,i.child.systemID-3e7);if(!t)return null;var a={calculated:!0,life:"Gate",parent:{}};return a.parent.id=i.child.id,a.parent.systemID=i.child.systemID,a.parent.name=i.child.name,a.parent.type=i.child.type,a.parent.nth=i.child.nth,a.child={},a.child.id=++e,a.child.systemID=s,a.child.name=tripwire.systems[s].name,a.child.path=t,a.child.jumps=t.length-1,a.child.nth=null,{childID:e,calcNode:a}}function l(e){if(e[0]<=0)return!1;var i=parseInt(e[1]),s=o.length;const t=[],a=function(e){$("#show-viewing").hasClass("active")&&tripwire.systems[e.child.systemID]&&!tripwire.systems[viewingSystemID].class&&!tripwire.systems[e.child.systemID].class&&viewingSystemID!=e.child.systemID&&((t=r(s,e,viewingSystemID))&&(s=t.childID,h.push(t.calcNode),o.push([0,s])));if($("#show-favorite").hasClass("active")&&tripwire.systems[e.child.systemID]&&!tripwire.systems[e.child.systemID].class)for(var i in options.favorites){var t;if(!(tripwire.systems[options.favorites[i]].regionID>=11e6||tripwire.systems[e.child.systemID].regionID>=11e6||options.favorites[i]==e.child.systemID))(t=r(s,e,options.favorites[i]))&&(s=t.childID,h.push(t.calcNode),o.push([0,s]))}};for(var n in d){var l=d[n];if(-1==$.inArray(l.id,p)){var c,m,y,u,v,f,g;if("secondary"==l.parent?(c=tripwire.client.signatures[l.secondaryID],m=tripwire.client.signatures[l.initialID]):(c=tripwire.client.signatures[l.initialID],m=tripwire.client.signatures[l.secondaryID]),y=l.type,"K162",c&&c.systemID==e[0])u=c,v=m,f="K162",g=y;else{if(!m||m.systemID!=e[0])continue;u=m,v=c,g="K162",f=y}var I={};I.id=l.id,I.life=l.life,I.mass=l.mass,I.time=u.modifiedTime,I.parent={},I.parent.id=i,I.parent.systemID=tripwire.systems[u.systemID]?u.systemID:u.systemID+"|"+Math.floor(Math.random()*Math.floor(1e4)),I.parent.name=v.name,I.parent.type=f,I.parent.typeBM=null,I.parent.classBM=null,I.parent.nth=null,I.parent.signatureID=v.signatureID,I.parent.sigIndex=v.id,I.child={},I.child.id=++s,I.child.systemID=tripwire.systems[v.systemID]?v.systemID:v.systemID+"|"+Math.floor(Math.random()*Math.floor(1e4)),I.child.name=u.name,I.child.type=g,I.child.typeBM=null,I.child.classBM=null,I.child.nth=null,I.child.signatureID=u.signatureID,I.child.sigIndex=u.id,h.push(I),o.push([I.child.systemID,I.child.id,e[2]]),p.push(I.id),tripwire.systems[v.systemID]&&t.push(1*v.systemID),a(I)}}thirdPartySuppliers.forEach(function(n){const r={parentID:i,nextChildID:++s},l=n.findLinks(1*e[0],r);if(l){s=r.nextChildID-1;for(var c=0;c<l.length;c++){var d=l[c];0>p.indexOf(d.id)&&(0>t.indexOf(d.child.systemID)&&(d.thirdParty=n.nodeNameSuffix,h.push(d),o.push([d.child.systemID,d.child.id,e[2]]),t.push(d.child.systemID),a(d)),p.push(d.id))}}})}if($("#chainTabs .current").length>0){var c=$("#chainTabs .current .name").data("tab").toString().split(","),o=[],d=e,h=[],p=[];if(0==c){let s=0;Object.keys(e).slice().forEach(t=>{const n=tripwire.client.signatures[e[t].initialID],r=tripwire.client.signatures[e[t].secondaryID];n&&tripwire.systems[n.systemID]&&void 0===tripwire.systems[n.systemID].class?(s++,i.rows.push({c:[a(n.systemID,s),{v:null}]}),o.push([n.systemID,s,n.systemID])):r&&tripwire.systems[r.systemID]&&void 0===tripwire.systems[r.systemID].class&&(s++,i.rows.push({c:[a(r.systemID,s),{v:null}]}),o.push([r.systemID,s,r.systemID]))})}else for(var m in c)i.rows.push({c:[a(c[m],parseInt(m)+1),{v:null}]}),o.push([c[m],parseInt(m)+1,c[m]]);for(var y=0;y<o.length;y++)l(o[y])}else{$("#chainError").hide();var u={c:[]},v=viewingSystemID;u.c.push(a(v,1),{v:null}),i.rows.push(u);for(o=[[v,1]],d=e,h=[],p=[],y=0;y<o.length;++y)l(o[y])}const f={};var g=null;for(var m in h){var I=h[m];u={c:[]};const e="id"==options.chain["node-reference"]?I.child.signatureID?I.child.signatureID.substring(0,3):"???":(I.child.type||"(?)")+sigFormat(I.child.typeBM,"type"),a=I.child.path?systemRendering.renderPath(I.child.path):(I.child.sigIndex?"<a href='#' onclick='sigDialog.openSignatureDialog({data: { signature: "+I.child.sigIndex+', mode: "update" }}); return false;\'>':"")+_.escape(I.child.name&&"ref"==options.chain.sigNameLocation?I.child.name:I.child.name&&"ref_prefix"==options.chain.sigNameLocation?I.child.name+" - "+e:e)+(I.child.sigIndex?"</a>":""),r=I.calculated?["calc"]:f[I.child.systemID]?["loop"]:[];I.thirdParty&&r.push("third-party","third-party-"+I.thirdParty);var w=[];"critical"==I.life&&w.push("eol"),"critical"==I.mass?w.push("critical"):"destab"==I.mass&&w.push("destab"),-1==$.inArray(I.parent.type,s)&&-1==$.inArray(I.child.type,s)||w.push("frig");const l=(f[I.parent.systemID]||{chainModifiers:[]}).chainModifiers;u.chainModifiers=w.concat(l),u.chainModifiers.forEach(function(e){w.push(e+"-chain")});const c=n(I.child.systemID,I.child.id,I.id,I.child.sigIndex,I.child.name,a,r.concat(w));var D={v:I.parent.id};u.c.push(c,D),i.rows.push(u),w.length&&t.push(Array(c.v,D.v,w,I.id));const o=(f[I.parent.systemID]||{pathHome:[]}).pathHome;if(u.pathHome=o.concat(I.child),!I.calculated){f[I.child.systemID]=u;const e=guidance.findShortestPath(tripwire.map.shortest,viewingSystemID-3e7,I.child.systemID-3e7);e&&(viewingSystemID==I.child.systemID||e&&(!g||e.length<g.pathLength))&&(g={systemID:I.child.systemID,pathLength:e.length,pathHome:u.pathHome})}}return t.reverse(),{map:i,lines:t,closestToViewing:g}},this.setActiveTab=function(i){$("#chainTabs .tab").removeClass("current"),options.chain.active=i,null!=i&&$("#chainTabs .tab").eq(i).addClass("current"),options.save(),e.redraw(),tripwire.parse(tripwire.client,"refresh")},this.redraw=function(){this.useRenderer(options.chain.renderer);var e=$.extend(!0,{},this.data);e.map=$.extend(!0,{},e.rawMap),this.draw(e)};var s=null;this.draw=function(i){i=void 0!==i?i:{};if(clearTimeout(s),!this.renderer.ready()||Object.keys(i.map||{}).length&&!tripwire.client.signatures)s=setTimeout(function(){e.draw(i)},100);else{if(i.map){this.drawing=!0,this.data.rawMap=$.extend(!0,{},i.map),Object.sort(i.map,"id"),$.extend(i,this.nodes(i.map)),$.extend(this.data,i);const e=options.chain.tabs[options.chain.active]&&options.chain.tabs[options.chain.active].collapsed||[];if(this.renderer.draw(i.map,i.lines,e),this.grid(),$("#chainMap [data-nodeid='"+viewingSystemID+"']").parent().addClass("currentNode"),WormholeTypeToolTips.attachedElements&&WormholeTypeToolTips.attachedElements.length>0&&WormholeTypeToolTips.detach($("#chainMap .whEffect")),WormholeTypeToolTips.attach($("#chainMap .whEffect[data-icon]")),WormholeRouteToolTips.attach($("#chainMap .path span[data-tooltip]")),SystemActivityToolTips.attach($("#chainMap .nodeClass span[data-tooltip]")),i.closestToViewing){const e=i.closestToViewing.pathLength<=1,s=e?"In chain: ":i.closestToViewing.pathLength-1+"j from ",t=i.closestToViewing.pathHome.slice().reverse().map(function(e){return'<a href=".?system='+tripwire.systems[e.systemID].name+'">'+(e.name||e.signatureID||"???")+"</a>"}).join(" &gt; "),a=e?"":"<br/>"+systemRendering.renderPath(guidance.findShortestPath(tripwire.map.shortest,i.closestToViewing.systemID-3e7,viewingSystemID-3e7));$("#infoExtra").html(s+t+a),Tooltips.attach($("#infoExtra [data-tooltip]"))}else $("#infoExtra").text("");this.drawing=!1}!this.data.activity||new Date>this.data.activity.expires?(i.activity={},tripwire.esi.universeJumps().done(function(e,s,t){i.activity.expires=new Date(t.getResponseHeader("expires")),$.each(e,function(s){i.activity[e[s].system_id]={systemID:e[s].system_id,shipJumps:e[s].ship_jumps}})}).then(function(){return tripwire.esi.universeKills().done(function(e){$.each(e,function(s){i.activity[e[s].system_id]?(i.activity[e[s].system_id].podKills=e[s].pod_kills,i.activity[e[s].system_id].shipKills=e[s].ship_kills,i.activity[e[s].system_id].npcKills=e[s].npc_kills):i.activity[e[s].system_id]={systemID:e[s].system_id,podKills:e[s].pod_kills,shipKills:e[s].ship_kills,npcKills:e[s].npc_kills}})})}).then(function(){e.data.activity=e.activity(i.activity)})):i.map&&e.activity(this.data.activity),i.occupied&&(this.data.occupied=this.occupied(i.occupied)),i.flares&&(this.data.flares=this.flares(i.flares))}},this.updateCollapsed=function(i){options.chain.tabs[options.chain.active]&&(options.chain.tabs[options.chain.active].collapsed=i),$("#chainMap [data-nodeid='"+viewingSystemID+"']").parent().addClass("currentNode"),WormholeTypeToolTips.attachedElements&&WormholeTypeToolTips.attachedElements.length>0&&WormholeTypeToolTips.detach($("#chainMap .whEffect")),WormholeTypeToolTips.attach($("#chainMap .whEffect[data-icon]")),e.activity(e.data.activity),e.occupied(e.data.occupied),e.flares(e.data.flares),e.grid(),options.save()}};
...
const automapState={pendingDecision:!1};tripwire.autoMapper=function(e,i){var t=[];if(!$("#toggle-automapper").hasClass("active")||$("#toggle-automapper").hasClass("disabled"))return!1;if(automapState.pendingDecision)return console.info("Not automapping because there is an automap dialog up"),!1;if(!tripwire.systems[e]||!tripwire.systems[i])return!1;if(e==i)return!1;if(tripwire.systems[e].regionID>12e6||tripwire.systems[i].regionID>12e6)return console.info("Not automapping into abyssal or other special space"),!1;if(tripwire.client.EVE&&tripwire.client.EVE.stationID)return!1;if(tripwire.client.EVE&&tripwire.client.EVE.shipTypeID&&$.inArray(parseInt(tripwire.client.EVE.shipTypeID),[33328,670])>=0)return!1;if(void 0!==tripwire.map.shortest[e-3e7]&&void 0!==tripwire.map.shortest[e-3e7][i-3e7])return!1;if($.map(tripwire.client.wormholes,function(t){const s=tripwire.client.signatures[t.initialID],r=tripwire.client.signatures[t.secondaryID];return s&&r&&(s.systemID==e&&r.systemID==i||s.systemID==i&&r.systemID==e)?t:null}).length>0)return!1;function s(e){return chain.data.map.rows.filter(i=>i.c[0].systemID==e).length>0}if(s(e)&&s(i))return console.info("Not automapping because both systems are already in chain"),!1;var r,n={signatures:{add:[],update:[]}};r=tripwire.systems[i].class?"Class-"+tripwire.systems[i].class:tripwire.systems[i].security>=.45?"High-Sec":tripwire.systems[i].security>0?"Low-Sec":"Null-Sec";var a=$.map(tripwire.client.wormholes,function(i){if(void 0!==tripwire.client.signatures[i.initialID]&&void 0!==tripwire.client.signatures[i.secondaryID]&&tripwire.client.signatures[i.initialID].systemID==e&&!tripwire.systems[tripwire.client.signatures[i.secondaryID].systemID]){if(tripwire.aSigSystems[tripwire.client.signatures[i.secondaryID].systemID]==r)return i;if(i.type&&tripwire.wormholes[i.type]&&tripwire.wormholes[i.type].leadsTo.replace(" ","-")==r)return i;if(!(null!==tripwire.client.signatures[i.secondaryID].systemID||i.type&&tripwire.wormholes[i.type]))return i}});if(a.length)if(a.length>1)$("#dialog-select-signature").dialog({autoOpen:!0,title:"Which Signature?",width:390,buttons:{Cancel:function(){$(this).dialog("close")},Ok:function(){var e=$("#dialog-select-signature [name=sig]:checked").val(),s=a[e],r=tripwire.client.signatures[s.initialID],o=tripwire.client.signatures[s.secondaryID];n.signatures.update.push({wormhole:{id:s.id},signatures:[{id:r.id},{id:o.id,systemID:i}]});tripwire.refresh("refresh",n,function(e){e.resultSet&&1==e.resultSet[0].result&&(t.push({wormhole:s,signatures:[r,o]}),$("#dialog-select-signature").dialog("close"))})}},open:function(){function t(e){const i=systemAnalysis.analyse(e);return"<b>"+i.name+'</b> (<span class="'+i.systemTypeClass+'">'+i.systemTypeName+"</span>)"}automapState.pendingDecision=!0,$("#dialog-select-signature .optionsTable tbody").empty(),document.getElementById("select-sig-from").innerHTML=t(e),document.getElementById("select-sig-to").innerHTML=t(i),$.each(a,function(e){const i=tripwire.client.signatures[a[e].initialID],t=tripwire.makeSigInfo(i,a[e]),s="<tr><td><input type='radio' name='sig' value='"+e+"' id='sig"+e+"' /></td><td class='centerAlign'>"+formatSignatureID(i.signatureID)+"</td><td class='centerAlign'>"+t.formattedType+"</td><td class='centerAlign'>"+t.leadsTo+"</td><td class='centerAlign "+a[e].life+"'>"+t.lifeText+"</td><td class='centerAlign "+a[e].mass+"'>"+a[e].mass+"</td></tr>",r=$(s);$(r).find("td").wrapInner("<label for='sig"+e+"' />"),$("#dialog-select-signature .optionsTable tbody").append(r)})},close:function(){automapState.pendingDecision=!1}});else{var o=a[0],l=tripwire.client.signatures[o.initialID],u=tripwire.client.signatures[o.secondaryID];n.signatures.update.push({wormhole:{id:o.id},signatures:[{id:l.id},{id:u.id,systemID:i}]}),t.push({wormhole:o,signatures:[l,u]})}else n.signatures.add.push({wormhole:{type:null,parent:"initial",life:"stable",mass:"stable"},signatures:[{systemID:e,type:"wormhole"},{systemID:i,type:"wormhole"}]});if(n.signatures.add.length||n.signatures.update.length){tripwire.refresh("refresh",n,function(e){e.resultSet&&1==e.resultSet[0].result&&($("#undo").removeClass("disabled"),e.results&&(viewingSystemID in tripwire.signatures.undo?tripwire.signatures.undo[viewingSystemID].push({action:"add",signatures:e.results}):tripwire.signatures.undo[viewingSystemID]=[{action:"add",signatures:e.results}]),t.length&&(viewingSystemID in tripwire.signatures.undo?tripwire.signatures.undo[viewingSystemID].push({action:"update",signatures:t}):tripwire.signatures.undo[viewingSystemID]=[{action:"update",signatures:t}]),sessionStorage.setItem("tripwire_undo",JSON.stringify(tripwire.signatures.undo)))})}};
