Object.sort=function(e,r){var t,i;do{for(var o in t=!1,i=null,e){if(i&&Number(e[o][r])<Number(e[i][r])){var n=e[o];e[o]=e[i],e[i]=n,t=!0}i=o}}while(t)},Object.index=function(e,r,t,i){for(var o in e){if(!i&&e[o][r]==t)return o;if(e[o][r]&&e[o][r].toLowerCase()==t.toLowerCase())return o}},Object.find=function(e,r,t,i){for(var o in e){if(!i&&e[o][r]==t)return e[o];if(e[o][r]&&e[o][r].toLowerCase()==t.toLowerCase())return e[o]}return!1},Object.maxTime=function(e,r){var t,i="";for(var o in e)(!t||t<new Date(e[o][r]))&&(t=new Date(e[o][r]),i=e[o][r]);return i},Object.size=function(e){var r,t=0;for(r in e)e.hasOwnProperty(r)&&t++;return t},Object.time=function(e){var r,t=[];for(r in e)t.push(new Date(e[r].time));return t.length?t.sort()[t.length-1].getTime()/1e3:0},function(e){e.fn.serializeObject=function(){var r=this,t={},i={},o={validate:/^[a-zA-Z][a-zA-Z0-9_]*(?:\[(?:\d*|[a-zA-Z0-9_]+)\])*$/,key:/[a-zA-Z0-9_]+|(?=\[\])/g,push:/^$/,fixed:/^\d+$/,named:/^[a-zA-Z0-9_]+$/};return this.build=function(e,r,t){return e[r]=t,e},this.push_counter=function(e){return void 0===i[e]&&(i[e]=0),i[e]++},e.each(e(this).serializeArray(),function(){if(o.validate.test(this.name)){for(var i,n=this.name.match(o.key),s=this.value,a=this.name;void 0!==(i=n.pop());)a=a.replace(new RegExp("\\["+i+"\\]$"),""),i.match(o.push)?s=r.build([],r.push_counter(a),s):i.match(o.fixed)?s=r.build([],i,s):i.match(o.named)&&(s=r.build({},i,s));t=e.extend(!0,t,s)}}),t}}(jQuery);var numFormat=function(e){var r=e.toString().split(".");return r[0]=r[0].replace(/\B(?=(\d{3})+(?!\d))/g,","),r.join(".")},letterToNumbers=function(e){e=e.toUpperCase();var r,t="ABCDEFGHIJKLMNOPQRSTUVWXYZ",i=0;for(r=0;r<e.length;r++)i+=Math.pow(t.length,r)*(t.indexOf(e.substr(-1*(r+1),1))+1);return i},sigFormat=function(e,r){if(!e)return"";for(var t=/^[a-zA-Z]+$/,i=/^[0-9]+$/,o="type"==r?options.chain.typeFormat||"":options.chain.classFormat||"",n=0,s=o.length;n<s;n++)if(o[n].match(t)){if("B"==o[n].toUpperCase()&&"a"==e)return"";o=o[n]==o[n].toUpperCase()?o.substr(0,n)+e.toUpperCase()+o.substr(n+1,s):o.substr(0,n)+e+o.substr(n+1,s)}else if(o[n].match(i)){if(2==o[n]&&"a"==e)return"";o=o.substr(0,n)+letterToNumbers(e)+o.substr(n+1,s)}return o},sigClass=function(e,r){var t=$.map(tripwire.systems,function(r,t){return r.name==e?t:null})[0],i=e,o=t?tripwire.systems[t].class:null,n=t?tripwire.systems[t].security:null,s=r,a=null;return 6==o||"Class-6"==i||void 0!==tripwire.wormholes[s]&&"Class 6"==tripwire.wormholes[s].leadsTo?a="C6":5==o||"Class-5"==i||void 0!==tripwire.wormholes[s]&&"Class 5"==tripwire.wormholes[s].leadsTo?a="C5":4==o||"Class-4"==i||void 0!==tripwire.wormholes[s]&&"Class 4"==tripwire.wormholes[s].leadsTo?a="C4":3==o||"Class-3"==i||void 0!==tripwire.wormholes[s]&&"Class 3"==tripwire.wormholes[s].leadsTo?a="C3":2==o||"Class-2"==i||void 0!==tripwire.wormholes[s]&&"Class 2"==tripwire.wormholes[s].leadsTo?a="C2":1==o||"Class-1"==i||void 0!==tripwire.wormholes[s]&&"Class 1"==tripwire.wormholes[s].leadsTo?a="C1":n>=.45||"High-Sec"==i||void 0!==tripwire.wormholes[s]&&"High-Sec"==tripwire.wormholes[s].leadsTo&&!n?a="HS":n>0||"Low-Sec"==i||void 0!==tripwire.wormholes[s]&&"Low-Sec"==tripwire.wormholes[s].leadsTo&&!n?a="LS":(n<=0&&null!=n||"Null-Sec"==i||void 0!==tripwire.wormholes[s]&&"Null-Sec"==tripwire.wormholes[s].leadsTo)&&(a="NS"),a},isEmpty=function(e){for(var r in e)if(e.hasOwnProperty(r))return!1;return!0};function positionRelativeTo(e,r){const t=e.getBoundingClientRect(),i=r.getBoundingClientRect();return{left:t.left-i.left+r.scrollLeft,top:t.top-i.top+r.scrollTop}}function lookupMultiple(e,r,t,i){const o=t.split(","),n=[];for(var s=0;s<o.length;s++){const t=o[s],a=e[t];if(!a){if(i)return;throw"Value "+t+" did not match anything in "+e}n.push(a[r])}return n.join(",")}function lookupByPropertyMultiple(e,r,t,i){const o=t.split(","),n=[];for(var s=0;s<o.length;s++){const t=o[s],a=Object.index(e,r,t);if(!a){if(i)return;throw"Value "+t+" did not match anything by property "+r+" in "+e}n.push(a)}return n.join(",")}var getCookie=function(e){var r=document.cookie,t=r.indexOf(" "+e+"=");if(-1==t&&(t=r.indexOf(e+"=")),-1==t)r=null;else{t=r.indexOf("=",t)+1;var i=r.indexOf(";",t);-1==i&&(i=r.length),r=unescape(r.substring(t,i))}return r},setCookie=function(e,r,t){var i=new Date;i.setDate(i.getDate()+t);var o=escape(r)+(null==t?"":"; expires="+i.toUTCString());document.cookie=e+"="+o+";"+("https:"==document.location.protocol?"secure;":"")};!function(e){var r=e.fn.addClass,t=e.fn.removeClass;e.fn.addClass=function(e){var t=r.apply(this,arguments);return this.trigger("classchange",e),t},e.fn.removeClass=function(e){var r=t.apply(this,arguments);return this.trigger("classchange",e),r}}(jQuery);var parseHeaders=function(e){var r=e.trim().split(/[\r\n]+/),t={};return r.forEach(function(e){var r=e.split(": "),i=r.shift(),o=r.join(": ");t[i]=o}),t};
...
const ChainMapRendererRadial=function(t){this.ready=function(){return!this.drawing},this.switchTo=function(){if(!document.getElementById("map-container")){const t=document.createElement("div");t.id="map-container",t.className="radial-map",document.getElementById("chainMap").appendChild(t)}this.container=document.getElementById("map-container"),this.container.style.display=""},this.switchFrom=function(){const t=document.getElementById("map-container");t&&t.parentNode.removeChild(t),this.container=null},this.draw=function(t,n,e){this.drawing=!0,this.switchFrom(),this.switchTo();try{i(t,n,e)}finally{this.drawing=!1}};const n={x:70,y:45,first_ring_delta:.3,ringX:function(t){return 0==t?0:(t+this.first_ring_delta)*this.x},ringY:function(t){return 0==t?0:(t+this.first_ring_delta)*this.y}},e=this,i=function(t,i,c){const a=[],d={};for(var l=0;l<t.rows.length;l++){const n=t.rows[l],e=n.c[0],o=e.v,r=n.c[1].v,s={id:o,children:[],minArc:0};if(null==r){const t={circles:[{arc:0,nodes:[s]}]};s.map=t,s.circle=0,a.push(t)}else{const t=d[r];if(!t)throw"Parent id "+r+" not on map yet";t.children.push(s),s.parent=t,s.connection=i.filter(function(t){return t[0]==o})[0]||[o,r,[],"?"],s.connection[2].unshift("connection"),s.map=t.map,s.circle=t.circle+1,s.map.circles.length<=s.circle?s.map.circles.push({arc:0,nodes:[s]}):s.map.circles[s.circle].nodes.push(s)}d[o]=s,s.markup=e.f}for(var h=0;h<a.length;h++){const t=a[h];for(var p=t.circles.length-1;p>=1;p--)for(var m=0;m<t.circles[p].nodes.length;m++){const n=t.circles[p].nodes[m];n.minArc*=p/(p+1),n.minArc<1&&(n.minArc=1),n.parent.minArc+=n.minArc,t.circles[p].arc+=n.minArc}}for(h=0;h<a.length;h++){const t=a[h],n=document.createElement("div");n.id="map"+h,n.className="map-chain-wrapper",n.innerHTML='<div class="map-outer-container"><div class="map-inner-container"><canvas class="map-drawing" id="map-canvas-'+h+'"/></div></div>';const e=n.firstChild.firstChild;document.getElementById("map-container").appendChild(n),t.bounds=o(e,0,t.circles[0].nodes,0,2*Math.PI),t.domNode=n,t.innerContainer=e}for(h=0;h<a.length;h++){const t=a[h],i={w:200+t.bounds.x[1]-t.bounds.x[0],h:100+t.bounds.y[1]-t.bounds.y[0],cx:100-t.bounds.x[0],cy:50-t.bounds.y[0]};if(1==a.length){const t=-38+e.container.offsetWidth;i.w<t&&(i.cx+=.5*(t-i.w),i.w=t)}const o=document.getElementById("chainParent").offsetHeight;i.h<o&&(i.cy+=.5*(o-i.h),i.h=o),i.h>=2*(t.bounds.y[1]>-t.bounds.y[0]?t.bounds.y[1]:-t.bounds.y[0])&&(i.cy=i.h/2),i.w>=2*(t.bounds.x[1]>-t.bounds.x[0]?t.bounds.x[1]:-t.bounds.x[0])&&(i.cx=i.w/2),t.domNode.style.width=i.w+"px",t.domNode.style.height=i.h+"px";const c=t.domNode.firstChild;c.style.left=i.cx+"px",c.style.top=i.cy+"px";const d=c.getElementsByTagName("canvas")[0];d.width=1*i.w,d.style.width=i.w+"px",d.height=1*i.h,d.style.height=i.h+"px",d.style.left=-i.cx+"px",d.style.top=-i.cy+"px";const l=d.getContext("2d");l.scale(1,1),l.translate(i.cx,i.cy);for(p=t.bounds.maxCi-1;p>=1;p--)if(options.chain.gridlines&&(l.beginPath(),l.ellipse&&(l.lineWidth=.5,l.setLineDash([]),l.ellipse(0,0,n.ringX(p),n.ringY(p),0,0,2*Math.PI)),l.strokeStyle=s("grid-default","color"),l.stroke()),!(p>=t.circles.length))for(m=0;m<t.circles[p].nodes.length;m++){const n=t.circles[p].nodes[m];l.beginPath(),l.lineWidth=n.connection[2].reduce(function(t,n){return"frig"==n?1:t},3),l.moveTo(n.position.x,n.position.y);const e=r({r:n.radPosition.r-.5,theta:(n.radPosition.theta+2*n.parent.radPosition.theta)/3}),i=r({r:n.radPosition.r-.5,theta:(2*n.radPosition.theta+n.parent.radPosition.theta)/3});p>1?l.bezierCurveTo(i.x,i.y,e.x,e.y,n.parent.position.x,n.parent.position.y):l.lineTo(n.parent.position.x,n.parent.position.y);n.position.y,n.parent.position;l.strokeStyle=s(n.connection[2],"border-top-color"),l.setLineDash({dashed:[3,2]}[s(n.connection[2],"border-top-style")]||[]),l.stroke()}}};function o(t,n,e,i,s){if(n>0)for(;e.length>1.1*n*(s-i);)n++;const c=(s-i)/e.reduce(function(t,n){return t+n.minArc},0);var a=i,d=0;const l={x:[0,0],y:[0,0],maxCi:n};for(var h=0;h<e.length;h++){const i=e[h],s=document.createRange().createContextualFragment('<div class="node-wrapper">'+i.markup+"</div>");i.domNode=s.firstChild,t.appendChild(i.domNode);const p=i.minArc*c,m=a+p/2;1==n&&0==h&&(d-=m),i.radPosition={r:n,theta:m+d},i.position=r(i.radPosition),i.position.x<l.x[0]&&(l.x[0]=i.position.x),i.position.x>l.x[1]&&(l.x[1]=i.position.x),i.position.y<l.y[0]&&(l.y[0]=i.position.y),i.position.y>l.y[1]&&(l.y[1]=i.position.y),i.domNode.style.left=i.position.x+"px",i.domNode.style.top=i.position.y+"px";const y=n>0&&p>i.minArc*n?p-i.minArc*n:0,u=o(t,n+1,i.children,a+.5*y+d,a-.5*y+d+p);u.x[0]<l.x[0]&&(l.x[0]=u.x[0]),u.x[1]>l.x[1]&&(l.x[1]=u.x[1]),u.y[0]<l.y[0]&&(l.y[0]=u.y[0]),u.y[1]>l.y[1]&&(l.y[1]=u.y[1]),u.maxCi>l.maxCi&&(l.maxCi=u.maxCi),a+=p}return l}function r(t){return{x:n.ringX(t.r)*Math.sin(t.theta),y:n.ringY(t.r)*Math.cos(t.theta)}}function s(t,n){Array.isArray(t)&&(t=t.join(" "));var e=document.getElementById("temp-div-"+t);return e||((e=document.createElement("div")).id="temp-div-"+t,e.style.cssText="position:fixed;left:-100px;top:-100px;width:1px;height:1px",e.className=t+" temp",document.body.appendChild(e)),getComputedStyle(e).getPropertyValue(n)}};
var chain=new function(){var s=this;this.map,this.view,this.drawing,this.data={};const e={orgChart:new ChainMapRendererOrgchart(this),radial:new ChainMapRendererRadial(this)};this.renderer=e[options.chain.renderer],this.renderer.switchTo(),this.useRenderer=function(s){if(!e[s])throw"Unknown renderer "+s;this.renderer!=e[s]&&(this.renderer.switchFrom(),this.renderer=e[s],this.renderer.switchTo(),this.redraw())},this.activity=function(s){for(var e=0,i=(t=document.querySelectorAll("#chainMap .nodeActivity span")).length;e<i;++e)t[e].className=t[e].className+" invisible";var t;for(e=0,i=(t=document.querySelectorAll("#chainMap [data-nodeid]")).length;e<i;++e){var a=t[e].getAttribute("data-nodeid");if(s[a]){var n=s[a].shipJumps,r=s[a].podKills,l=s[a].shipKills,c=s[a].npcKills,o=t[e].getElementsByClassName("nodeActivity")[0];if(n>0){var d=o.getElementsByClassName("jumps")[0];d.className=d.className.replace(/invisible/g,""),d.setAttribute("data-tooltip",n+" Jumps")}if(r>0){var p=o.getElementsByClassName("pods")[0];p.className=p.className.replace(/invisible/g,""),p.setAttribute("data-tooltip",r+" Pod Kills")}if(l>0){var h=o.getElementsByClassName("ships")[0];h.className=h.className.replace(/invisible/g,""),h.setAttribute("data-tooltip",l+" Ship Kills")}if(c>0){var m=o.getElementsByClassName("npcs")[0];m.className=m.className.replace(/invisible/g,""),m.setAttribute("data-tooltip",c+" NPC Kills")}}}return SystemActivityToolTips.attachedElements&&SystemActivityToolTips.attachedElements.length>0&&SystemActivityToolTips.detach($("#chainMap .whEffect")),SystemActivityToolTips.attach($("#chainMap .nodeActivity > span[data-tooltip]:not(.invisible)")),s},this.occupied=function(s){for(var e in $("#chainMap [data-icon='user'], #chainMap [data-icon='user'] + .badge").addClass("invisible"),s)$("#chainMap [data-nodeid='"+s[e].systemID+"'] [data-icon='user']").removeClass("invisible"),$("#chainMap [data-nodeid='"+s[e].systemID+"'] [data-icon='user'] + .badge").removeClass("invisible").html(s[e].count);return OccupiedToolTips.attach($("#chainMap [data-icon='user']:not(.invisible)")),s},this.flares=function(s){if($("#chainMap div.node").removeClass("redNode yellowNode greenNode"),$("#chainGrid tr").removeClass("red yellow green"),s)for(var e in s.flares){var i=s.flares[e].systemID,t=s.flares[e].flare,a=($("#chainMap [data-nodeid="+i+"]").addClass(t+"Node").parent().index()-1)/3*2;a>0&&$("#chainGrid tr:eq("+a+")").addClass(t).next().addClass(t)}return s},this.grid=function(){if(0==options.chain.gridlines)return $("#chainGrid tr").addClass("hidden"),!1;$("#chainGrid tr").removeClass("hidden");var s=Math.max(0,2*$(".google-visualization-orgchart-table tr:has(.node)").length-1);$("#chainGrid tr:gt("+s+")").addClass("hidden")},this.nodes=function(s){var e={cols:[{label:"System",type:"string"},{label:"Parent",type:"string"}],rows:[]},i=["Q003","E004","L005","Z006","M001","C008","G008","A009","SML"],t=[];function a(s,e){if(!s||!tripwire.systems[s])return!1;const i=options.chain.tabs[options.chain.active];return n(s,e,null,null,i&&0!=i.systemID&&0>i.systemID.indexOf(",")?options.chain.tabs[options.chain.active].name:void 0,"&nbsp;",["top-level"])}function n(s,e,i,t,a,n,r){var l=function(s){const e=tripwire.systems[s];var i="string"==typeof s&&s.indexOf("|")>=0?tripwire.aSigSystems[s.substring(0,s.indexOf("|"))]:null;const t=e?e.class:i&&"Class-"==i.substring(0,6)?1*i.substring(6):void 0,a=e?e.security:"High-Sec"==i?.8:"Low-Sec"==i?.4:"Null-Sec"==i?-.1:void 0;return t?"<span class='wh class-"+t+"'>C"+t+"</span>":a>=.45?"<span class='hisec'>HS</span>":a>0?"<span class='lowsec'>LS</span>":a<=0?"<span class='nullsec'>NS</span>":"&nbsp;"}(s);const c=tripwire.systems[s];var o=null,d=null;if(c&&c.effect){switch(c.effect){case"Black Hole":o="blackhole";break;case"Cataclysmic Variable":o="cataclysmic-variable";break;case"Magnetar":o="magnetar";break;case"Pulsar":o="pulsar";break;case"Red Giant":o="red-giant";break;case"Wolf-Rayet Star":o="wolf-rayet"}d=c.effect}var p={v:e,systemID:s},h="<div id='node"+e+"' data-nodeid='"+s+"'"+(i?" data-sigid='"+i+"'":"")+(t?" data-inSigid='"+t+"'":"")+" class='node "+(r||[]).join(" ")+"'><div class='nodeIcons'><div style='float: left;'><i class='whEffect' "+(o?"data-icon='"+o+"' data-tooltip='"+d+"'":null)+"></i></div><div style='float: right;'><i data-icon='user' class='invisible'></i><span class='badge invisible'></span></div></div><h4 class='nodeClass'>"+l+"</h4><h4 class='nodeSystem'>"+(c?"<a href='.?system="+c.name+"'>"+(a||c.name)+"</a>":a||"&nbsp;")+"</h4><h4 class='nodeType'>"+n+"</h4><div class='statics'>"+function(s){if(!s)return"";const e={"High-Sec":"H","Low-Sec":"L","Null-Sec":"N","Class 1":"1","Class 2":"2","Class 3":"3","Class 4":"4","Class 5":5,"Class 6":6},i={H:"hisec",L:"lowsec",N:"nullsec"};return s.map(function(s){const t=e[tripwire.wormholes[s].leadsTo];return'<span class="'+(i[t]||"class-"+t)+'" data-tooltip="'+tripwire.wormholes[s].leadsTo+" via "+s+'">'+t+"</span>"}).join("")}(c?c.statics:[])+"</div><div class='nodeActivity'><span class='jumps invisible'>&#9679;</span>&nbsp;<span class='pods invisible'>&#9679;</span>&nbsp;&nbsp;<span class='ships invisible'>&#9679;</span>&nbsp;<span class='npcs invisible'>&#9679;</span></div></div>";return p.f=h,p}function r(s,e,i){var t=guidance.findShortestPath(tripwire.map.shortest,[i-3e7,e.child.systemID-3e7]),a={calculated:!0,life:"Gate",parent:{}};return a.parent.id=e.child.id,a.parent.systemID=e.child.systemID,a.parent.name=e.child.name,a.parent.type=e.child.type,a.parent.nth=e.child.nth,a.child={},a.child.id=++s,a.child.systemID=i,a.child.name=tripwire.systems[i].name,a.child.path=t,a.child.jumps=t.length-1,a.child.nth=null,{childID:s,calcNode:a}}function l(s){if(s[0]<=0)return!1;var e=parseInt(s[1]),i=o.length;for(var t in d){var a=d[t];if(-1==$.inArray(a.id,h)){var n,l,c,m,u,y,v;if("secondary"==a.parent?(n=tripwire.client.signatures[a.secondaryID],l=tripwire.client.signatures[a.initialID]):(n=tripwire.client.signatures[a.initialID],l=tripwire.client.signatures[a.secondaryID]),c=a.type,"K162",n&&n.systemID==s[0])m=n,u=l,y="K162",v=c;else{if(!l||l.systemID!=s[0])continue;m=l,u=n,v="K162",y=c}var f={};if(f.id=a.id,f.life=a.life,f.mass=a.mass,f.time=m.modifiedTime,f.parent={},f.parent.id=e,f.parent.systemID=tripwire.systems[m.systemID]?m.systemID:m.systemID+"|"+Math.floor(Math.random()*Math.floor(1e4)),f.parent.name=m.name,f.parent.type=y,f.parent.typeBM=null,f.parent.classBM=null,f.parent.nth=null,f.parent.signatureID=u.signatureID,f.parent.sigIndex=u.id,f.child={},f.child.id=++i,f.child.systemID=tripwire.systems[u.systemID]?u.systemID:u.systemID+"|"+Math.floor(Math.random()*Math.floor(1e4)),f.child.name=u.name,f.child.type=v,f.child.typeBM=null,f.child.classBM=null,f.child.nth=null,f.child.signatureID=m.signatureID,f.child.sigIndex=m.id,p.push(f),o.push([f.child.systemID,f.child.id,s[2]]),h.push(f.id),$("#show-viewing").hasClass("active")&&tripwire.systems[f.child.systemID]&&!tripwire.systems[viewingSystemID].class&&!tripwire.systems[f.child.systemID].class&&viewingSystemID!=f.child.systemID)i=(g=r(i,f,viewingSystemID)).childID,p.push(g.calcNode),o.push([0,i]);if($("#show-favorite").hasClass("active")&&tripwire.systems[f.child.systemID]&&!tripwire.systems[f.child.systemID].class)for(var t in options.favorites){var g;if(!(tripwire.systems[options.favorites[t]].regionID>=11e6||tripwire.systems[f.child.systemID].regionID>=11e6||options.favorites[t]==f.child.systemID))i=(g=r(i,f,options.favorites[t])).childID,p.push(g.calcNode),o.push([0,i])}}}}if($("#chainTabs .current").length>0){var c=$("#chainTabs .current .name").data("tab").toString().split(","),o=[],d=s,p=[],h=[];if(0==c){let i=0;Object.keys(s).slice().forEach(t=>{const n=tripwire.client.signatures[s[t].initialID],r=tripwire.client.signatures[s[t].secondaryID];n&&tripwire.systems[n.systemID]&&void 0===tripwire.systems[n.systemID].class?(i++,e.rows.push({c:[a(n.systemID,i),{v:null}]}),o.push([n.systemID,i,n.systemID])):r&&tripwire.systems[r.systemID]&&void 0===tripwire.systems[r.systemID].class&&(i++,e.rows.push({c:[a(r.systemID,i),{v:null}]}),o.push([r.systemID,i,r.systemID]))})}else for(var m in c)e.rows.push({c:[a(c[m],parseInt(m)+1),{v:null}]}),o.push([c[m],parseInt(m)+1,c[m]]);for(var u=0;u<o.length;u++)l(o[u])}else{$("#chainError").hide();var y={c:[]},v=viewingSystemID;y.c.push(a(v,1),{v:null}),e.rows.push(y);for(o=[[v,1]],d=s,p=[],h=[],u=0;u<o.length;++u)l(o[u])}const f={};for(var m in p){var g=p[m];y={c:[]};const s=g.child.path?this.renderPath(g.child.path):"<a href='#' onclick='openSignatureDialog({data: { signature: "+g.child.sigIndex+', mode: "update" }}); return false;\'>'+("id"==options.chain["node-reference"]?g.child.signatureID?g.child.signatureID.substring(0,3):"???":(g.child.type||"(?)")+sigFormat(g.child.typeBM,"type"))+"</a>",a=g.calculated?["calc"]:f[g.child.systemID]?["loop"]:[],r=n(g.child.systemID,g.child.id,g.id,g.child.sigIndex,g.parent.name,s,a);var w={v:g.parent.id};y.c.push(r,w),e.rows.push(y);var I=[];"critical"==g.life&&I.push("eol"),"critical"==g.mass?I.push("critical"):"destab"==g.mass&&I.push("destab"),-1==$.inArray(g.parent.type,i)&&-1==$.inArray(g.child.type,i)||I.push("frig"),I.length&&t.push(Array(r.v,w.v,I,g.id)),g.calculated||(f[g.child.systemID]=y)}return t.reverse(),{map:e,lines:t}},this.renderPath=function(s){if(s.length<=1||s.length>options.chain.routingLimit)return""+s.length-1;for(var e=s.slice(0,s.length-1).reverse().map(function(s){var e=appData.systems[3e7+1*s];return'<span class="'+(e.security>=.45?"hisec":e.security>=0?"lowsec":"nullsec")+'" data-tooltip="'+e.name+" ("+e.security+')">&#x25a0</span>'}),i='<span class="path">',t=0;t<e.length;t++)t>0&&0==t%5&&(i+="|"),i+=e[t];return i+"</span>"},this.redraw=function(){this.useRenderer(options.chain.renderer);var s=$.extend(!0,{},this.data);s.map=$.extend(!0,{},s.rawMap),this.draw(s)};var i=null;this.draw=function(e){e=void 0!==e?e:{};if(clearTimeout(i),!this.renderer.ready()||Object.size(e.map)&&!tripwire.client.signatures)i=setTimeout(function(){s.draw(e)},100);else{if(e.map){this.drawing=!0,this.data.rawMap=$.extend(!0,{},e.map),Object.sort(e.map,"id"),$.extend(e,this.nodes(e.map)),$.extend(this.data,e);const s=options.chain.tabs[options.chain.active]&&options.chain.tabs[options.chain.active].collapsed||[];this.renderer.draw(e.map,e.lines,s),this.grid(),$("#chainMap [data-nodeid='"+viewingSystemID+"']").parent().addClass("currentNode"),WormholeTypeToolTips.attachedElements&&WormholeTypeToolTips.attachedElements.length>0&&WormholeTypeToolTips.detach($("#chainMap .whEffect")),WormholeTypeToolTips.attach($("#chainMap .whEffect[data-icon]")),WormholeRouteToolTips.attach($("#chainMap .path span[data-tooltip]")),this.drawing=!1}!this.data.activity||new Date>this.data.activity.expires?(e.activity={},tripwire.esi.universeJumps().done(function(s,i,t){e.activity.expires=new Date(t.getResponseHeader("expires")),$.each(s,function(i){e.activity[s[i].system_id]={systemID:s[i].system_id,shipJumps:s[i].ship_jumps}})}).then(function(){return tripwire.esi.universeKills().done(function(s){$.each(s,function(i){e.activity[s[i].system_id]?(e.activity[s[i].system_id].podKills=s[i].pod_kills,e.activity[s[i].system_id].shipKills=s[i].ship_kills,e.activity[s[i].system_id].npcKills=s[i].npc_kills):e.activity[s[i].system_id]={systemID:s[i].system_id,podKills:s[i].pod_kills,shipKills:s[i].ship_kills,npcKills:s[i].npc_kills}})})}).then(function(){s.data.activity=s.activity(e.activity)})):e.map&&s.activity(this.data.activity),e.occupied&&(this.data.occupied=this.occupied(e.occupied)),e.flares&&(this.data.flares=this.flares(e.flares))}},this.updateCollapsed=function(e){options.chain.tabs[options.chain.active]&&(options.chain.tabs[options.chain.active].collapsed=e),$("#chainMap [data-nodeid='"+viewingSystemID+"']").parent().addClass("currentNode"),WormholeTypeToolTips.attachedElements&&WormholeTypeToolTips.attachedElements.length>0&&WormholeTypeToolTips.detach($("#chainMap .whEffect")),WormholeTypeToolTips.attach($("#chainMap .whEffect[data-icon]")),s.activity(s.data.activity),s.occupied(s.data.occupied),s.flares(s.data.flares),s.grid(),options.save()}};
...
$("#sigTable tbody").on("dblclick","tr",{mode:"update",source:"sig-row"},openSignatureDialog),$("#edit-signature").on("click",{mode:"update",source:"edit-sig"},openSignatureDialog),$("#add-signature").click({mode:"add"},openSignatureDialog);const sigDialogVM={};function openSignatureDialog(e){e.preventDefault&&e.preventDefault();var i=e.data.mode;switch(i){case"update":if("sig-row"==e.data.source)$("#sigTable tr.selected").removeClass("selected"),$(this).closest("tr").addClass("selected"),sigDialogVM.sigId=$(this).data("id"),i="update";else if("edit-sig"==e.data.source){var t=$("#sigTable tbody tr.selected");if(1!==t.length)return!1;sigDialogVM.sigId=$(t[0]).data("id")}else sigDialogVM.sigId=e.data.signature;break;default:delete sigDialogVM.sigId}sigDialogVM.viewingSystemID=(tripwire.client.signatures[sigDialogVM.sigId]||{systemID:viewingSystemID}).systemID,sigDialogVM.viewingSystem=tripwire.systems[sigDialogVM.viewingSystemID],$("#dialog-signature").hasClass("ui-dialog-content")?$("#dialog-signature").dialog("isOpen")||$("#dialog-signature").dialog("open"):$("#dialog-signature").dialog({autoOpen:!0,resizable:!1,dialogClass:"dialog-noeffect ui-dialog-shadow",position:{my:"center",at:"center",of:$("#signaturesWidget")},buttons:{Save:function(){$("#form-signature").submit()},Add:function(){$("#form-signature").submit()},Cancel:function(){$(this).dialog("close")}},create:function(){var e=$.map(tripwire.wormholes,function(e,i){return i});e.splice(26,0,"K162"),e.push("GATE"),e.push("SML"),e.push("MED"),e.push("LRG"),e.push("XLG"),$("#dialog-signature [name='signatureType'], #dialog-signature [name='signatureLife']").selectmenu({width:100}),$("#dialog-signature [name='wormholeLife'], #dialog-signature [name='wormholeMass']").selectmenu({width:80}),$("#dialog-signature [data-autocomplete='sigSystems']").inlinecomplete({source:tripwire.aSigSystems,maxSize:10,delay:0}),$("#dialog-signature [data-autocomplete='sigType']").inlinecomplete({source:e,maxSize:10,delay:0}),$("#dialog-signature #durationPicker").durationPicker(),$("#dialog-signature #durationPicker").on("change",function(){this.value<0&&(this.value=0,$(this).change())}),$("#dialog-signature [name='signatureID_Alpha'], #dialog-signature [name='signatureID2_Alpha']").on("input",function(){for(;!/^[a-zA-Z?]*$/g.test(this.value);)this.value=this.value.substring(0,this.value.length-1)}),$("#dialog-signature [name='signatureID_Alpha']").on("input",function(){3===this.value.length&&$("#dialog-signature [name='signatureID_Numeric']").select()}),$("#dialog-signature [name='signatureID2_Alpha']").on("input",function(){3===this.value.length&&$("#dialog-signature [name='signatureID2_Numeric']").select()}),$("#dialog-signature [name='signatureID_Numeric'], #dialog-signature [name='signatureID2_Numeric']").on("input",function(){for(;!/^[0-9?]*$/g.test(this.value);)this.value=this.value.substring(0,this.value.length-1)}),$("#dialog-signature .signatureID, #dialog-signature .wormholeType").on("click",function(){$(this).select()}),$("#dialog-signature .wormholeType").on("input, change",function(){this.value.length>0&&-1!=$.inArray(this.value.toUpperCase(),e)&&"K162"!=this.value.toUpperCase()?($("#dialog-signature .wormholeType").not(this).val("K162"),tripwire.wormholes[this.value.toUpperCase()]&&$("#dialog-signature #durationPicker").val(60*tripwire.wormholes[this.value.toUpperCase()].life.substring(0,2)*60).change()):"K162"===this.value.toUpperCase()?-1!==$.inArray($("#dialog-signature .wormholeType").not(this).val().toUpperCase(),e)&&"K162"!==$("#dialog-signature .wormholeType").not(this).val().toUpperCase()||$("#dialog-signature .wormholeType").not(this).val("????"):"????"==this.value&&$("#dialog-signature .wormholeType").not(this).val("K162")}),$("#dialog-signature").on("selectmenuchange","[name='signatureType']",function(){"wormhole"==this.value?($("#dialog-signature #site").slideUp(200,function(){$(this).hide(0)}),$("#dialog-signature #wormhole").slideDown(200,function(){$(this).show(200)})):($("#dialog-signature #site").slideDown(200,function(){$(this).show(200)}),$("#dialog-signature #wormhole").slideUp(200,function(){$(this).hide(0)})),ValidationTooltips.close()}),$("#form-signature").submit(function(t){t.preventDefault();var a=$(this).serializeObject(),s=!0;if(ValidationTooltips.close(),$.each($("#dialog-signature .signatureID:visible"),function(){if(this.value.length>0&&this.value.length<3)return ValidationTooltips.open({target:$(this)}).setContent("Must be 3 characters in length!"),$(this).select(),s=!1,!1}),!s)return!1;if(3===a.signatureID_Alpha.length&&3===a.signatureID_Numeric.length&&0!=Object.find(tripwire.client.signatures,"signatureID",a.signatureID_Alpha+a.signatureID_Numeric,!0)&&Object.find(tripwire.client.signatures,"signatureID",a.signatureID_Alpha+a.signatureID_Numeric,!0).id!=$("#dialog-signature").data("signatureid")){var r=Object.find(tripwire.client.signatures,"signatureID",a.signatureID_Alpha+a.signatureID_Numeric);return ValidationTooltips.open({target:$("#dialog-signature .signatureID:first")}).setContent("Signature ID already exists! <input type='button' autofocus='true' id='overwrite' value='Overwrite' style='margin-bottom: -4px; margin-top: -4px; font-size: 0.8em;' data-id='"+r.id+"' />"),$("#overwrite").focus(),s=!1,!1}if(!s)return!1;if($.each($("#dialog-signature .wormholeType:visible"),function(){if(this.value.length>0&&-1==$.inArray(this.value.toUpperCase(),e)&&"????"!=this.value)return ValidationTooltips.open({target:$(this)}).setContent("Must be a valid wormhole type!"),$(this).select(),s=!1,!1}),!s)return!1;if($.each($("#dialog-signature .leadsTo:visible"),function(){if(this.value.length>0&&-1==tripwire.aSigSystems.findIndex(e=>this.value.toLowerCase()===e.toLowerCase()))return ValidationTooltips.open({target:$(this)}).setContent("Must be a valid leads to system!"),$(this).select(),s=!1,!1}),!s)return!1;if($.each($("#dialog-signature .leadsTo:visible"),function(){if(this.value.length>0&&this.value.toLowerCase()===sigDialogVM.viewingSystem.name.toLowerCase())return ValidationTooltips.open({target:$(this)}).setContent("Wormhole cannot lead to the same system it comes from!"),$(this).select(),s=!1,!1}),!s)return!1;var n={},o=[];if("wormhole"===a.signatureType){var l={signatureID:a.signatureID_Alpha+a.signatureID_Numeric,systemID:sigDialogVM.viewingSystemID,type:"wormhole",name:a.wormholeName,lifeLength:a.signatureLength},g=null;Object.index(tripwire.systems,"name",a.leadsTo,!0)?g=Object.index(tripwire.systems,"name",a.leadsTo,!0):tripwire.wormholes[a.wormholeType.toUpperCase()]?tripwire.aSigSystems.findIndex(e=>tripwire.wormholes[a.wormholeType.toUpperCase()].leadsTo.replace(" ","-").toLowerCase()===e.toLowerCase())>-1&&(g=tripwire.aSigSystems.findIndex(e=>tripwire.wormholes[a.wormholeType.toUpperCase()].leadsTo.replace(" ","-").toLowerCase()===e.toLowerCase())):-1!==tripwire.aSigSystems.findIndex(e=>a.leadsTo.toLowerCase()===e.toLowerCase())&&(g=tripwire.aSigSystems.findIndex(e=>a.leadsTo.toLowerCase()===e.toLowerCase()));var u={signatureID:a.signatureID2_Alpha+a.signatureID2_Numeric,systemID:g,type:"wormhole",name:a.wormholeName2,lifeLength:a.signatureLength},d=null,p=null;a.wormholeType.length>0&&-1!=$.inArray(a.wormholeType.toUpperCase(),e)&&"K162"!=a.wormholeType.toUpperCase()?(p="initial",d=a.wormholeType.toUpperCase()):a.wormholeType2.length>0&&-1!=$.inArray(a.wormholeType2.toUpperCase(),e)&&"K162"!=a.wormholeType2.toUpperCase()?(p="secondary",d=a.wormholeType2.toUpperCase()):"K162"==a.wormholeType.toUpperCase()?(p="secondary",d="????"):"K162"==a.wormholeType2.toUpperCase()&&(p="initial",d="????");var m={type:d,parent:p,life:a.wormholeLife,mass:a.wormholeMass};"update"==i?(l.id=$("#dialog-signature").data("signatureid"),u.id=$("#dialog-signature").data("signature2id"),m.id=$("#dialog-signature").data("wormholeid"),tripwire.client.wormholes[m.id]&&(a.wormholeType.length>0&&-1!=$.inArray(a.wormholeType.toUpperCase(),e)&&"K162"!=a.wormholeType.toUpperCase()?(m.parent=tripwire.client.wormholes[m.id].initialID==l.id?"initial":"secondary",m.type=a.wormholeType.toUpperCase()):a.wormholeType2.length>0&&-1!=$.inArray(a.wormholeType2.toUpperCase(),e)&&"K162"!=a.wormholeType2.toUpperCase()?(m.parent=tripwire.client.wormholes[m.id].initialID==l.id?"secondary":"initial",m.type=a.wormholeType2.toUpperCase()):"K162"==a.wormholeType.toUpperCase()?(m.parent=tripwire.client.wormholes[m.id].initialID==l.id?"secondary":"initial",m.type="????"):"K162"==a.wormholeType2.toUpperCase()&&(m.parent=tripwire.client.wormholes[m.id].initialID==l.id?"initial":"secondary",m.type="????")),n={signatures:{update:[{wormhole:m,signatures:[l,u]}]}},tripwire.client.wormholes[m.id]?o.push({wormhole:tripwire.client.wormholes[m.id],signatures:[tripwire.client.signatures[l.id],tripwire.client.signatures[u.id]]}):o.push(tripwire.client.signatures[l.id])):n={signatures:{add:[{wormhole:m,signatures:[l,u]}]}}}else{if("update"==i)if(n={signatures:{update:[l={id:$("#dialog-signature").data("signatureid"),signatureID:a.signatureID_Alpha+a.signatureID_Numeric,systemID:sigDialogVM.viewingSystemID,type:a.signatureType,name:a.signatureName,lifeLength:a.signatureLength}]}},"wormhole"==tripwire.client.signatures[l.id].type){m=$.map(tripwire.client.wormholes,function(e){if(e.initialID==l.id||e.secondaryID==l.id)return e})[0],u=l.id==m.initialID?tripwire.client.signatures[m.secondaryID]:tripwire.client.signatures[m.initialID];o.push({wormhole:tripwire.client.wormholes[m.id],signatures:[tripwire.client.signatures[l.id],tripwire.client.signatures[u.id]]})}else o.push(tripwire.client.signatures[l.id]);else n={signatures:{add:[l={signatureID:a.signatureID_Alpha+a.signatureID_Numeric,systemID:sigDialogVM.viewingSystemID,type:a.signatureType,name:a.signatureName,lifeLength:a.signatureLength}]}}}$("#dialog-signature").parent().find(":button:contains('Save')").button("disable");tripwire.refresh("refresh",n,function(e){e.resultSet&&1==e.resultSet[0].result&&($("#dialog-signature").dialog("close"),$("#undo").removeClass("disabled"),"add"==i&&(o=e.results),sigDialogVM.viewingSystemID in tripwire.signatures.undo?tripwire.signatures.undo[sigDialogVM.viewingSystemID].push({action:i,signatures:o}):tripwire.signatures.undo[sigDialogVM.viewingSystemID]=[{action:i,signatures:o}],sessionStorage.setItem("tripwire_undo",JSON.stringify(tripwire.signatures.undo)))},function(){$("#sigEditForm input[type=submit]").removeAttr("disabled"),$("#dialog-signature").parent().find(":button:contains('Save')").button("enable")})})},open:function(){$("#dialog-signature").data("signatureid",""),$("#dialog-signature").data("signature2id",""),$("#dialog-signature").data("wormholeid",""),$("#dialog-signature input").val(""),$("#dialog-signature [name='signatureType']").val("unknown").selectmenu("refresh"),$("#dialog-signature [name='wormholeLife']").val("stable").selectmenu("refresh"),$("#dialog-signature [name='wormholeMass']").val("stable").selectmenu("refresh"),$("#dialog-signature #site").show(),$("#dialog-signature #wormhole").hide(),$("#dialog-signature .sideLabel:first").html(sigDialogVM.viewingSystem.name+" Side"),$("#dialog-signature .sideLabel:last").html("Other Side"),$("#dialog-signature #durationPicker").val(60*options.signatures.pasteLife*60).change();var e=sigDialogVM.sigId;if("update"==i&&e&&tripwire.client.signatures[e]){var t=tripwire.client.signatures[e];if($("#dialog-signature").data("signatureid",e),$("#dialog-signature").parent().find("button:contains('Add')").hide(),$("#dialog-signature").parent().find("button:contains('Save')").show(),$("#dialog-signature").dialog("option","title","Edit Signature"),"wormhole"==t.type){var a=$.map(tripwire.client.wormholes,function(i){if(i.initialID==e||i.secondaryID==e)return i})[0],s=e==a.initialID?tripwire.client.signatures[a.secondaryID]:tripwire.client.signatures[a.initialID];$("#dialog-signature").data("signature2id",s.id),$("#dialog-signature").data("wormholeid",a.id);const i=t.signatureID?t.signatureID.substr(0,3):"???";$("#dialog-signature input[name='signatureID_Alpha']").val(i),$("#dialog-signature input[name='signatureID_Numeric']").val(t.signatureID?t.signatureID.substr(3,5):""),$("#dialog-signature [name='signatureType']").val(t.type).selectmenu("refresh").trigger("selectmenuchange"),$("#dialog-signature [name='wormholeName']").val(t.name),$("#dialog-signature [name='leadsTo']").val(tripwire.systems[s.systemID]?tripwire.systems[s.systemID].name:tripwire.aSigSystems[s.systemID]?tripwire.aSigSystems[s.systemID]:""),$("#dialog-signature input[name='signatureID2_Alpha']").val(s.signatureID?s.signatureID.substr(0,3):"???"),$("#dialog-signature input[name='signatureID2_Numeric']").val(s.signatureID?s.signatureID.substr(3,5):""),$("#dialog-signature [name='wormholeName2']").val(s.name),$("#dialog-signature [name='wormholeLife']").val(a.life).selectmenu("refresh").trigger("selectmenuchange"),$("#dialog-signature [name='wormholeMass']").val(a.mass).selectmenu("refresh").trigger("selectmenuchange"),a[a.parent+"ID"]==t.id?$("#dialog-signature input[name='wormholeType']").val(a.type).change():a[a.parent+"ID"]==s.id&&$("#dialog-signature input[name='wormholeType2']").val(a.type).change(),$("#dialog-signature #durationPicker").val(t.lifeLength).change(),"???"!=i?$("#dialog-signature input[name='wormholeName']").select():$("#dialog-signature input[name='signatureID_Alpha']").select()}else $("#dialog-signature input[name='signatureID_Alpha']").val(t.signatureID?t.signatureID.substr(0,3):"???"),$("#dialog-signature input[name='signatureID_Numeric']").val(t.signatureID?t.signatureID.substr(3,5):""),$("#dialog-signature [name='signatureType']").val(t.type).selectmenu("refresh").trigger("selectmenuchange"),$("#dialog-signature [name='signatureName']").val(t.name),$("#dialog-signature #durationPicker").val(t.lifeLength).change(),$("#dialog-signature input[name='signatureID_Alpha']").select()}else $("#dialog-signature").parent().find("button:contains('Add')").show(),$("#dialog-signature").parent().find("button:contains('Save')").hide(),$("#dialog-signature").dialog("option","title","Add Signature"),$("#dialog-signature [name='signatureType']").val(options.signatures.editType||"unknown").selectmenu("refresh"),"wormhole"===$("#dialog-signature [name='signatureType']").val()&&($("#dialog-signature #site").hide(),$("#dialog-signature #wormhole").show())},close:function(){ValidationTooltips.close(),$("#sigTable tr.selected").removeClass("selected"),$("#dialog-signature").data("signatureid",""),$("#dialog-signature").data("signature2id",""),$("#dialog-signature").data("wormholeid","")}})}
