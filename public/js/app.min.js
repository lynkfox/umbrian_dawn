...
tripwire.esi=function(){var e="https://esi.tech.ccp.is",a="Tripwire Client "+tripwire.version+" ("+window.location.hostname+") - "+window.navigator.userAgent;this.esi.connection=!0,this.esi.characters={};var t=function(e){$("#tracking .tracking-clone[data-characterid='"+e+"']").find(".alert").show()},r=function(){r.timer,clearTimeout(r.timer);for(characterID in tripwire.esi.characters){var t=tripwire.esi.characters[characterID];moment(t.tokenExpire).subtract(5,"minutes").isBefore(moment())?tripwire.data.esi={expired:!0}:$.ajax({url:e+"/v1/characters/"+characterID+"/location/?"+$.param({token:t.accessToken,user_agent:a}),type:"GET",dataType:"JSON",characterID:characterID}).done(function(e,a,t){var r=tripwire.esi.characters[this.characterID];r&&(r.locationDate=t.getResponseHeader("last-modified"),r.systemID!=e.solar_system_id&&(r.systemID=e.solar_system_id||null,r.systemName=tripwire.systems[e.solar_system_id]?tripwire.systems[e.solar_system_id].name:null,$("#tracking .tracking-clone[data-characterid='"+this.characterID+"']").find(".system").html(r.systemName||"&nbsp;"),tripwire.data.tracking[this.characterID]={characterID:r.characterID,characterName:r.characterName,systemID:r.systemID,systemName:r.systemName,stationID:r.stationID,stationName:r.stationName,shipID:r.shipID,shipName:r.shipName,shipTypeID:r.shipTypeID,shipTypeName:r.shipTypeName}),r.stationID!=e.station_id&&(r.stationID=e.station_id||null,e.station_id?tripwire.esi.stationLookup(e.station_id,this.characterID).always(function(e){var a=tripwire.esi.characters[this.reference];a.stationName=e.name||null,$("#tracking .tracking-clone[data-characterid='"+this.reference+"']").find(".station").html(e.name.substring(0,17)+"..."||"&nbsp;").attr("data-tooltip",e.name),Tooltips.attach($("#tracking .tracking-clone[data-characterid='"+this.reference+"'] .station[data-tooltip]")),tripwire.data.tracking[characterID]={characterID:a.characterID,characterName:a.characterName,systemID:a.systemID,systemName:a.systemName,stationID:a.stationID,stationName:a.stationName,shipID:a.shipID,shipName:a.shipName,shipTypeID:a.shipTypeID,shipTypeName:a.shipTypeName}}):(r.stationName=null,Tooltips.detach($("#tracking .tracking-clone[data-characterid='"+this.characterID+"'] .station[data-tooltip]")),tripwire.data.tracking[this.characterID]={characterID:r.characterID,characterName:r.characterName,systemID:r.systemID,systemName:r.systemName,stationID:r.stationID,stationName:r.stationName,shipID:r.shipID,shipName:r.shipName,shipTypeID:r.shipTypeID,shipTypeName:r.shipTypeName})),options.tracking.active==this.characterID&&tripwire.EVE(tripwire.esi.characters[options.tracking.active]))}).fail(function(e){403==e.status&&tripwire.refresh("refresh",{esi:{expired:!0}})}).always(function(e,a){"success"!=a&&"abort"!=a&&1==tripwire.esi.connection?(tripwire.esi.connection=!1,$("#esiConnectionSuccess, #esiConnectionError").click(),Notify.trigger("ESI Connection Failed","red",!1,"esiConnectionError")):"success"==a&&0==tripwire.esi.connection&&(tripwire.esi.connection=!0,$("#esiConnectionSuccess, #esiConnectionError").click(),Notify.trigger("ESI Connection Resumed","green",5e3,"esiConnectionSuccess"))})}r.timer=setTimeout(r,5e3)},i=function(){i.timer,clearTimeout(i.timer);for(characterID in tripwire.esi.characters){var t=tripwire.esi.characters[characterID];moment(t.tokenExpire).subtract(5,"minutes").isBefore(moment())?tripwire.data.esi={expired:!0}:$.ajax({url:e+"/v1/characters/"+characterID+"/ship/?"+$.param({token:t.accessToken,user_agent:a}),type:"GET",dataType:"JSON",characterID:characterID}).done(function(e,a,t){var r=tripwire.esi.characters[this.characterID];r&&(r.shipDate=t.getResponseHeader("last-modified"),r.shipID!=e.ship_item_id&&(r.shipID=e.ship_item_id||null,tripwire.data.tracking[this.characterID]={characterID:r.characterID,characterName:r.characterName,systemID:r.systemID,systemName:r.systemName,stationID:r.stationID,stationName:r.stationName,shipID:r.shipID,shipName:r.shipName,shipTypeID:r.shipTypeID,shipTypeName:r.shipTypeName}),r.shipName!=e.ship_name&&(r.shipName=e.ship_name||null,$("#tracking .tracking-clone[data-characterid='"+this.characterID+"']").find(".shipname").html(e.ship_name||"&nbsp;"),tripwire.data.tracking[this.characterID]={characterID:r.characterID,characterName:r.characterName,systemID:r.systemID,systemName:r.systemName,stationID:r.stationID,stationName:r.stationName,shipID:r.shipID,shipName:r.shipName,shipTypeID:r.shipTypeID,shipTypeName:r.shipTypeName}),r.shipTypeID!=e.ship_type_id&&(r.shipTypeID=e.ship_type_id||null,e.ship_type_id?tripwire.esi.typeLookup(e.ship_type_id,this.characterID).always(function(e){var a=tripwire.esi.characters[this.reference];a.shipTypeName=e.name||null,$("#tracking .tracking-clone[data-characterid='"+this.reference+"']").find(".ship").html(e.name||"&nbsp;"),tripwire.data.tracking[this.characterID]={characterID:a.characterID,characterName:a.characterName,systemID:a.systemID,systemName:a.systemName,stationID:a.stationID,stationName:a.stationName,shipID:a.shipID,shipName:a.shipName,shipTypeID:a.shipTypeID,shipTypeName:a.shipTypeName}}):(r.shipTypeName=null,$("#tracking .tracking-clone[data-characterid='"+this.characterID+"']").find(".ship").html("&nbsp;"),tripwire.data.tracking[this.characterID]={characterID:r.characterID,characterName:r.characterName,systemID:r.systemID,systemName:r.systemName,stationID:r.stationID,stationName:r.stationName,shipID:r.shipID,shipName:r.shipName,shipTypeID:r.shipTypeID,shipTypeName:r.shipTypeName})))}).fail(function(e){403==e.status&&tripwire.refresh("refresh",{esi:{expired:!0}})}).always(function(e,a){"success"!=a&&"abort"!=a&&1==tripwire.esi.connection?(tripwire.esi.connection=!1,$("#esiConnectionSuccess, #esiConnectionError").click(),Notify.trigger("ESI Connection Failed","red",!1,"esiConnectionError")):"success"==a&&0==tripwire.esi.connection&&(tripwire.esi.connection=!0,$("#esiConnectionSuccess, #esiConnectionError").click(),Notify.trigger("ESI Connection Resumed","green",5e3,"esiConnectionSuccess"))})}i.timer=setTimeout(i,5e3)},s=function(){s.timer,clearTimeout(s.timer);for(characterID in tripwire.esi.characters){var e=tripwire.esi.characters[characterID];tripwire.esi.characterStatus(e.characterID,e).done(function(e){e?$("#tracking .tracking-clone[data-characterid='"+this.reference.characterID+"']").find(".online").removeClass("critical").addClass("stable"):$("#tracking .tracking-clone[data-characterid='"+this.reference.characterID+"']").find(".online").removeClass("stable").addClass("critical")}).fail(function(e){e&&403==e.status&&t(this.reference.characterID),$("#tracking .tracking-clone[data-characterid='"+this.reference.characterID+"']").find(".online").removeClass("stable").addClass("critical")})}s.timer=setTimeout(s,6e4)};this.esi.typeLookup=function(t,r){return $.ajax({url:e+"/v2/universe/types/"+t+"/?"+$.param({user_agent:a}),type:"GET",dataType:"JSON",reference:r})},this.esi.stationLookup=function(t,r){return $.ajax({url:e+"/v2/universe/stations/"+t+"/?"+$.param({user_agent:a}),type:"GET",dataType:"JSON",reference:r})},this.esi.setDestination=function(t,r,i,s){return $.ajax({url:e+"/v2/ui/autopilot/waypoint/?"+$.param({destination_id:t,clear_other_waypoints:i,add_to_beginning:s}),headers:{Authorization:"Bearer "+tripwire.esi.characters[r].accessToken,"X-User-Agent":a},type:"POST",dataType:"JSON"})},this.esi.showInfo=function(t,r){return $.ajax({url:e+"/v1/ui/openwindow/information/?"+$.param({target_id:t}),headers:{Authorization:"Bearer "+tripwire.esi.characters[r].accessToken,"X-User-Agent":a},type:"POST",dataType:"JSON"})},this.esi.characterStatus=function(t,r){return $.ajax({url:e+"/v1/characters/"+t+"/online/?"+$.param({token:tripwire.esi.characters[t].accessToken,user_agent:a}),type:"GET",dataType:"JSON",reference:r})},this.esi.eveStatus=function(){return $.ajax({url:e+"/v1/status/?"+$.param({user_agent:a}),type:"GET",dataType:"JSON"})},this.esi.idLookup=function(t){return $.ajax({url:e+"/v2/universe/names/?"+$.param({user_agent:a}),type:"POST",dataType:"JSON",contentType:"application/json",processData:!1,data:JSON.stringify(t)})},this.esi.characterLookup=function(t){return $.ajax({url:e+"/v4/characters/"+t+"/?"+$.param({user_agent:a}),type:"GET",dataType:"JSON",eveID:t})},this.esi.corporationLookup=function(t,r){return $.ajax({url:e+"/v4/corporations/"+t+"/?"+$.param({user_agent:a}),type:"GET",dataType:"JSON",eveID:t,reference:r})},this.esi.parse=function(e){for(characterID in tripwire.esi.characters)characterID in e||(delete tripwire.esi.characters[characterID],$("#tracking .tracking-clone[data-characterid='"+characterID+"']").remove(),options.tracking.active==characterID&&(tripwire.EVE(!1,!0),$("#removeESI").attr("disabled","disabled")));for(characterID in e){if("new"==options.tracking.active&&(options.tracking.active=characterID),!(characterID in tripwire.esi.characters)){var a=$("#tracking-clone").clone();a.attr("data-characterid",characterID),a.find(".avatar img").attr("src","https://image.eveonline.com/Character/"+characterID+"_32.jpg"),a.find(".name").html(e[characterID].characterName),a.removeAttr("id"),a.removeClass("hidden"),a.addClass("tracking-clone"),options.tracking.active==characterID&&(a.addClass("active"),$("#removeESI").removeAttr("disabled")),$("#tracking").append(a)}tripwire.esi.characters[characterID]=e[characterID]}i(),r(),s()}},tripwire.esi();
