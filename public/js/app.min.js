...
tripwire.autoMapper=function(i,e){if(!tripwire.systems[i]||!tripwire.systems[e])return!1;if(!$("#toggle-automapper").hasClass("active")||$("#toggle-automapper").hasClass("disabled"))return!1;if($.inArray(parseInt(tripwire.client.EVE.shipTypeID),[33328,670])>=0)return!1;if(void 0!==tripwire.map.shortest[i-3e7]&&void 0!==tripwire.map.shortest[i-3e7][e-3e7])return!1;if($.map(tripwire.client.wormholes,function(t){return tripwire.client.signatures[t.initialID].systemID==i&&tripwire.client.signatures[t.secondaryID].systemID==e||tripwire.client.signatures[t.initialID].systemID==e&&tripwire.client.signatures[t.secondaryID].systemID==i?t:null}).length>0)return!1;var t,s={signatures:{add:[],update:[]}},r=null;if(r=tripwire.systems[e].class?"Class "+tripwire.systems[e].class:tripwire.systems[e].security>=.45?"High-Sec":tripwire.systems[e].security>0?"Low-Sec":"Null-Sec",(t=$.map(tripwire.client.wormholes,function(e){if(tripwire.client.signatures[e.initialID].systemID==i&&!tripwire.systems[tripwire.client.signatures[e.secondaryID].systemID]){if(tripwire.aSigSystems[tripwire.client.signatures[e.secondaryID].systemID]==r)return e;if(e.type&&tripwire.wormholes[e.type]&&tripwire.wormholes[e.type].leadsTo==r)return e}})).length)if(t.length>1)$("#dialog-msg").dialog({autoOpen:!0,title:"Which Signature?",buttons:{Cancel:function(){$(this).dialog("close")},Ok:function(){var i=$("#dialog-msg #msg [name=sig]:checked").val(),r=t[i],n=tripwire.client.signatures[r.initialID],a=tripwire.client.signatures[r.secondaryID];s.signatures.update.push({wormhole:{id:r.id},signatures:[{id:n.id},{id:a.id,systemID:e}]});tripwire.refresh("refresh",s,function(i){i.resultSet&&1==i.resultSet[0].result&&$("#dialog-msg").dialog("close")})}},open:function(){$("#dialog-msg #msg").html("Which signature would you like to update?<br/><br/>"),$.each(t,function(i){$("#dialog-msg #msg").append("<input type='radio' name='sig' value='"+i+"' />"+tripwire.client.signatures[t[i].initialID].signatureID+"<br/>")})}});else{var n=t[0],a=tripwire.client.signatures[n.initialID],l=tripwire.client.signatures[n.secondaryID];s.signatures.update.push({wormhole:{id:n.id},signatures:[{id:a.id},{id:l.id,systemID:e}]})}if(0==t.length)if((t=$.map(tripwire.client.wormholes,function(e){if(tripwire.client.signatures[e.initialID].systemID==i&&!tripwire.systems[tripwire.client.signatures[e.secondaryID].systemID]&&!tripwire.client.signatures[e.secondaryID].systemID)return e})).length)if(t.length>1)$("#dialog-msg").dialog({autoOpen:!0,title:"Which Signature?",buttons:{Cancel:function(){$(this).dialog("close")},Ok:function(){var i=$("#dialog-msg #msg [name=sig]:checked").val(),r=t[i],n=tripwire.client.signatures[r.initialID],a=tripwire.client.signatures[r.secondaryID];s.signatures.update.push({wormhole:{id:r.id},signatures:[{id:n.id},{id:a.id,systemID:e}]});tripwire.refresh("refresh",s,function(i){i.resultSet&&1==i.resultSet[0].result&&$("#dialog-msg").dialog("close")})}},open:function(){$("#dialog-msg #msg").html("Which signature would you like to update?<br/><br/>"),$.each(t,function(i){$("#dialog-msg #msg").append("<input type='radio' name='sig' value='"+i+"' />"+tripwire.client.signatures[t[i].initialID].signatureID+"<br/>")})}});else{n=t[0],a=tripwire.client.signatures[n.initialID],l=tripwire.client.signatures[n.secondaryID];s.signatures.update.push({wormhole:{id:n.id},signatures:[{id:a.id},{id:l.id,systemID:e}]})}else s.signatures.add.push({wormhole:{type:null,parent:"initial",life:"stable",mass:"stable"},signatures:[{signatureID:null,systemID:i,type:"wormhole",name:null},{signatureID:null,systemID:e,type:"wormhole",name:null}]});if(s.signatures.add.length||s.signatures.update.length){tripwire.refresh("refresh",s,function(i){})}};
