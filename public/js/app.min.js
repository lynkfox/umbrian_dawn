...
tripwire.addSig=function(t,s,e){var a=void 0===(s=s||{}).animate||s.animate,e=e||!1;if(t.mass){t.systemID==viewingSystemID?t.nth:t.nth2;var i=t.systemID==viewingSystemID?t.signatureID:t.sig2ID,n=t.systemID==viewingSystemID?t.type:t.sig2Type,o=t.systemID==viewingSystemID?t.typeBM:t.type2BM,d=t.systemID==viewingSystemID?t.connectionID:t.systemID,l=t.systemID==viewingSystemID?t.connection:t.system,r=tripwire.systems[d]?"<a href='.?system="+tripwire.systems[d].name+"'>"+(l||tripwire.systems[d].name)+"</a>":l;switch(t.life){case"Stable":g="stable";break;case"Critical":g="critical";break;default:var g=""}switch(t.mass){case"Stable":m="stable";break;case"Destab":m="destab";break;case"Critical":m="critical";break;default:var m=""}var c="<tr data-id='"+t.id+"' data-tooltip='' "+(e?'disabled="disabled"':"")+"><td class='"+options.signatures.alignment.sigID+"'>"+i+"</td><td class='type-tooltip "+options.signatures.alignment.sigType+"' data-tooltip=\""+this.whTooltip(t)+'">'+n+sigFormat(o,"type")+'</td><td class="age-tooltip '+options.signatures.alignment.sigAge+"\" data-tooltip='"+this.ageTooltip(t)+"'><span data-age='"+t.lifeTime+"'></span></td><td class='"+options.signatures.alignment.leadsTo+"'>"+r+"</td><td class='"+g+" "+options.signatures.alignment.sigLife+"'>"+t.life+"</td><td class='"+m+" "+options.signatures.alignment.sigMass+"'>"+t.mass+"</td></tr>",p=$(c)}else var c="<tr data-id='"+t.id+"' data-tooltip='' "+(e?'disabled="disabled"':"")+"><td class='"+options.signatures.alignment.sigID+"'>"+t.signatureID.substring(0,3)+"-"+t.signatureID.substring(3,6)+"</td><td class='"+options.signatures.alignment.sigType+"'>"+t.type+"</td><td class='age-tooltip "+options.signatures.alignment.sigAge+"' data-tooltip='"+this.ageTooltip(t)+"'><span data-age='"+t.lifeTime+"'></span></td><td class='"+options.signatures.alignment.leadsTo+"' colspan='3'>"+(t.name?linkSig(t.name):"")+"</td></tr>",p=$(c);Tooltips.attach($(p).find("[data-tooltip]")),$("#sigTable").append(p),$("#sigTable").trigger("update"),"Critical"==t.life?$(p).find("span[data-age]").countdown({until:moment.utc(t.lifeLeft).toDate(),onExpiry:this.pastEOL,alwaysExpire:!0,compact:!0,format:this.ageFormat,serverSync:this.serverTime.getTime}).countdown("pause").addClass("critical").countdown("resume"):$(p).find("span[data-age]").countdown({since:moment.utc(t.lifeTime).toDate(),compact:!0,format:this.ageFormat,serverSync:this.serverTime.getTime}).countdown("pause").countdown("resume"),a&&($(p).find("td").wrapInner('<div class="hidden" />').parent().find("td > div").slideDown(700,function(){$set=$(this),$set.replaceWith($set.contents())}),$(p).find("td").animate({backgroundColor:"#004D16"},1e3).delay(1e3).animate({backgroundColor:"#111"},1e3,null,function(){$(this).css({backgroundColor:""})}))};
...
tripwire.editSig=function(t,s){var s=s||!1;if(t.mass){t.systemID==viewingSystemID?t.nth:t.nth2;var e=t.systemID==viewingSystemID?t.signatureID:t.sig2ID,a=t.systemID==viewingSystemID?t.type:t.sig2Type,i=t.systemID==viewingSystemID?t.typeBM:t.type2BM,n=t.systemID==viewingSystemID?t.connectionID:t.systemID,o=t.systemID==viewingSystemID?t.connection:t.system,l=tripwire.systems[n]?"<a href='.?system="+tripwire.systems[n].name+"'>"+(o||tripwire.systems[n].name)+"</a>":o;switch(t.life){case"Stable":d="stable";break;case"Critical":d="critical";break;default:var d=""}switch(t.mass){case"Stable":r="stable";break;case"Destab":r="destab";break;case"Critical":r="critical";break;default:var r=""}var g="<tr data-id='"+t.id+"' data-tooltip='' "+(s?'disabled="disabled"':"")+"><td class='"+options.signatures.alignment.sigID+"'>"+e+"</td><td class='type-tooltip "+options.signatures.alignment.sigType+"' data-tooltip=\""+this.whTooltip(t)+'">'+a+sigFormat(i,"type")+'</td><td class="age-tooltip '+options.signatures.alignment.sigAge+"\" data-tooltip='"+this.ageTooltip(t)+"'><span data-age='"+t.lifeTime+"'></span></td><td class='"+options.signatures.alignment.leadsTo+"'>"+l+"</td><td class='"+d+" "+options.signatures.alignment.sigLife+"'>"+t.life+"</td><td class='"+r+" "+options.signatures.alignment.sigMass+"'>"+t.mass+"</td></tr>",m=$(g)}else var g="<tr data-id='"+t.id+"' data-tooltip='' "+(s?'disabled="disabled"':"")+"><td class='"+options.signatures.alignment.sigID+"'>"+t.signatureID.substring(0,3)+"-"+t.signatureID.substring(3,6)+"</td><td class='"+options.signatures.alignment.sigType+"'>"+t.type+"</td><td class='age-tooltip "+options.signatures.alignment.sigAge+"' data-tooltip='"+this.ageTooltip(t)+"'><span data-age='"+t.lifeTime+"'></span></td><td class='"+options.signatures.alignment.leadsTo+"' colspan='3'>"+(t.name?linkSig(t.name):"")+"</td></tr>",m=$(g);Tooltips.attach($(m).find("[data-tooltip]")),$("#sigTable tr[data-id='"+t.id+"']").replaceWith(m),$("#sigTable").trigger("update"),$(m).find("span[data-age]").countdown("destroy"),"Critical"==t.life?$(m).find("span[data-age]").countdown({until:moment.utc(t.lifeLeft).toDate(),onExpiry:this.pastEOL,alwaysExpire:!0,compact:!0,format:this.ageFormat,serverSync:this.serverTime.getTime}).addClass("critical"):$(m).find("span[data-age]").countdown({since:moment.utc(t.lifeTime).toDate(),compact:!0,format:this.ageFormat,serverSync:this.serverTime.getTime}),$(m).effect("pulsate")};
