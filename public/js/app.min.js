...
const systemAnalysis=new function(){const s=[];this.addMutator=function(e){s.push(e)},this.analyse=function(e,t){if(t||(t=tripwire.systems[e]),!t)return t;const c=Object.assign({},t);return c.baseSecurity=1*t.security,c.pathSymbol="■",c.systemTypeModifiers=[],s.forEach(function(s){s.mutate(c,e)}),c.systemTypeClass=c.class?"wh class-"+c.class:c.security>=.45?"hisec":c.security>0?"lowsec":c.security<=0?"nullsec":"unknown",c.systemTypeName=c.class?"C"+c.class:c.baseSecurity>=.45?"HS":c.baseSecurity>0?"LS":c.baseSecurity<=0?"NS":" ",c}};
