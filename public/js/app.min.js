...
tripwire.addSig=function(t,s,i){var e=void 0===(s=s||{}).animate||s.animate,a=(i=i||!1,{});if("wormhole"==t.type){a=$.map(tripwire.client.wormholes,function(s){if(s.parentID==t.id||s.childID==t.id)return s})[0];var n=t.id==a.parentID?tripwire.client.signatures[a.childID]:tripwire.client.signatures[a.parentID];t.name?leadsTo=tripwire.systems[n.systemID]?"<a href='.?system="+tripwire.systems[n.systemID].name+"'>"+t.name+"</a>":t.name:tripwire.aSigSystems[n.systemID]?leadsTo=tripwire.aSigSystems[n.systemID]:tripwire.systems[n.systemID]?leadsTo="<a href='.?system="+tripwire.systems[n.systemID].name+"'>"+tripwire.systems[n.systemID].name+"</a>":leadsTo="";var o="<tr data-id='"+t.id+"' data-tooltip='' "+(i?'disabled="disabled"':"")+"><td class='"+options.signatures.alignment.sigID+"'>"+(t.signatureID?t.signatureID.substring(0,3)+"-"+(t.signatureID.substring(3,6)||"###"):"???-###")+"</td><td class='type-tooltip "+options.signatures.alignment.sigType+"' data-tooltip=\""+this.whTooltip(a)+'">'+(a.parentID==t.id?a.type||"????":"K162")+'</td><td class="age-tooltip '+options.signatures.alignment.sigAge+"\" data-tooltip='"+this.ageTooltip(t)+"'><span data-age='"+t.lifeTime+"'></span></td><td class='"+options.signatures.alignment.leadsTo+"'>"+(leadsTo||"")+"</td><td class='"+a.life+" "+options.signatures.alignment.sigLife+"'>"+a.life+"</td><td class='"+a.mass+" "+options.signatures.alignment.sigMass+"'>"+a.mass+"</td></tr>",r=$(o)}else o="<tr data-id='"+t.id+"' data-tooltip='' "+(i?'disabled="disabled"':"")+"><td class='"+options.signatures.alignment.sigID+"'>"+(t.signatureID?t.signatureID.substring(0,3)+"-"+(t.signatureID.substring(3,6)||"###"):"???-###")+"</td><td class='"+options.signatures.alignment.sigType+"'>"+t.type+"</td><td class='age-tooltip "+options.signatures.alignment.sigAge+"' data-tooltip='"+this.ageTooltip(t)+"'><span data-age='"+t.lifeTime+"'></span></td><td class='"+options.signatures.alignment.leadsTo+"' colspan='3'>"+(t.name?linkSig(t.name):"")+"</td></tr>",r=$(o);Tooltips.attach($(r).find("[data-tooltip]")),$("#sigTable").append(r),$("#sigTable").trigger("update"),"critical"==a.life?$(r).find("span[data-age]").countdown({until:moment.utc(t.lifeLeft).toDate(),onExpiry:this.pastEOL,alwaysExpire:!0,compact:!0,format:this.ageFormat,serverSync:this.serverTime.getTime}).addClass("critical"):$(r).find("span[data-age]").countdown({since:moment.utc(t.lifeTime).toDate(),compact:!0,format:this.ageFormat,serverSync:this.serverTime.getTime}),e&&($(r).find("td").wrapInner('<div class="hidden" />').parent().find("td > div").slideDown(700,function(){$set=$(this),$set.replaceWith($set.contents())}),$(r).find("td").animate({backgroundColor:"#004D16"},1e3).delay(1e3).animate({backgroundColor:"#111"},1e3,null,function(){$(this).css({backgroundColor:""})}))};
tripwire.API=function(){this.indicator,this.APIrefresh,this.API.expire=function(){var e={since:tripwire.API.APIrefresh,until:null,format:"MS",layout:"-{mnn}{sep}{snn}"};$("#APItimer").countdown("option",e)},this.API.refresh=function(){$.ajax({url:"api_update.php",cache:!1,dataType:"JSON",data:"indicator="+tripwire.API.indicator}).done(function(e){if(e&&e.APIrefresh){tripwire.API.indicator=e.indicator,tripwire.API.APIrefresh=new Date(e.APIrefresh),activity.refresh();var i={until:tripwire.API.APIrefresh,since:null,layout:"{mnn}{sep}{snn}"};$("#APItimer").countdown("option",i),setTimeout("tripwire.API.refresh();",$.countdown.periodsToSeconds($("#APItimer").countdown("getTimes"))-30),e.chain&&tripwire.chainMap.parse(e.chain)}else"-{mnn}{sep}{snn}"!==$("#APItimer").countdown("option","layout")&&$.countdown.periodsToSeconds($("#APItimer").countdown("getTimes"))>120?setTimeout("tripwire.API.refresh();",1e3*($.countdown.periodsToSeconds($("#APItimer").countdown("getTimes"))-30)):setTimeout("tripwire.API.refresh();",15e3)})},this.API.init=function(){$.ajax({url:"api_update.php",cache:!0,dataType:"JSON",data:"init=true"}).done(function(e){tripwire.API.indicator=e.indicator,tripwire.API.APIrefresh=new Date(e.APIrefresh),$("#APItimer").countdown({until:tripwire.API.APIrefresh,onExpiry:tripwire.API.expire,alwaysExpire:!0,compact:!0,format:"MS",serverSync:tripwire.serverTime.getTime,onTick:function(e){$("#APIclock").val(e[5]+1).trigger("change")}});var i="-{mnn}{sep}{snn}"===$("#APItimer").countdown("option","layout")?15:$.countdown.periodsToSeconds($("#APItimer").countdown("getTimes"))-30;setTimeout("tripwire.API.refresh();",1e3*i)})},this.API.init()},tripwire.API();
tripwire.autoMapper=function(e,s){if(!tripwire.systems[e]||!tripwire.systems[s])return!1;if(!$("#toggle-automapper").hasClass("active"))return!1;if($.inArray(parseInt(tripwire.client.EVE.shipTypeID),[33328,670])>=0)return!1;if(void 0!==tripwire.map.shortest[e-3e7]&&void 0!==tripwire.map.shortest[e-3e7][s-3e7])return!1;if($.map(chain.data.rawMap,function(t){return t.systemID==e&&t.connectionID==s||t.connectionID==e&&t.systemID==s?t:null})[0])return!1;var t,i={request:{signatures:{add:[],update:[]}}},n=null;if(n=tripwire.systems[s].class?"Class "+tripwire.systems[s].class:tripwire.systems[s].security>=.45?"High-Sec":tripwire.systems[s].security>0?"Low-Sec":"Null-Sec",(t=$.map(chain.data.rawMap,function(s){return s.systemID==e&&s.mass&&(tripwire.wormholes[s.type]&&tripwire.wormholes[s.type].leadsTo==n&&s.connectionID<=0||s.connection==n)?s:null})).length?t.length>1?$("#dialog-msg").dialog({autoOpen:!0,buttons:{Cancel:function(){$(this).dialog("close")},Ok:function(){var e=$("#dialog-msg #msg [name=sig]:checked").val();i.request.signatures.update.push({id:t[e].id,side:"parent",signatureID:t[e].signatureID,systemID:t[e].systemID,systemName:t[e].system,type:"Wormhole",whType:t[e].type,sig2ID:t[e].sig2ID,sig2Type:t[e].sig2Type,connectionName:tripwire.systems[s].name,connectionID:s,whLife:t[e].life,whMass:t[e].mass,lifeLength:t[e].lifeLength}),i.systemID=viewingSystemID;tripwire.refresh("refresh",i,function(e){e&&1==e.result&&$("#dialog-msg").dialog("close")})}},open:function(){$("#dialog-msg #msg").html("Which signature would you like to update?<br/><br/>"),$.each(t,function(e){$("#dialog-msg #msg").append("<input type='radio' name='sig' value='"+e+"' />"+this.signatureID+"<br/>")})}}):t.length&&(t=t[0],i.request.signatures.update.push({id:t.id,side:"parent",signatureID:t.signatureID,systemID:t.systemID,systemName:t.system,type:"Wormhole",whType:t.type,sig2ID:t.sig2ID,sig2Type:t.sig2Type,connectionName:tripwire.systems[s].name,connectionID:s,whLife:t.life,whMass:t.mass,lifeLength:t.lifeLength})):(t=$.map(chain.data.rawMap,function(s){return s.systemID==e&&s.connectionID<=0&&("???"==s.type||"K162"==s.type)?s:null}))&&(t.length>1?$("#dialog-msg").dialog({autoOpen:!0,buttons:{Cancel:function(){$(this).dialog("close")},Ok:function(){var e=$("#dialog-msg #msg [name=sig]:checked").val();i.request.signatures.update.push({id:t[e].id,side:"parent",signatureID:t[e].signatureID,systemID:t[e].systemID,systemName:t[e].system,type:"Wormhole",whType:t[e].type,sig2ID:t[e].sig2ID,sig2Type:t[e].sig2Type,connectionName:tripwire.systems[s].name,connectionID:s,whLife:t[e].life,whMass:t[e].mass,lifeLength:t[e].lifeLength}),i.systemID=viewingSystemID;tripwire.refresh("refresh",i,function(e){e&&1==e.result&&$("#dialog-msg").dialog("close")})}},open:function(){$("#dialog-msg #msg").html("Which signature would you like to update?<br/><br/>"),$.each(t,function(e){$("#dialog-msg #msg").append("<input type='radio' name='sig' value='"+e+"' /> "+this.signatureID+"<br/>")})}}):t.length&&(t=t[0],i.request.signatures.update.push({id:t.id,side:"parent",signatureID:t.signatureID,systemID:t.systemID,systemName:t.system,type:"Wormhole",whType:t.type,sig2ID:t.sig2ID,sig2Type:t.sig2Type,connectionName:tripwire.systems[s].name,connectionID:s,whLife:t.life,whMass:t.mass,lifeLength:t.lifeLength}))),0==t.length&&i.request.signatures.add.push({signatureID:"???",systemID:e,type:"Wormhole",whType:"???",class:sigClass(tripwire.systems[e].name,"???"),class2:sigClass(tripwire.systems[s].name,null),connectionName:"",connectionID:s}),i.request.signatures.add.length||i.request.signatures.update.length){i.systemID=viewingSystemID;var r=$.map(i.request.signatures.update,function(e){return tripwire.client.signatures[e.id]});tripwire.refresh("refresh",i,function(e){1==e.result&&($("#undo").removeClass("disabled"),viewingSystemID in tripwire.signatures.undo?(e.resultSet&&tripwire.signatures.undo[viewingSystemID].push({action:"add",signatures:$.map(e.resultSet,function(s){return e.signatures[s]})}),r.length&&tripwire.signatures.undo[viewingSystemID].push({action:"update",signatures:r})):(e.resultSet&&(tripwire.signatures.undo[viewingSystemID]=[{action:"add",signatures:$.map(e.resultSet,function(s){return e.signatures[s]})}]),r.length&&(tripwire.signatures.undo[viewingSystemID]=[{action:"update",signatures:r}])),sessionStorage.setItem("tripwire_undo",JSON.stringify(tripwire.signatures.undo)))})}};
tripwire.comments=function(){this.comments.data={},this.comments.parse=function(t){for(var e in t){var m=t[e].id;if(Object.find(tripwire.comments.data,"id",m)||0!=$(".comment[data-id='"+m+"']").length){if(Object.find(tripwire.comments.data,"id",m)&&Object.find(tripwire.comments.data,"id",m).modified!=t[e].modified){i=$(".comment[data-id='"+m+"']");try{i.find(".commentBody").html(t[e].comment)}catch(t){i.find(".commentFooter").show(),i.find(".commentStatus").html("<span class='critical'>"+t.constructor.name+": "+t.message+"</span>"),i.find(".commentFooter .commentControls").hide()}i.find(".commentModified").html("Edited by "+t[e].modifiedBy+" at "+t[e].modified),i.find(".commentSticky").addClass(t[e].sticky?"active":"")}}else{var i=$(".comment:last").clone(),o=$(".comment:visible:last .commentBody").attr("id")?$(".comment:visible:last .commentBody").attr("id").replace("comment","")+1:0;$(".comment:last").before(i),i.attr("data-id",m);try{i.find(".commentBody").html(t[e].comment)}catch(t){i.find(".commentFooter").show(),i.find(".commentStatus").html("<span class='critical'>"+t.constructor.name+": "+t.message+"</span>"),i.find(".commentFooter .commentControls").hide()}i.find(".commentModified").html("Edited by "+t[e].modifiedBy+" at "+t[e].modified),i.find(".commentCreated").html("Posted by "+t[e].createdBy+" at "+t[e].created),i.find(".commentBody").attr("id","comment"+o),i.find(".commentSticky").addClass(t[e].sticky?"active":""),i.removeClass("hidden"),Tooltips.attach(i.find("[data-tooltip]"))}}for(var e in tripwire.comments.data){m=tripwire.comments.data[e].id;if(!Object.find(t,"id",m))(i=$(".comment[data-id='"+m+"']")).remove()}tripwire.comments.data=t}},tripwire.comments();
...
tripwire.undo=function(){if(tripwire.signatures.undo[viewingSystemID].length>0){$("#undo").addClass("disabled");var e=tripwire.signatures.undo[viewingSystemID].length-1,i={systemID:viewingSystemID,signatures:{add:[],remove:[],update:[]}},r=tripwire.signatures.undo[viewingSystemID][e],t=$.map(r.signatures,function(e){if(e.wormhole&&tripwire.client.wormholes[e.wormhole.id])return{wormhole:tripwire.client.wormholes[e.wormhole.id],signatures:[tripwire.client.signatures[e.wormhole.id],tripwire.client.signatures[e.wormhole.id]]};if(tripwire.client.signatures[e.id]&&"wormhole"==tripwire.client.signatures[e.id].type){var i=$.map(tripwire.client.wormholes,function(i){if(i.parentID==e.id||i.childID==e.id)return i})[0];return{wormhole:i,signatures:[tripwire.client.signatures[i.parentID],tripwire.client.signatures[i.childID]]}}return e.wormhole&&tripwire.client.signatures[e.signatures[0].id]?tripwire.client.signatures[e.signatures[0].id]:tripwire.client.signatures[e.id]});switch(r.action){case"add":i.signatures.remove=i.signatures.remove.concat($.map(r.signatures,function(e){return e.wormhole?e.wormhole:e.id}));break;case"remove":i.signatures.add=i.signatures.add.concat(r.signatures);break;case"update":i.signatures.update=i.signatures.update.concat(r.signatures)}tripwire.refresh("refresh",i,function(e){e.resultSet&&1==e.resultSet[0].result&&(tripwire.signatures.undo[viewingSystemID].pop(),$("#redo").removeClass("disabled"),viewingSystemID in tripwire.signatures.redo?"remove"==r.action?tripwire.signatures.redo[viewingSystemID].push({action:r.action,signatures:e.results}):"update"==r.action?tripwire.signatures.redo[viewingSystemID].push({action:r.action,signatures:t}):tripwire.signatures.redo[viewingSystemID].push({action:r.action,signatures:r.signatures}):"remove"==r.action?tripwire.signatures.redo[viewingSystemID]=[{action:r.action,signatures:e.results}]:"update"==r.action?tripwire.signatures.redo[viewingSystemID]=[{action:r.action,signatures:t}]:tripwire.signatures.redo[viewingSystemID]=[{action:r.action,signatures:r.signatures}],sessionStorage.setItem("tripwire_undo",JSON.stringify(tripwire.signatures.undo)),sessionStorage.setItem("tripwire_redo",JSON.stringify(tripwire.signatures.redo)))},function(e){tripwire.signatures.undo[viewingSystemID].length>0&&$("#undo").removeClass("disabled")})}};
...
var chain=new function(){this.map,this.view,this.options,this.drawing,this.data={},this.newView=function(i){return this.view=new google.visualization.DataView(new google.visualization.DataTable(i)),this.view},this.activity=function(i){return $("#chainMap .nodeActivity > span:not(.invisible)").addClass("invisible"),$("#chainMap [data-nodeid]").each(function(){var s=$(this).attr("data-nodeid");if(i[s]){var e=i[s].shipJumps,t=i[s].podKills,a=i[s].shipKills,n=i[s].npcKills,l=$(this).find(".nodeActivity");e>0&&l.find(".jumps").removeClass("invisible").attr("title",e+" Jumps"),t>0&&l.find(".pods").removeClass("invisible").attr("title",t+" Pod Kills"),a>0&&l.find(".ships").removeClass("invisible").attr("title",a+" Ship Kills"),n>0&&l.find(".npcs").removeClass("invisible").attr("title",n+" NPC Kills")}}),$("#chainMap .nodeActivity > span[title]").jBox("Tooltip",{position:{y:"bottom"}}),i},this.occupied=function(i){for(var s in $("#chainMap [data-icon='user'], #chainMap [data-icon='user'] + .badge").addClass("invisible"),i)$("#chainMap [data-nodeid='"+i[s].systemID+"'] [data-icon='user']").removeClass("invisible"),$("#chainMap [data-nodeid='"+i[s].systemID+"'] [data-icon='user'] + .badge").removeClass("invisible").html(i[s].count);return OccupiedToolTips.attach($("#chainMap [data-icon='user']:not(.invisible)")),i},this.flares=function(i){if($("#chainMap td.node").removeClass("redNode yellowNode greenNode"),$("#chainGrid tr").removeClass("red yellow green"),i)for(var s in i.flares){var e=i.flares[s].systemID,t=i.flares[s].flare,a=($("#chainMap [data-nodeid="+e+"]").parent().addClass(t+"Node").parent().index()-1)/3*2;a>0&&$("#chainGrid tr:eq("+a+")").addClass(t).next().addClass(t)}return i},this.grid=function(){if(0==options.chain.gridlines)return $("#chainGrid tr").addClass("hidden"),!1;$("#chainGrid tr").removeClass("hidden");var i=2*$(".google-visualization-orgchart-table tr:has(.node)").length-1;$("#chainGrid tr:gt("+i+")").addClass("hidden")},this.lines=function(i){function s(s,e,t,a){var n=$("#chainMap #node"+s).parent();if(0==n.length)return!1;var l=Math.ceil((n[0].cellIndex+1)/2-1),r=$(n.parent().prev().children("td.google-visualization-orgchart-lineleft, td.google-visualization-orgchart-lineright")[l]).addClass("left-"+t+" right-"+t),c=$("#chainMap #node"+e).parent();if(0==c.length||0==r.length)return!1;var d=0,p=r[0].cellIndex;n.parent().prev().find("td").each(function(i){if(d+=this.colSpan,i==p)return!1});for(var o=Math.ceil((c[0].cellIndex+1)/2-1),h=o,m=0;m<=o;m++){var y=0;n.parent().prev().prev().prev().find("td > [data-nodeid]").each(function(i){if(i==m)return y=$(this).attr("id").replace("node",""),!1}),$.map(i.map.rows,function(i){return i.c[1].v==y?i:null}).length<=0&&h--}o=h;var v=$(n.parent().prev().prev().children("td.google-visualization-orgchart-lineleft, td.google-visualization-orgchart-lineright")[o]).addClass("left-"+t+" right-"+t),u=0,f=(e=!1,!1);n.parent().prev().prev().find("td").each(function(i,s){if(u+=this.colSpan,f&&e)return!1;if(void 0!==v[0]&&v[0].cellIndex==i){if(e=!0,$(this).addClass("left-"+t),f||u==d||$(this).addClass("bottom-"+t),d==u)return!1}else if(u==d)f=!0,$(this).addClass("bottom-"+t);else if(f||e){var a=0,l=!1,r=!1;if(n.parent().prev().find("td").each(function(i){if((a+=this.colSpan)==u&&($(this).hasClass("google-visualization-orgchart-lineleft")||$(this).hasClass("google-visualization-orgchart-lineright"))){if(0==e)return l=!0,v.removeClass("left-"+t+" right-"+t),!1;1==e&&(v.removeClass("left-"+t+" right-"+t),n.parent().prev().prev().find("td").each(function(i){i>=v[0].cellIndex&&$(this).removeClass("bottom-"+t)}),r=!0)}}),l)return!1;r||$(this).addClass("bottom-"+t)}})}for(var e in i.lines)s(i.lines[e][0],i.lines[e][1],i.lines[e][2],i.lines[e][3])},this.nodes=function(i){var s={cols:[{label:"System",type:"string"},{label:"Parent",type:"string"}],rows:[]},e=["Q003","E004","L005","Z006","M001","C008","G008","A009"],t=[];function a(i,s){if(!i||!tripwire.systems[i])return!1;var e;tripwire.systems[i].class?e="<span class='wh'>C"+tripwire.systems[i].class+"</span>":tripwire.systems[i].security>=.45?e="<span class='hisec'>HS</span>":tripwire.systems[i].security>0?e="<span class='lowsec'>LS</span>":tripwire.systems[i].security<=0&&(e="<span class='nullsec'>NS</span>");var t=null,a=null;if(tripwire.systems[i].class){switch(tripwire.systems[i].effect){case"Black Hole":t="blackhole";break;case"Cataclysmic Variable":t="cataclysmic-variable";break;case"Magnetar":t="magnetar";break;case"Pulsar":t="pulsar";break;case"Red Giant":t="red-giant";break;case"Wolf-Rayet Star":t="wolf-rayet"}a=tripwire.systems[i].effect}var n={v:s},l="<div id='node"+s+"' data-nodeid='"+i+"'><div class='nodeIcons'><div style='float: left;'><i class='whEffect' "+(t?"data-icon='"+t+"' data-tooltip='"+a+"'":null)+"></i></div><div style='float: right;'><i data-icon='user' class='invisible'></i><span class='badge' class='invisible'></span></div></div><h4 class='nodeClass'>"+e+"</h4><h4 class='nodeSystem'><a href='.?system="+tripwire.systems[i].name+"'>"+(options.chain.tabs[options.chain.active]&&0!=options.chain.tabs[options.chain.active].systemID?options.chain.tabs[options.chain.active].name:tripwire.systems[i].name)+"</a></h4><h4 class='nodeType'>&nbsp;</h4><div class='nodeActivity'><span class='jumps invisible'>&#9679;</span>&nbsp;<span class='pods invisible'>&#9679;</span>&nbsp;&nbsp;<span class='ships invisible'>&#9679;</span>&nbsp;<span class='npcs invisible'>&#9679;</span></div></div>";return n.f=l,n}function n(i){if(i[0]<=0)return!1;var s=parseInt(i[1]),e=r.length;for(var t in c){var a=c[t];if(-1==$.inArray(a.id,p))if(a.systemID==i[0]){if((l={}).id=a.id,l.life=a.life,l.mass=a.mass,l.time=a.time,l.parent={},l.parent.id=s,l.parent.systemID=a.systemID,l.parent.name=a.system,l.parent.type=a.sig2Type,l.parent.typeBM=a.type2BM,l.parent.classBM=a.class2BM,l.parent.nth=a.nth2,l.parent.signatureID=a.sig2ID,l.child={},l.child.id=++e,l.child.systemID=a.connectionID,l.child.name=a.connection,l.child.type=a.type,l.child.typeBM=a.typeBM,l.child.classBM=a.classBM,l.child.nth=a.nth,l.child.signatureID=a.signatureID,d.push(l),r.push([l.child.systemID,l.child.id,i[2]]),p.push(l.id),$("#show-viewing").hasClass("active")&&tripwire.systems[l.child.systemID]&&!tripwire.systems[viewingSystemID].class&&!tripwire.systems[l.child.systemID].class){var n=guidance.findShortestPath(tripwire.map.shortest,[viewingSystemID-3e7,l.child.systemID-3e7]).length-1;(o={life:"Gate",parent:{}}).parent.id=l.child.id,o.parent.systemID=l.child.systemID,o.parent.name=l.child.name,o.parent.type=l.child.type,o.parent.nth=l.child.nth,o.child={},o.child.id=++e,o.child.systemID=viewingSystemID,o.child.name=tripwire.systems[viewingSystemID].name,o.child.type=n,o.child.nth=null,o.child.signatureID=n,d.push(o),r.push([0,e])}if($("#show-favorite").hasClass("active")&&tripwire.systems[l.child.systemID])for(t in options.favorites)if(!(tripwire.systems[options.favorites[t]].regionID>=11e6||tripwire.systems[l.child.systemID].regionID>=11e6)){n=guidance.findShortestPath(tripwire.map.shortest,[options.favorites[t]-3e7,l.child.systemID-3e7]).length-1;(o={life:"Gate",parent:{}}).parent.id=l.child.id,o.parent.systemID=l.child.systemID,o.parent.name=l.child.name,o.parent.type=l.child.type,o.parent.nth=l.child.nth,o.child={},o.child.id=++e,o.child.systemID=options.favorites[t],o.child.name=tripwire.systems[options.favorites[t]].name,o.child.type=n,o.child.nth=null,o.child.signatureID=n,d.push(o),r.push([0,e])}}else if(a.connectionID==i[0]){var l;if((l={}).id=a.id,l.life=a.life,l.mass=a.mass,l.time=a.time,l.parent={},l.parent.id=s,l.parent.systemID=a.connectionID,l.parent.name=a.connection,l.parent.type=a.type,l.parent.typeBM=a.typeBM,l.parent.classBM=a.classBM,l.parent.nth=a.nth,l.parent.signatureID=a.signatureID,l.child={},l.child.id=++e,l.child.systemID=a.systemID,l.child.name=a.system,l.child.type=a.sig2Type,l.child.typeBM=a.type2BM,l.child.classBM=a.class2BM,l.child.nth=a.nth2,l.child.signatureID=a.sig2ID,d.push(l),r.push([l.child.systemID,l.child.id,i[2]]),p.push(l.id),$("#show-viewing").hasClass("active")&&tripwire.systems[l.child.systemID]&&!tripwire.systems[viewingSystemID].class&&!tripwire.systems[l.child.systemID].class){n=guidance.findShortestPath(tripwire.map.shortest,[viewingSystemID-3e7,l.child.systemID-3e7]).length-1;(o={life:"Gate",parent:{}}).parent.id=l.child.id,o.parent.systemID=l.child.systemID,o.parent.name=l.child.name,o.parent.type=l.child.type,o.parent.nth=l.child.nth,o.child={},o.child.id=++e,o.child.systemID=viewingSystemID,o.child.name=tripwire.systems[viewingSystemID].name,o.child.type=n,o.child.nth=null,o.child.signatureID=n,d.push(o),r.push([0,e])}if($("#show-favorite").hasClass("active")&&tripwire.systems[l.child.systemID])for(t in options.favorites)if(!(tripwire.systems[options.favorites[t]].regionID>=11e6||tripwire.systems[l.child.systemID].regionID>=11e6)){var o;n=guidance.findShortestPath(tripwire.map.shortest,[options.favorites[t]-3e7,l.child.systemID-3e7]).length-1;(o={life:"Gate",parent:{}}).parent.id=l.child.id,o.parent.systemID=l.child.systemID,o.parent.name=l.child.name,o.parent.type=l.child.type,o.parent.nth=l.child.nth,o.child={},o.child.id=++e,o.child.systemID=options.favorites[t],o.child.name=tripwire.systems[options.favorites[t]].name,o.child.type=n,o.child.nth=null,o.child.signatureID=n,d.push(o),r.push([0,e])}}}}if($("#chainTabs .current").length>0){var l=$("#chainTabs .current .name").data("tab").toString().split(","),r=[],c=i,d=[],p=[];if(0==l){var o=0;for(var h in i)void 0===tripwire.systems[i[h].systemID].class?(o++,s.rows.push({c:[a(i[h].systemID,o),{v:null}]}),r.push([i[h].systemID,o,i[h].systemID])):tripwire.systems[i[h].connectionID]&&void 0===tripwire.systems[i[h].connectionID].class&&(o++,s.rows.push({c:[a(i[h].connectionID,o),{v:null}]}),r.push([i[h].connectionID,o,i[h].connectionID]))}else for(var h in l)s.rows.push({c:[a(l[h],parseInt(h)+1),{v:null}]}),r.push([l[h],parseInt(h)+1,l[h]]);for(o=0;o<r.length;o++)n(r[o])}else{$("#chainError").hide();var m={c:[]},y=viewingSystemID;m.c.push(a(y,1),{v:null}),s.rows.push(m);for(r=[[y,1]],c=i,d=[],p=[],o=0;o<r.length;++o)n(r[o])}for(var h in d){var v,u=d[h],f=(m={c:[]},tripwire.systems[u.child.systemID]?tripwire.systems[u.child.systemID].class:null),w=tripwire.systems[u.child.systemID]?tripwire.systems[u.child.systemID].security:null;v=6==f||"Class-6"==u.child.name||void 0!==tripwire.wormholes[u.child.type]&&"Class 6"==tripwire.wormholes[u.child.type].leadsTo?"<span class='wh'>C6</span>":5==f||"Class-5"==u.child.name||void 0!==tripwire.wormholes[u.child.type]&&"Class 5"==tripwire.wormholes[u.child.type].leadsTo?"<span class='wh'>C5</span>":4==f||"Class-4"==u.child.name||void 0!==tripwire.wormholes[u.child.type]&&"Class 4"==tripwire.wormholes[u.child.type].leadsTo?"<span class='wh'>C4</span>":3==f||"Class-3"==u.child.name||void 0!==tripwire.wormholes[u.child.type]&&"Class 3"==tripwire.wormholes[u.child.type].leadsTo?"<span class='wh'>C3</span>":2==f||"Class-2"==u.child.name||void 0!==tripwire.wormholes[u.child.type]&&"Class 2"==tripwire.wormholes[u.child.type].leadsTo?"<span class='wh'>C2</span>":1==f||"Class-1"==u.child.name||void 0!==tripwire.wormholes[u.child.type]&&"Class 1"==tripwire.wormholes[u.child.type].leadsTo?"<span class='wh'>C1</span>":f>6?"<span class='wh'>C"+f+"</span>":void 0!==tripwire.wormholes[u.child.type]&&tripwire.wormholes[u.child.type].leadsTo.split(" ").length>1?"<span class='wh'>C"+tripwire.wormholes[u.child.type].leadsTo.split(" ")[1]+"</span>":w>=.45||"High-Sec"==u.child.name||void 0!==tripwire.wormholes[u.child.type]&&"High-Sec"==tripwire.wormholes[u.child.type].leadsTo&&!w?"<span class='hisec'>HS</span>":w>0||"Low-Sec"==u.child.name||void 0!==tripwire.wormholes[u.child.type]&&"Low-Sec"==tripwire.wormholes[u.child.type].leadsTo&&!w?"<span class='lowsec'>LS</span>":w<=0&&null!=w||"Null-Sec"==u.child.name||void 0!==tripwire.wormholes[u.child.type]&&"Null-Sec"==tripwire.wormholes[u.child.type].leadsTo?"<span class='nullsec'>NS</span>":"<span>&nbsp;</span>";var g=null,I=null;if(void 0!==tripwire.systems[u.child.systemID]){switch(tripwire.systems[u.child.systemID].effect){case"Black Hole":g="blackhole";break;case"Cataclysmic Variable":g="cataclysmic-variable";break;case"Magnetar":g="magnetar";break;case"Pulsar":g="pulsar";break;case"Red Giant":g="red-giant";break;case"Wolf-Rayet Star":g="wolf-rayet";break;default:g=null}I=tripwire.systems[u.child.systemID].effect}var D={v:u.child.id},b="<div id='node"+u.child.id+"' data-nodeid='"+u.child.systemID+"' data-sigid='"+u.id+"'><div class='nodeIcons'><div style='float: left;'><i class='whEffect' "+(g?"data-icon='"+g+"' data-tooltip='"+I+"'":null)+"></i></div><div style='float: right;'><i data-icon='user' class='invisible'></i><span class='badge' class='invisible'></span></div></div><h4 class='nodeClass'>"+(v+sigFormat(u.child.classBM,"class"))+"</h4><h4 class='nodeSystem'>"+(tripwire.systems[u.child.systemID]?"<a href='.?system="+tripwire.systems[u.child.systemID].name+"'>"+(u.child.name?u.child.name:tripwire.systems[u.child.systemID].name)+"</a>":"<a class='invisible'>system</a>")+"</h4><h4 class='nodeType'>"+("id"==options.chain["node-reference"]?u.child.signatureID:u.child.type+sigFormat(u.child.typeBM,"type")||"&nbsp;")+"</h4><div class='nodeActivity'><span class='jumps invisible'>&#9679;</span>&nbsp;<span class='pods invisible'>&#9679;</span>&nbsp;&nbsp;<span class='ships invisible'>&#9679;</span>&nbsp;<span class='npcs invisible'>&#9679;</span></div></div>";D.f=b;var C={v:u.parent.id};m.c.push(D,C),s.rows.push(m),"Critical"!=u.life||-1==$.inArray(u.parent.type,e)&&-1==$.inArray(u.child.type,e)?"Critical"==u.life&&"Critical"==u.mass?t.push(Array(D.v,C.v,"eol-critical",u.id)):"Critical"==u.life&&"Destab"==u.mass?t.push(Array(D.v,C.v,"eol-destab",u.id)):-1!=$.inArray(u.parent.type,e)||-1!=$.inArray(u.child.type,e)?t.push(Array(D.v,C.v,"frig",u.id)):"Critical"==u.life?t.push(Array(D.v,C.v,"eol",u.id)):"Critical"==u.mass?t.push(Array(D.v,C.v,"critical",u.id)):"Destab"==u.mass?t.push(Array(D.v,C.v,"destab",u.id)):"Gate"!=u.life&&"GATE"!=u.parent.type&&"GATE"!=u.child.type||t.push(Array(D.v,C.v,"gate",u.id)):t.push(Array(D.v,C.v,"eol-frig",u.id))}return t.reverse(),{map:s,lines:t}},this.redraw=function(){var i=$.extend(!0,{},this.data);i.map=$.extend(!0,{},i.rawMap),this.draw(i)},this.draw=function(i){i=void 0!==i?i:{};if(this.map){if(i.map){if(this.drawing=!0,this.data.rawMap=$.extend(!0,{},i.map),(null==options.chain.active||options.chain.tabs[options.chain.active]&&0==options.chain.tabs[options.chain.active].evescout)&&"273.0"!=options.masks.active)for(var s in i.map)"273.0"==i.map[s].mask&&delete i.map[s];if(Object.sort(i.map,"id"),$.extend(i,this.nodes(i.map)),$.extend(this.data,i),this.map.draw(this.newView(i.map),this.options),options.chain.tabs[options.chain.active])for(var e in options.chain.tabs[options.chain.active].collapsed){var t=$("#chainMap [data-nodeid='"+options.chain.tabs[options.chain.active].collapsed[e]+"']").attr("id");t&&(t=t.split("node")[1],this.map.collapse(t-1,!0))}this.lines(i),this.grid(),$("#chainMap [data-nodeid='"+viewingSystemID+"']").parent().addClass("currentNode"),WormholeTypeToolTips.attach($("#chainMap .whEffect")),this.drawing=!1}!this.data.activity||new Date>this.data.activity.expires?(i.activity={},tripwire.esi.universeJumps().done(function(s,e,t){i.activity.expires=new Date(t.getResponseHeader("expires")),$.each(s,function(e){i.activity[s[e].system_id]={systemID:s[e].system_id,shipJumps:s[e].ship_jumps}})}).then(function(){return tripwire.esi.universeKills().done(function(s){$.each(s,function(e){i.activity[s[e].system_id]?(i.activity[s[e].system_id].podKills=s[e].pod_kills,i.activity[s[e].system_id].shipKills=s[e].ship_kills,i.activity[s[e].system_id].npcKills=s[e].npc_kills):i.activity[s[e].system_id]={systemID:s[e].system_id,podKills:s[e].pod_kills,shipKills:s[e].ship_kills,npcKills:s[e].npc_kills}})})}).then(function(){chain.data.activity=chain.activity(i.activity)})):chain.activity(this.data.activity),i.occupied&&(this.data.occupied=this.occupied(i.occupied)),i.flares&&(this.data.flares=this.flares(i.flares)),i.last_modified&&(this.data.last_modified=i.last_modified)}},this.collapse=function(i){if(chain.drawing)return!1;var s=chain.map.getCollapsedNodes();for(x in options.chain.tabs[options.chain.active].collapsed=[],s){var e=$("#chainMap #node"+(s[x]+1)).data("nodeid");options.chain.tabs[options.chain.active].collapsed.push(e)}chain.lines(chain.data),$("#chainMap [data-nodeid='"+viewingSystemID+"']").parent().addClass("currentNode"),WormholeTypeToolTips.attach($("#chainMap .whEffect")),chain.activity(chain.data.activity),chain.occupied(chain.data.occupied),chain.flares(chain.data.flares),chain.grid(),options.save()},this.init=function(){chain.map=new google.visualization.OrgChart(document.getElementById("chainMap")),chain.options={allowHtml:!0,allowCollapse:!0,size:"medium",nodeClass:"node"},google.visualization.events.addListener(chain.map,"collapse",chain.collapse),chain.map.draw(new google.visualization.DataView(new google.visualization.DataTable({cols:[{label:"System",type:"string"},{label:"Parent",type:"string"}]})),this.options),chain.redraw()},google.charts.setOnLoadCallback(this.init)};
