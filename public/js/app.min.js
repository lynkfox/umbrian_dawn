...
tripwire.autoMapper=function(e,s){if(!tripwire.systems[e]||!tripwire.systems[s])return!1;if(!$("#toggle-automapper").hasClass("active"))return!1;if($.inArray(parseInt(tripwire.client.EVE.shipTypeID),[33328,670])>=0)return!1;if(console.log($.map(tripwire.client.wormholes,function(t){return tripwire.client.signatures[t.parentID].systemID==e&&tripwire.client.signatures[t.childID].systemID==s||tripwire.client.signatures[t.parentID].systemID==s&&tripwire.client.signatures[t.childID].systemID==e?t:null})),$.map(chain.data.rawMap,function(t){return t.systemID==e&&t.connectionID==s||t.connectionID==e&&t.systemID==s?t:null})[0])return!1;var t,i={signatures:{add:[],update:[]}},n=null;if(n=tripwire.systems[s].class?"Class "+tripwire.systems[s].class:tripwire.systems[s].security>=.45?"High-Sec":tripwire.systems[s].security>0?"Low-Sec":"Null-Sec",wormholes=$.map(tripwire.client.wormholes,function(s){tripwire.client.signatures[s.parentID].systemID==e&&tripwire.client.signatures[s.childID].systemID}),(t=$.map(chain.data.rawMap,function(s){return s.systemID==e&&s.mass&&(tripwire.wormholes[s.type]&&tripwire.wormholes[s.type].leadsTo==n&&s.connectionID<=0||s.connection==n)?s:null})).length?t.length>1?$("#dialog-msg").dialog({autoOpen:!0,buttons:{Cancel:function(){$(this).dialog("close")},Ok:function(){var e=$("#dialog-msg #msg [name=sig]:checked").val();i.signatures.update.push({id:t[e].id,side:"parent",signatureID:t[e].signatureID,systemID:t[e].systemID,systemName:t[e].system,type:"Wormhole",whType:t[e].type,sig2ID:t[e].sig2ID,sig2Type:t[e].sig2Type,connectionName:tripwire.systems[s].name,connectionID:s,whLife:t[e].life,whMass:t[e].mass,lifeLength:t[e].lifeLength});tripwire.refresh("refresh",i,function(e){e&&1==e.result&&$("#dialog-msg").dialog("close")})}},open:function(){$("#dialog-msg #msg").html("Which signature would you like to update?<br/><br/>"),$.each(t,function(e){$("#dialog-msg #msg").append("<input type='radio' name='sig' value='"+e+"' />"+this.signatureID+"<br/>")})}}):t.length&&(t=t[0],i.signatures.update.push({id:t.id,side:"parent",signatureID:t.signatureID,systemID:t.systemID,systemName:t.system,type:"Wormhole",whType:t.type,sig2ID:t.sig2ID,sig2Type:t.sig2Type,connectionName:tripwire.systems[s].name,connectionID:s,whLife:t.life,whMass:t.mass,lifeLength:t.lifeLength})):(t=$.map(chain.data.rawMap,function(s){return s.systemID==e&&s.connectionID<=0&&("???"==s.type||"K162"==s.type)?s:null}))&&(t.length>1?$("#dialog-msg").dialog({autoOpen:!0,buttons:{Cancel:function(){$(this).dialog("close")},Ok:function(){var e=$("#dialog-msg #msg [name=sig]:checked").val();i.signatures.update.push({id:t[e].id,side:"parent",signatureID:t[e].signatureID,systemID:t[e].systemID,systemName:t[e].system,type:"Wormhole",whType:t[e].type,sig2ID:t[e].sig2ID,sig2Type:t[e].sig2Type,connectionName:tripwire.systems[s].name,connectionID:s,whLife:t[e].life,whMass:t[e].mass,lifeLength:t[e].lifeLength});tripwire.refresh("refresh",i,function(e){e&&1==e.result&&$("#dialog-msg").dialog("close")})}},open:function(){$("#dialog-msg #msg").html("Which signature would you like to update?<br/><br/>"),$.each(t,function(e){$("#dialog-msg #msg").append("<input type='radio' name='sig' value='"+e+"' /> "+this.signatureID+"<br/>")})}}):t.length&&(t=t[0],i.signatures.update.push({id:t.id,side:"parent",signatureID:t.signatureID,systemID:t.systemID,systemName:t.system,type:"Wormhole",whType:t.type,sig2ID:t.sig2ID,sig2Type:t.sig2Type,connectionName:tripwire.systems[s].name,connectionID:s,whLife:t.life,whMass:t.mass,lifeLength:t.lifeLength}))),0==t.length&&i.signatures.add.push({wormhole:{type:null,life:"stable",mass:"stable"},signatures:[{signatureID:null,systemID:e,type:"wormhole",name:null},{signatureID:null,systemID:s,type:"wormhole",name:null}]}),i.signatures.add.length||i.signatures.update.length){tripwire.refresh("refresh",i,function(e){})}};
