...
tripwire.autoMapper=function(e,i){var t=[];if(!$("#toggle-automapper").hasClass("active")||$("#toggle-automapper").hasClass("disabled"))return!1;if(!tripwire.systems[e]||!tripwire.systems[i])return!1;if(e==i)return!1;if(tripwire.client.EVE&&tripwire.client.EVE.shipTypeID&&$.inArray(parseInt(tripwire.client.EVE.shipTypeID),[33328,670])>=0)return!1;if(void 0!==tripwire.map.shortest[e-3e7]&&void 0!==tripwire.map.shortest[e-3e7][i-3e7])return!1;if($.map(tripwire.client.wormholes,function(t){return tripwire.client.signatures[t.initialID].systemID==e&&tripwire.client.signatures[t.secondaryID].systemID==i||tripwire.client.signatures[t.initialID].systemID==i&&tripwire.client.signatures[t.secondaryID].systemID==e?t:null}).length>0)return!1;var s,r={signatures:{add:[],update:[]}},n=null;if(n=tripwire.systems[i].class?"Class-"+tripwire.systems[i].class:tripwire.systems[i].security>=.45?"High-Sec":tripwire.systems[i].security>0?"Low-Sec":"Null-Sec",(s=$.map(tripwire.client.wormholes,function(i){if(tripwire.client.signatures[i.initialID].systemID==e&&!tripwire.systems[tripwire.client.signatures[i.secondaryID].systemID]){if(tripwire.aSigSystems[tripwire.client.signatures[i.secondaryID].systemID]==n)return i;if(i.type&&tripwire.wormholes[i.type]&&tripwire.wormholes[i.type].leadsTo.replace(" ","-")==n)return i}})).length)if(s.length>1)$("#dialog-select-signature").dialog({autoOpen:!0,title:"Which Signature?",width:390,buttons:{Cancel:function(){$(this).dialog("close")},Ok:function(){var e=$("#dialog-select-signature [name=sig]:checked").val(),n=s[e],a=tripwire.client.signatures[n.initialID],l=tripwire.client.signatures[n.secondaryID];r.signatures.update.push({wormhole:{id:n.id},signatures:[{id:a.id},{id:l.id,systemID:i}]});tripwire.refresh("refresh",r,function(e){e.resultSet&&1==e.resultSet[0].result&&(t.push({wormhole:n,signatures:[a,l]}),$("#dialog-select-signature").dialog("close"))})}},open:function(){$("#dialog-select-signature .optionsTable tbody").empty(),$.each(s,function(e){var i=tripwire.client.signatures[s[e].initialID],t="<tr><td><input type='radio' name='sig' value='"+e+"' id='sig"+e+"' /></td>"+$("#sigTable tr[data-id='"+i.id+"']").html()+"</tr>";$("#dialog-select-signature .optionsTable tbody").append(t),$("#dialog-select-signature .optionsTable tbody td").wrapInner("<label for='sig"+e+"' />")})}});else{var a=s[0],l=tripwire.client.signatures[a.initialID],u=tripwire.client.signatures[a.secondaryID];r.signatures.update.push({wormhole:{id:a.id},signatures:[{id:l.id},{id:u.id,systemID:i}]}),t.push({wormhole:a,signatures:[l,u]})}if(0==s.length)if((s=$.map(tripwire.client.wormholes,function(i){if(tripwire.client.signatures[i.initialID].systemID==e&&!tripwire.systems[tripwire.client.signatures[i.secondaryID].systemID])return i})).length)if(s.length>1)$("#dialog-select-signature").dialog({autoOpen:!0,title:"Which Signature?",width:390,buttons:{Cancel:function(){$(this).dialog("close")},Ok:function(){var e=$("#dialog-select-signature [name=sig]:checked").val(),n=s[e],a=tripwire.client.signatures[n.initialID],l=tripwire.client.signatures[n.secondaryID];r.signatures.update.push({wormhole:{id:n.id},signatures:[{id:a.id},{id:l.id,systemID:i}]});tripwire.refresh("refresh",r,function(e){e.resultSet&&1==e.resultSet[0].result&&(t.push({wormhole:n,signatures:[a,l]}),$("#dialog-select-signature").dialog("close"))})}},open:function(){$("#dialog-select-signature .optionsTable tbody").empty(),$.each(s,function(e){var i=tripwire.client.signatures[s[e].initialID],t="<tr><td><input type='radio' name='sig' value='"+e+"' id='sig"+e+"' /></td>"+$("#sigTable tr[data-id='"+i.id+"']").html()+"</tr>";$("#dialog-select-signature .optionsTable tbody").append(t),$("#dialog-select-signature .optionsTable tbody td").wrapInner("<label for='sig"+e+"' />")})}});else{a=s[0],l=tripwire.client.signatures[a.initialID],u=tripwire.client.signatures[a.secondaryID];r.signatures.update.push({wormhole:{id:a.id},signatures:[{id:l.id},{id:u.id,systemID:i}]}),t.push({wormhole:a,signatures:[l,u]})}else r.signatures.add.push({wormhole:{type:null,parent:"initial",life:"stable",mass:"stable"},signatures:[{systemID:e,type:"wormhole"},{systemID:i,type:"wormhole"}]});if(r.signatures.add.length||r.signatures.update.length){tripwire.refresh("refresh",r,function(e){e.resultSet&&1==e.resultSet[0].result&&($("#undo").removeClass("disabled"),e.results&&(viewingSystemID in tripwire.signatures.undo?tripwire.signatures.undo[viewingSystemID].push({action:"add",signatures:e.results}):tripwire.signatures.undo[viewingSystemID]=[{action:"add",signatures:e.results}]),t.length&&(viewingSystemID in tripwire.signatures.undo?tripwire.signatures.undo[viewingSystemID].push({action:"update",signatures:t}):tripwire.signatures.undo[viewingSystemID]=[{action:"update",signatures:t}]),sessionStorage.setItem("tripwire_undo",JSON.stringify(tripwire.signatures.undo)))})}};
